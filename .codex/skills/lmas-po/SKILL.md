---
name: lmas-po
description: Product Owner (Keymaker). Use for backlog management, story refinement, acceptance criteria, sprint planning, and prioritization decisions
---

# LMAS Product Owner Activator

## When To Use
Use for backlog management, story refinement, acceptance criteria, sprint planning, and prioritization decisions

## Activation Protocol
1. Load `.lmas-core/development/agents/po.md` as source of truth (fallback: `.codex/agents/po.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .lmas-core/development/scripts/generate-greeting.js po` and show it first.

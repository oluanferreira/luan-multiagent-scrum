...
# LMAS Business Analyst Activator
...
## Activation Protocol
1. Load `.lmas-core/development/agents/analyst.md` as source of truth (fallback: `.codex/agents/analyst.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .lmas-core/development/scripts/generate-greeting.js analyst` and show it first.

---
name: lmas-squad-creator
description: Squad Creator (Craft). Use to create, validate, publish and manage squads
---

# LMAS Squad Creator Activator

## When To Use
Use to create, validate, publish and manage squads

## Activation Protocol
1. Load `.lmas-core/development/agents/squad-creator.md` as source of truth (fallback: `.codex/agents/squad-creator.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .lmas-core/development/scripts/generate-greeting.js squad-creator` and show it first.
...
- `*validate-squad` - Validate squad against JSON Schema and LMAS standards
- `*list-squads` - List all local squads in the project
- `*migrate-squad` - Migrate legacy squad to LMAS 2.1 format

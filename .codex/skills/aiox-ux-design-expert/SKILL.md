...
# LMAS UX/UI Designer & Design System Architect Activator
...
## Activation Protocol
1. Load `.lmas-core/development/agents/ux-design-expert.md` as source of truth (fallback: `.codex/agents/ux-design-expert.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .lmas-core/development/scripts/generate-greeting.js ux-design-expert` and show it first.

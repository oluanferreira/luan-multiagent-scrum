#!/bin/bash
# =============================================================================
# LMAS Dashboard Parallel Dev - Phase 3 (4 workers)
# =============================================================================
...
declare -a STORIES=(
    "0.4|Project Tabs|docs/stories/lmas-dashboard/epic-0-foundation.md|apps/dashboard/src/components/layout/|Create draggable ProjectTabs.tsx using @dnd-kit, create projectsStore.ts"
    "0.5|Status Bar|docs/stories/lmas-dashboard/epic-0-foundation.md|apps/dashboard/src/components/layout/|Create StatusBar.tsx showing auth, rate limit, claude status, active agent"
    "1.1|Kanban Layout|docs/stories/lmas-dashboard/epic-1-story-board.md|apps/dashboard/src/components/kanban/|Create KanbanBoard.tsx with 7 columns, create storyStore.ts"
    "1.6|Story Wizard|docs/stories/lmas-dashboard/epic-1-story-board.md|apps/dashboard/src/components/stories/|Create StoryWizard.tsx modal with multi-step form, draft auto-save"
)
...
echo ""
echo -e "${CYAN}╔═══════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     ${YELLOW}LMAS Dashboard Phase 3${NC}                                ${CYAN}║${NC}"
echo -e "${CYAN}╠═══════════════════════════════════════════════════════════╣${NC}"

...
const FILES = {
  // Core Engine
  'core/engine.js': '.lmas-core/core/synapse/engine.js',
  'core/context/context-tracker.js': '.lmas-core/core/synapse/context/context-tracker.js',
  'core/domain/domain-loader.js': '.lmas-core/core/synapse/domain/domain-loader.js',
  'core/layers/layer-processor.js': '.lmas-core/core/synapse/layers/layer-processor.js',
  'core/layers/l0-constitution.js': '.lmas-core/core/synapse/layers/l0-constitution.js',
  'core/layers/l1-global.js': '.lmas-core/core/synapse/layers/l1-global.js',
  'core/layers/l2-agent.js': '.lmas-core/core/synapse/layers/l2-agent.js',
  'core/layers/l3-workflow.js': '.lmas-core/core/synapse/layers/l3-workflow.js',
  'core/layers/l4-task.js': '.lmas-core/core/synapse/layers/l4-task.js',
  'core/layers/l5-squad.js': '.lmas-core/core/synapse/layers/l5-squad.js',
  'core/layers/l6-keyword.js': '.lmas-core/core/synapse/layers/l6-keyword.js',
  'core/layers/l7-star-command.js': '.lmas-core/core/synapse/layers/l7-star-command.js',
  'core/memory/memory-bridge.js': '.lmas-core/core/synapse/memory/memory-bridge.js',
  'core/output/formatter.js': '.lmas-core/core/synapse/output/formatter.js',
  'core/session/session-manager.js': '.lmas-core/core/synapse/session/session-manager.js',
  'core/scripts/generate-constitution.js': '.lmas-core/core/synapse/scripts/generate-constitution.js',
  'core/utils/paths.js': '.lmas-core/core/synapse/utils/paths.js',
  'core/utils/tokens.js': '.lmas-core/core/synapse/utils/tokens.js',

  // Diagnostics
  'core/diagnostics/synapse-diagnostics.js': '.lmas-core/core/synapse/diagnostics/synapse-diagnostics.js',
  'core/diagnostics/report-formatter.js': '.lmas-core/core/synapse/diagnostics/report-formatter.js',
  'core/diagnostics/collectors/safe-read-json.js': '.lmas-core/core/synapse/diagnostics/collectors/safe-read-json.js',
  'core/diagnostics/collectors/hook-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/hook-collector.js',
  'core/diagnostics/collectors/session-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/session-collector.js',
  'core/diagnostics/collectors/manifest-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/manifest-collector.js',
  'core/diagnostics/collectors/pipeline-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/pipeline-collector.js',
  'core/diagnostics/collectors/uap-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/uap-collector.js',
  'core/diagnostics/collectors/timing-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/timing-collector.js',
  'core/diagnostics/collectors/quality-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/quality-collector.js',
  'core/diagnostics/collectors/consistency-collector.js': '.lmas-core/core/synapse/diagnostics/collectors/consistency-collector.js',
  'core/diagnostics/collectors/output-analyzer.js': '.lmas-core/core/synapse/diagnostics/collectors/output-analyzer.js',
  'core/diagnostics/collectors/relevance-matrix.js': '.lmas-core/core/synapse/diagnostics/collectors/relevance-matrix.js',
...
const RUNTIME_DOMAINS = [
  ...
  'agent-ux', 'agent-lmas-master', 'agent-squad-creator',
...
engine for LMAS. On every user prompt, it injects \`<synapse-rules>\` with adaptive
...
\`\`\`
cp -r core/ <your-project>/.lmas-core/core/synapse/
\`\`\`
...
├── core/                      # Engine source (.lmas-core/core/synapse/)

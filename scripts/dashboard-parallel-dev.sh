#!/bin/bash
# =============================================================================
# LMAS Dashboard Parallel Dev - v2.0
# =============================================================================
...
declare -a STORIES=(
    "0.3|Layout Shell|docs/stories/lmas-dashboard/epic-0-foundation.md|apps/dashboard/src/components/layout/|Create Sidebar.tsx, AppShell.tsx following Auto-Claude layout"
    "0.1|Status Reader|docs/stories/lmas-dashboard/epic-0-foundation.md|apps/dashboard/src/app/api/status/|Create API route that reads .lmas/dashboard/status.json"
    "1.2|Story Card|docs/stories/lmas-dashboard/epic-1-story-board.md|apps/dashboard/src/components/stories/|Create StoryCard.tsx with badges, progress, agent indicator"
)
...
echo ""
echo -e "${CYAN}╔═══════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     ${YELLOW}LMAS Dashboard Parallel Dev v2.0${NC}                     ${CYAN}║${NC}"
echo -e "${CYAN}╠═══════════════════════════════════════════════════════════╣${NC}"

 ...
 */
const EVENT_MAPPING = {
  // LMAS Event -> { claude: ClaudeEvent, gemini: GeminiEvent }
...
class UnifiedHook {
   ...
   * @param {string} config.event - LMAS event name
  ...
  toClaudeConfig() {
    ...
    // Runners not yet implemented - path .lmas-core/hooks/unified/runners/ does not exist
    return null;

    // return {
    //   event: claudeEvent,
    //   matcher: this.matcher,
    //   handler: `node .lmas-core/hooks/unified/runners/claude-runner.js ${this.name}`,
    // };
  }
  ...
  toGeminiConfig() {
    ...
    //       name: this.name,
    //       type: 'command',
    //       command: `node .lmas-core/hooks/unified/runners/gemini-runner.js ${this.name}`,

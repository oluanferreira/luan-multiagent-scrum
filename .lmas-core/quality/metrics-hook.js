 ...
 * const { recordPreCommitMetrics } = require('./.lmas-core/quality/metrics-hook');
 ...
 * @param {Object} [result.quinn] - Oracle (QA agent) findings
 * @param {Object} [result.metadata] - Additional metadata
 * @returns {Promise<Object>} Recorded run
 *
 * @example
 * const { recordPRReviewMetrics } = require('./.lmas-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordHumanReviewMetrics } = require('./.lmas-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { withPreCommitMetrics } = require('./.lmas-core/quality/metrics-hook');
 *

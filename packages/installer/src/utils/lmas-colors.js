/**
 * LMAS Color Palette v5.0.0
 *
 * Brand color system for CLI tools and terminal output.
 * Colors derived from LMAS brand identity: Lime + Cream on Dark surfaces.
 *
 * @see docs/standards/LMAS-COLOR-PALETTE-V2.1.md
 * @module lmas-colors
 */
...
const colors = {
  ...
  /**
   * Primary branding - Bold lime for LMAS brand moments
   */
...
const examples = {
  welcome: () => {
    console.log(headings.h1('🎉 Welcome to LMAS v4 Installer!'));
  ...
  complete: () => {
    ...
    console.log(colors.info('Your LMAS project is ready to use.'));

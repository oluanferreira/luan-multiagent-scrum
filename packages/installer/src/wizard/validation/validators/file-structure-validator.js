...
async function validateFiles(fileContext = {}) {
  ...
  try {
    ...
    const coreConfigPath = fileContext.coreConfig || '.lmas-core/core-config.yaml';
    ...
    // Validate directory structure - only .lmas-core is required
    const requiredDirs = ['.lmas-core'];

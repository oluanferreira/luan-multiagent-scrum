...
const TRANSLATIONS = {
  en: {
    ...
    proContactSupportEmail: 'Or open an issue: https://github.com/oluanferreira/aiox-core/issues',
  ...
  pt: {
    ...
    proContactSupportEmail: 'Ou abra uma issue: https://github.com/oluanferreira/aiox-core/issues',
  ...
  es: {
    ...
    proContactSupportEmail: 'O abra un issue: https://github.com/oluanferreira/aiox-core/issues',

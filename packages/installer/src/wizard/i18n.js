/**
 * Internationalization (i18n) for LMAS Wizard
 *
...
const TRANSLATIONS = {
  en: {
    ...
    // Progress messages
    installingCore: 'Installing LMAS core...',
    ...
    proNoAccess: 'No LMAS Pro access found for this email.',
    proContactSupport: 'If you believe this is an error, please contact support:',
    proPurchase: 'Purchase Pro: https://pro.lmas.ai',
    ...
    proForgotPassword: 'Forgot your password? Visit https://lmas-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'Or open an issue: https://github.com/oluanferreira/lmas-core/issues',
    proAuthFailed: 'Authentication failed: {message}',
    proCreateAccount: 'Create your LMAS Pro account to get started.',
    ...
    proPurchaseAt: 'Purchase Pro at https://pro.lmas.ai',
    ...
    proModuleNotAvailable: 'Pro license module not available. Ensure @lmas-fullstack/pro is installed.',
    proModuleBootstrap: 'Pro license module not found locally. Installing @lmas-fullstack/pro to bootstrap...',
    ...
    proInstallingPackage: 'Installing @lmas-fullstack/pro...',
    proPackageInstalled: 'Pro package installed',
    proPackageInstallFailed: 'Failed to install Pro package',
    proScaffolderNotAvailable: 'Pro scaffolder not available. Ensure @lmas-fullstack/pro is installed.',
    ...
    proInstallComplete: 'LMAS Pro installation complete!',
    proNeedHelp: 'Need help? Run: npx lmas-pro recover',
    proCISetEnv: 'CI mode: Set LMAS_PRO_EMAIL + LMAS_PRO_PASSWORD or LMAS_PRO_KEY environment variables.',
    ...
    proNpmInstallFailed: 'npm install @lmas-fullstack/pro failed: {message}. Try manually: npm install @lmas-fullstack/pro',
  },
  ...
  pt: {
    ...
    // User Profile (Story 10.2 - Epic 10: User Profile System)
    // PRD: LMAS v2.0 "Projeto Bob" - Seção 2.4 (exact copy)
    ...
    // Progress messages
    installingCore: 'Instalando LMAS core...',
    ...
    proNoAccess: 'Nenhum acesso LMAS Pro encontrado para este email.',
    proContactSupport: 'Se você acredita que isso é um erro, entre em contato com o suporte:',
    proPurchase: 'Comprar Pro: https://pro.lmas.ai',
    ...
    proForgotPassword: 'Esqueceu sua senha? Acesse https://lmas-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'Ou abra uma issue: https://github.com/oluanferreira/lmas-core/issues',
    proAuthFailed: 'Falha na autenticação: {message}',
    proCreateAccount: 'Crie sua conta LMAS Pro para começar.',
    ...
    proPurchaseAt: 'Compre o Pro em https://pro.lmas.ai',
    ...
    proModuleNotAvailable: 'Módulo de licença Pro não disponível. Certifique-se de que @lmas-fullstack/pro está instalado.',
    proModuleBootstrap: 'Módulo de licença Pro não encontrado localmente. Instalando @lmas-fullstack/pro...',
    ...
    proInstallingPackage: 'Instalando @lmas-fullstack/pro...',
    proPackageInstalled: 'Pacote Pro instalado',
    proPackageInstallFailed: 'Falha ao instalar pacote Pro',
    proScaffolderNotAvailable: 'Scaffolder Pro não disponível. Certifique-se de que @lmas-fullstack/pro está instalado.',
    ...
    proInstallComplete: 'Instalação do LMAS Pro completa!',
    proNeedHelp: 'Precisa de ajuda? Execute: npx lmas-pro recover',
    proCISetEnv: 'Modo CI: Defina as variáveis LMAS_PRO_EMAIL + LMAS_PRO_PASSWORD ou LMAS_PRO_KEY.',
    ...
    proNpmInstallFailed: 'npm install @lmas-fullstack/pro falhou: {message}. Tente manualmente: npm install @lmas-fullstack/pro',
  },
  ...
  es: {
    ...
    proNoAccess: 'No se encontró acceso LMAS Pro para este email.',
    ...
    proForgotPassword: '¿Olvidó su contraseña? Visite https://lmas-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'O abra un issue: https://github.com/oluanferreira/lmas-core/issues',
    proAuthFailed: 'Error de autenticación: {message}',
    proCreateAccount: 'Cree su cuenta LMAS Pro para comenzar.',
    ...
    proPurchaseAt: 'Compre Pro en https://pro.lmas.ai',
    ...
    proModuleNotAvailable: 'Módulo de licencia Pro no disponible. Asegúrese de que @lmas-fullstack/pro esté instalado.',
    proModuleBootstrap: 'Módulo de licencia Pro no encontrado localmente. Instalando @lmas-fullstack/pro...',
    ...
    proScaffolderNotAvailable: 'Scaffolder Pro no disponible. Asegúrese de que @lmas-fullstack/pro esté instalado.',
    ...
    proInstallComplete: '¡Instalación de LMAS Pro completa!',
    proNeedHelp: '¿Necesita ayuda? Ejecute: npx lmas-pro recover',
    proCISetEnv: 'Modo CI: Configure las variables LMAS_PRO_EMAIL + LMAS_PRO_PASSWORD o LMAS_PRO_KEY.',
    ...
    proNpmInstallFailed: 'npm install @lmas-fullstack/pro falló: {message}. Intente manualmente: npm install @lmas-fullstack/pro',
  },
};

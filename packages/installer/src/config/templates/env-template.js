...
/**
 * Get the current LMAS version from package.json
 * @returns {string} The version string
 */
function getLmasVersion() {
  try {
...
const LMAS_VERSION = getLmasVersion();

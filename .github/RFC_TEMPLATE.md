...
>
> - Someone familiar with LMAS can understand
...
**Note:** This template follows the LMAS RFC process. For questions about the process, see [CONTRIBUTING.md](/CONTRIBUTING.md).

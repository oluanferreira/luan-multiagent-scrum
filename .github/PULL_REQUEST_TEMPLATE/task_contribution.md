...
<!-- Thank you for contributing a task to LMAS! Please fill out this template. -->

### Task Information

- **Task Name:** <!-- e.g., db-validate-kiss -->
- **Task File:** <!-- e.g., .lmas-core/development/tasks/db-validate-kiss.md -->

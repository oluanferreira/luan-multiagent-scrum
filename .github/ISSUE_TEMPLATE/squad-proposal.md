---
name: Squad Proposal
about: Propose a new LMAS Squad for the framework
title: '[SQUAD] '
...
### 📋 Description
A clear and concise description of what this LMAS Squad does and what domain it covers.

> LMAS Squads are modular teams of AI agents that work together to accomplish specialized tasks.
...
# Or via CLI
lmas squad activate my-domain
```

### 📦 Dependencies
- **Core Framework:** Required lmas-core version?
- **Other Squads:** Any dependencies on other LMAS Squads?
- **External Services:** Any API keys or external services needed?

### 🔒 License & Distribution
- [ ] This squad will be open-source (MIT) in `lmas-squads` repo
...
### ✅ Checklist
- [ ] Squad follows LMAS structure (`{squad}/agents/`, `{squad}/tasks/`, etc.)
...
**Note:** All squad proposals are reviewed by maintainers. Approved squads may be included in the official `lmas-squads` repository.

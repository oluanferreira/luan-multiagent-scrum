...
This directory contains automated workflows for the LMAS project.
...
> **Note:** Legacy 1MCP metrics have been deprecated. LMAS now uses Docker MCP Toolkit exclusively (Story 5.11).

...
jest.mock('../../.lmas-core/core/synapse/context/context-tracker', () => ({
...
// Mock formatter
jest.mock('../../.lmas-core/core/synapse/output/formatter', () => ({
...
jest.mock('../../.lmas-core/core/synapse/layers/l0-constitution', () => {
...
jest.mock('../../.lmas-core/core/synapse/layers/l1-global', () => {
...
jest.mock('../../.lmas-core/core/synapse/layers/l2-agent', () => {
...
jest.mock('../../.lmas-core/core/synapse/layers/l3-workflow', () => {
...
jest.mock('../../.lmas-core/core/synapse/layers/l4-task', () => {
  const err = new Error("Cannot find module './layers/l4-task'");
  err.code = 'MODULE_NOT_FOUND';
  throw err;
}, { virtual: true });

jest.mock('../../.lmas-core/core/synapse/layers/l5-squad', () => {
  const err = new Error("Cannot find module './layers/l5-squad'");
  err.code = 'MODULE_NOT_FOUND';
  throw err;
}, { virtual: true });

jest.mock('../../.lmas-core/core/synapse/layers/l6-keyword', () => {
  const err = new Error("Cannot find module './layers/l6-keyword'");
  err.code = 'MODULE_NOT_FOUND';
  throw err;
}, { virtual: true });

jest.mock('../../.lmas-core/core/synapse/layers/l7-star-command', () => {
...
jest.mock('../../.lmas-core/core/synapse/memory/memory-bridge', () => ({
...
const { SynapseEngine, PipelineMetrics, PIPELINE_TIMEOUT_MS } = require('../../.lmas-core/core/synapse/engine');
const contextTracker = require('../../.lmas-core/core/synapse/context/context-tracker');
const formatter = require('../../.lmas-core/core/synapse/output/formatter');

...
jest.mock('../../.lmas-core/core/synapse/memory/synapse-memory-provider', () => ({
...
const { MemoryBridge, BRACKET_LAYER_MAP, BRIDGE_TIMEOUT_MS } = require('../../.lmas-core/core/synapse/memory/memory-bridge');

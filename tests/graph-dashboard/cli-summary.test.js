...
jest.mock('../../.lmas-core/core/graph-dashboard/data-sources/code-intel-source', () => ({
...
jest.mock('../../.lmas-core/core/graph-dashboard/data-sources/registry-source', () => ({
...
jest.mock('../../.lmas-core/core/graph-dashboard/data-sources/metrics-source', () => ({
...
const { handleSummary, handleDeps, FORMAT_MAP, VALID_FORMATS } = require('../../.lmas-core/core/graph-dashboard/cli');
...
describe('cli-summary', () => {
  ...
  describe('handleSummary', () => {
    it('should render all three sections', async () => {
      ...
      expect(output).toContain('LMAS Graph Dashboard');

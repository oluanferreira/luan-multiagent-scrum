...
describe('errors', () => {
  describe('ProFeatureError', () => {
    ...
    it('should include activation instructions in message', () => {
      ...
      expect(error.message).toContain('Premium Squads requires an active LMAS Pro license');
      expect(error.message).toContain('lmas pro activate --key <KEY>');
      expect(error.message).toContain('https://lmas.ai/pro');
    });
    ...
    describe('toCliMessage', () => {
      it('should return formatted CLI message', () => {
        ...
        expect(cliMsg).toContain('Premium Squads requires an active LMAS Pro license');
    ...
    describe('toJSON', () => {
      it('should return JSON-serializable object', () => {
        ...
        expect(json.message).toContain('requires an active LMAS Pro license');

...
const WorkflowOrchestrator = require('../../../.lmas-core/core/orchestration/workflow-orchestrator');
...
describe('WorkflowOrchestrator execution profile propagation', () => {
  ...
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), 'lmas-workflow-profile-'));

...
const {
  BobOrchestrator,
  ProjectState,
} = require('../../../.lmas-core/core/orchestration/bob-orchestrator');
...
jest.mock('../../../.lmas-core/core/orchestration/message-formatter', () => ({
...
jest.mock('../../../.lmas-core/core/orchestration/brownfield-handler', () => ({
...
jest.mock('../../../.lmas-core/core/orchestration/executor-assignment', () => ({
...
jest.mock('../../../.lmas-core/core/orchestration/terminal-spawner', () => ({
  spawnAgent: jest.fn().mockResolvedValue({ success: true, output: 'done' }),
  isSpawnerAvailable: jest.fn().mockReturnValue(true),
}));

jest.mock('../../../.lmas-core/core/orchestration/workflow-executor', () => {
  return {
...
jest.mock('../../../.lmas-core/core/ui/observability-panel', () => ({
...
jest.mock('../../../.lmas-core/core/orchestration/bob-status-writer', () => ({
...
jest.mock('../../../.lmas-core/core/events/dashboard-emitter', () => ({
...
jest.mock('../../../.lmas-core/core/orchestration/surface-checker', () => {
...
jest.mock('../../../.lmas-core/core/orchestration/session-state', () => {
...
jest.mock('../../../.lmas-core/core/orchestration/lock-manager', () => {
...
jest.mock('../../../.lmas-core/core/orchestration/data-lifecycle-manager', () => {
...
const { resolveConfig } = require('../../../.lmas-core/core/config/config-resolver');
...
describe('BobOrchestrator', () => {
  ...
  beforeEach(async () => {
    ...
    await fs.mkdir(path.join(TEST_PROJECT_ROOT, '.lmas/locks'), { recursive: true });
  ...
  describe('orchestrate', () => {
    it('should return lock_failed when lock cannot be acquired', async () => {
      // Given
      const LockManager = require('../../../.lmas-core/core/orchestration/lock-manager');
  ...
  describe('constraint: router not god class (AC13)', () => {
    it('should have less than 50 lines of other-agent-specific logic', async () => {
      ...
      const sourcePath = path.join(
        __dirname,
        '../../../.lmas-core/core/orchestration/bob-orchestrator.js',
      );
  ...
  describe('Educational Mode (Story 12.7)', () => {
    ...
    describe('handleEducationalModeToggle (AC6)', () => {
      ...
      it('should persist to user config for permanent type', async () => {
        // Given
        const { setUserConfigValue } = require('../../../.lmas-core/core/config/config-resolver');

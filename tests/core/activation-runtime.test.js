...
jest.mock('../../.lmas-core/development/scripts/unified-activation-pipeline', () => ({
...
const { ActivationRuntime, activateAgent } = require('../../.lmas-core/development/scripts/activation-runtime');

...
const { DashboardEmitter, getDashboardEmitter } = require('../../../.lmas-core/core/events/dashboard-emitter');
const { DashboardEventType } = require('../../../.lmas-core/core/events/types');
...
describe('DashboardEmitter Bob-specific methods', () => {
  ...
  beforeEach(async () => {
    ...
    emitter.fallbackPath = path.join(tempDir, '.lmas', 'dashboard', 'events.jsonl');
  });

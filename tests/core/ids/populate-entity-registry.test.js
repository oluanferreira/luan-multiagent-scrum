...
const {
  ...
  EXTERNAL_TOOLS,
  DEPRECATED_PATTERNS,
} = require('../../../.lmas-core/development/scripts/populate-entity-registry');
...
describe('populate-entity-registry (AC: 3, 4, 12)', () => {
  ...
  describe('resolveUsedBy enhanced (NOG-15 AC4)', () => {
    it('creates correct reverse references via name index', () => {
      const entities = {
        tasks: {
          'task-a': {
            path: '.lmas-core/development/tasks/task-a.md',
            type: 'task',
            dependencies: ['util-x'],
            usedBy: [],
          },
        ...
        utils: {
          'util-x': {
            path: '.lmas-core/core/utils/util-x.js',
            type: 'util',
            dependencies: [],
            usedBy: [],
          },
    ...
    it('resolves by filename when ID does not match', () => {
      const entities = {
        tasks: {
          'my-task': {
            path: '.lmas-core/development/tasks/my-task.md',
            type: 'task',
        ...
        scripts: {
          helper: {
            path: '.lmas-core/development/scripts/helper.js',
            type: 'script',
            dependencies: [],
            usedBy: [],
          },
  ...
  describe('buildNameIndex() (NOG-16A AC5)', () => {
    it('builds index from entity IDs, filenames, and basenames', () => {
      const entities = {
        tasks: {
          'task-a': { path: '.lmas-core/development/tasks/task-a.md', dependencies: [], usedBy: [] },
        },
        scripts: {
          helper: { path: '.lmas-core/development/scripts/helper.js', dependencies: [], usedBy: [] },
        },
      };
  ...
  describe('regression: real deps preserved (NOG-16A AC6)', () => {
    it('dev agent still has 40+ dependencies after filtering (all extractors combined)', () => {
      const devAgentPath = path.resolve(__dirname, '../../../.lmas-core/development/agents/dev.md');

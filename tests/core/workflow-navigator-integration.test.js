...
const { SessionState } = require('../../.lmas-core/core/orchestration/session-state');
const { SurfaceChecker } = require('../../.lmas-core/core/orchestration/surface-checker');
...
describe('WorkflowNavigator Integration (Story ACT-5)', () => {
    ...
    mockAgent = {
      ...
      persona_profile: {
        greeting_levels: {
          ...
          archetypal: '\uD83D\uDCBB Neo the Builder ready!',
        },
        communication: {
          signature_closing: '-- Neo, always building',
        },
      },
      persona: {
  ...
  describe('AC5: Bob orchestration patterns in workflow-patterns.yaml', () => {
    ...
    beforeAll(() => {
      const patternsPath = path.join(
        __dirname,
        '../../.lmas-core/data/workflow-patterns.yaml',
      );
  ...
  describe('UnifiedActivationPipeline _detectWorkflowState relaxation', () => {
    ...
    beforeEach(() => {
      ...
      jest.mock('../../.lmas-core/development/scripts/greeting-builder');
      ...
      const { UnifiedActivationPipeline } = require('../../.lmas-core/development/scripts/unified-activation-pipeline');
      const MockWorkflowNavigator = require('../../.lmas-core/development/scripts/workflow-navigator');

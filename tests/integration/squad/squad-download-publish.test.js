 ...
 * Set LMAS_INTEGRATION_TESTS=true to run network tests.
 *
...
const RUN_NETWORK_TESTS = process.env.LMAS_INTEGRATION_TESTS === 'true';
...
`,
  ...
  describe('List available squads from registry (Test 4.4)', () => {
    ...
    conditionalTest(
      'should list squads from lmas-squads registry',
      async () => {

...
const { onPreCompact, getHookConfig } = require('../../../../.lmas-core/hooks/unified/runners/precompact-runner');
...
describe('PreCompact Hook Runner', () => {
  ...
  describe('onPreCompact', () => {
    ...
    it('should gracefully no-op when lmas-pro not available', async () => {
      proDetector.isProAvailable.mockReturnValue(false);
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[PreCompact] lmas-pro not available, skipping session digest',
      );
    });

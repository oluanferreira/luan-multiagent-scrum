...
const { RegistryProvider, LAYER_PRIORITY } = require('../../../.lmas-core/core/code-intel/providers/registry-provider');
const { CodeIntelProvider } = require('../../../.lmas-core/core/code-intel/providers/provider-interface');
const { CodeGraphProvider } = require('../../../.lmas-core/core/code-intel/providers/code-graph-provider');
const { CodeIntelClient, CB_CLOSED } = require('../../../.lmas-core/core/code-intel/code-intel-client');
...
entities:
  tasks:
    create-story:
      path: .lmas-core/development/tasks/create-story.md
      layer: L2
      type: task
      ...
      dependencies:
        - story-template
    validate-story:
      path: .lmas-core/development/tasks/validate-story.md
      layer: L2
      type: task
  ...
  agents:
    dev-agent:
      path: .lmas-core/development/agents/dev.md
      layer: L2
      type: agent
      ...
      dependencies:
        - create-story
    sm-agent:
      path: .lmas-core/development/agents/sm.md
      layer: L2
      type: agent
  ...
  templates:
    story-template:
      path: .lmas-core/development/templates/story-tmpl.yaml
      layer: L2
      type: template
  ...
  core:
    code-intel-client:
      path: .lmas-core/core/code-intel/code-intel-client.js
      layer: L1
      type: module
...
entities:
  tasks:
    yaml-validator:
      path: .lmas-core/development/tasks/yaml-validator.md
      layer: L2
      type: task
      ...
      dependencies: []
    index:
      path: .lmas-core/development/tasks/index.md
      layer: L2
      type: task
  ...
  scripts:
    yaml-validator:
      path: .lmas-core/development/scripts/yaml-validator.js
      layer: L2
      type: script
      ...
      dependencies: []
    backup-manager:
      path: .lmas-core/development/scripts/backup-manager.js
      layer: L2
      type: script
  ...
  core:
    yaml-validator:
      path: .lmas-core/core/yaml-validator.js
      layer: L1
      type: module
    ...
    index:
      ...
      dependencies: []
    backup-manager:
      path: .lmas-core/core/backup-manager.js
      layer: L1
      type: module
  ...
  templates:
    yaml-validator:
      path: .lmas-core/development/templates/yaml-validator.yaml
      layer: L3
      type: template
      ...
      dependencies: []
    index:
      path: .lmas-core/development/templates/index.yaml
      layer: L3
      type: template
      ...
      dependencies: []
    backup-manager:
      path: .lmas-core/development/templates/backup-manager.yaml
      layer: L3
      type: template
...
describe('RegistryProvider — 5 Implemented Primitives', () => {
  ...
  describe('findDefinition()', () => {
    test('finds entity by exact name', async () => {
      ...
      expect(result.file).toBe('.lmas-core/development/tasks/create-story.md');
  ...
  describe('findReferences()', () => {
    ...
    test('finds references via dependencies field', async () => {
      ...
      expect(paths).toContain('.lmas-core/development/tasks/create-story.md');
    });
...
describe('RegistryProvider — Entity Name Disambiguation', () => {
  ...
  test('yaml-validator has 4 entries, all preserved in index', async () => {
    ...
    expect(result.file).toBe('.lmas-core/core/yaml-validator.js');
  });
  ...
  test('disambiguation scoring: L1 > L2 > L3', async () => {
    ...
    const result = await provider.findDefinition('yaml-validator');
    expect(result.file).toContain('.lmas-core/core/');
  });
});

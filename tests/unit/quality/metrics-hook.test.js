...
const {
  ...
  getQuickSummary,
} = require('../../../.lmas-core/quality/metrics-hook');
const { MetricsCollector } = require('../../../.lmas-core/quality/metrics-collector');
...
describe('Metrics Hook', () => {
  ...
  describe('recordPRReviewMetrics', () => {
    ...
    it('should record PR review with Oracle data', async () => {
      const result = await recordPRReviewMetrics({
        passed: true,
        durationMs: 120000,
        quinn: {

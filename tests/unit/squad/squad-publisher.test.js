...
describe('SquadPublisher', () => {
  ...
  describe('Constants', () => {
    it('should export LMAS_SQUADS_REPO', () => {
      expect(LMAS_SQUADS_REPO).toBe('LMAS/lmas-squads');
    });
  ...
  describe('Constructor', () => {
    ...
    it('should use default repo when not specified', () => {
      const defaultPublisher = new SquadPublisher();
      expect(defaultPublisher.repo).toBe(LMAS_SQUADS_REPO);
    });
  ...
  describe('publish()', () => {
    ...
    it('should return preview in dry run mode', async () => {
      ...
      expect(result.preview.repo).toBe(LMAS_SQUADS_REPO);
  ...
  describe('generatePRBody()', () => {
    ...
    it('should include checklist in PR body', () => {
      ...
      expect(body).toContain('[x] Squad follows LMAS task-first architecture');
    ...
    it('should include submit attribution', () => {
      ...
      expect(body).toContain('LMAS-FullStack');
    });
  });

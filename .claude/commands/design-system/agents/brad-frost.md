...
> Integrates with LMAS via `/DS:agents:brad-frost` skill.
...
# ============================================================
# OUTPUT EXAMPLES (LMAS Standard - 3+ examples)
# ============================================================
output_examples:
...
status:
  ...
  note: |
    ...
    Integrates with LMAS via /SA:design-system skill.
```

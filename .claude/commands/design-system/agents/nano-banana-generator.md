...
2. **Gotchas**: Read `.lmas/gotchas.json` (filter for Design, Image, AI-relevant)
3. **Technical Preferences**: Read `.lmas-core/data/technical-preferences.md`
4. **Project Config**: Read `.lmas-core/core-config.yaml`

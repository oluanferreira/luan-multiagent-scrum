...
O Synkra LMAS segue uma hierarquia clara de prioridades que deve guiar **TODAS** as decisões:
...
*Synkra LMAS Claude Code Configuration v4.0*
*CLI First | Observability Second | UI Third*

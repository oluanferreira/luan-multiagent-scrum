...
> Schema definitions for LMAS agents and tasks with Auto-Claude capabilities.
...
- **V2 (Legacy)**: Current LMAS format without `autoClaude` section
...
```yaml
agent:
  name: string # Persona name (e.g., 'Neo')
...
```bash
node validate-v3-schema.js .lmas-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js --diff .lmas-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js .lmas-core/development/agents/dev.md --strict
```
...
- PRD: `docs/prd/lmas-autonomous-development-engine.md`
- Auto-Claude Analysis: `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md`
- Migration Stories: `docs/stories/lmas-core-ade/epic-2-migration-v2-v3.md`
...
_LMAS V3 Schemas - Synkra Framework_

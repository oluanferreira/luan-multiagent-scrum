...
The `setup-environment` workflow helps developers configure their IDE for optimal LMAS development experience.

### Features
- Backs up existing IDE configurations
- Applies LMAS-specific development rules
- Verifies GitHub CLI installation and authentication
- Provides clear feedback throughout the process

### Usage

From the lmas-master agent:
```
@lmas-master
*setup-environment
```
...
4. **Rule Application** - Copies LMAS-specific rules to appropriate locations

...
Cria um novo squad seguindo a arquitetura task-first do LMAS.
...
📚 Documentation:
   ...
   - Task Format: .lmas-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md
...
```javascript
const { SquadGenerator } = require('./.lmas-core/development/scripts/squad');

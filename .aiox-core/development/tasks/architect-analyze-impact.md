...
*analyze-impact deprecate lmas-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation-impact.html
...
*analyze-impact remove lmas-core/workflows/legacy-workflow.yaml --depth deep --save-report reports/removal-impact.json
```
...
class AnalyzeImpactTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🔍 LMAS Impact Analysis'));
...
{
  "success": true,
  "targetComponent": "lmas-core/agents/weather-agent.md",
  "riskLevel": "medium",

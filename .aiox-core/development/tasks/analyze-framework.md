...
- **Tool:** code-analyzer
  ...
  - **Source:** .lmas-core/utils/code-analyzer.js
...
- **Script:** analyze-codebase.js
  ...
  - **Language:** JavaScript
  - **Location:** .lmas-core/scripts/analyze-codebase.js
...
module.exports = {
  ...
  async saveReport(analysis) {
    const reportsDir = path.join(process.cwd(), '.lmas', 'reports');
...
---
*Report generated by LMAS Framework Analyzer*
`;
  }
};
```

...
Downloads public squads from the lmas-squads GitHub repository to use in your project.
...
Available Squads (from lmas-squads):
...
Downloading: etl-squad@1.0.0
  Source: github.com/SynkraAI/lmas-squads/packages/etl-squad
...
```
1. Fetch registry.json from lmas-squads
...
The registry.json in lmas-squads contains:

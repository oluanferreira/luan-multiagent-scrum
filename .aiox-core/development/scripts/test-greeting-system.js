...
const mockDevAgent = {
  ...
  persona_profile: {
    ...
    greeting_levels: {
      minimal: '💻 Neo ready',
      named: '💻 Neo (Builder) ready. Let\'s build something solid!',
      archetypal: '💻 Neo the Builder (♒ Aquarius) ready to construct excellence!',
    },
  },
  persona: {
...
const mockPoAgent = {
  ...
  persona_profile: {
    ...
    zodiac: '♎ Libra',
    greeting_levels: {
      minimal: '⚖️ Keymaker ready',
      named: '⚖️ Keymaker (Balancer) ready. Let\'s prioritize together!',
      archetypal: '⚖️ Keymaker the Balancer (♎ Libra) ready to harmonize requirements!',
    },
  },
  persona: {

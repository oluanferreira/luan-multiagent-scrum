...
**Version:** 2.1.0
**Date:** 2025-12-09
**Purpose:** Document differences between LMAS open-source and LMAS service implementations
...
LMAS has two deployment contexts:
...
|---------|----------|--------------|
| `@lmas/core` | npm public | Open-source |
| `@lmas/squad-etl` | npm public | Open-source |
| `@lmas/squad-creator` | npm public | Open-source |
| `@lmas/squad-mmos` | npm public | Open-source |
| `@lmas/mcp-presets` | npm public | Open-source |
...
```yaml
**Template:**
- path: .lmas-core/templates/task-execution-report.md
  type: output
  version: 1.0
...
**Difference:**
- Open-source uses templates from `.lmas-core/templates/`
...
.lmas-core/checklists/{agent-id}-general-validation.md
```
...
- `.lmas-core/scripts/{agent-id}-specific/{script}.js`
...
**Scripts:**
- .lmas-core/scripts/dev-specific/test-runner.js:    # Only dev uses this
...
- Missing template → Use generic template from `.lmas-core/templates/`
...
- fallback: |
    ...
    1. Check .lmas-core/templates/ for generic version
...
**Agent Personas:**
- Defined in `.lmas-core/agents/{agent-id}.md`
- All 11 agents have personas (Neo, Oracle, Keymaker, etc.)
...
- [ ] Update template paths (squads/ → .lmas-core/templates)
...
| **Templates** | .lmas-core/templates/ | squads/{squad}/ |
...
- [LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md](./LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Complete v4.2 framework guide
...
| 2025-12-09 | 2.1.0 | Added Multi-Repo Strategy section, updated terminology (Squad), updated related docs | @dev (Neo) |

---

**Last Updated:** 2025-12-09
**Version:** 2.1.0
**Applies to:** LMAS v4.2+

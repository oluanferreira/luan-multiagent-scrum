# Synkra LMAS Development Rules for AntiGravity
...
### Agent Integration
- Recognize LMAS agent activations: @dev, @qa, @architect, @pm, @po, @sm, @analyst
...
---
*Synkra LMAS AntiGravity Configuration v1.0*

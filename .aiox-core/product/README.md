...
```javascript
const templatePath = '.lmas-core/product/templates/story-tmpl.yaml';
const checklistPath = '.lmas-core/product/checklists/story-dod-checklist.md';
```

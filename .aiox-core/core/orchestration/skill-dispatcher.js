...
class SkillDispatcher {
  ...
  constructor(options = {}) {
     ...
     * These correspond to files in .claude/commands/LMAS/agents/
     */
    this.skillMapping = {
     ...
     */
    this.agentPersonas = {
      architect: { name: 'Architect', title: 'System Architect' },
      'data-engineer': { name: 'Dozer', title: 'Database Architect' },
      dev: { name: 'Neo', title: 'Senior Developer' },
      qa: { name: 'Oracle', title: 'QA Guardian' },
      pm: { name: 'Trinity', title: 'Project Manager' },
      po: { name: 'Keymaker', title: 'Product Owner' },
      sm: { name: 'Niobe', title: 'Scrum Master' },
      analyst: { name: 'Link', title: 'Business Analyst' },
      'ux-design-expert': { name: 'Switch', title: 'UX Design Expert' },
      'ux-expert': { name: 'Switch', title: 'UX Design Expert' },
      devops: { name: 'Operator', title: 'DevOps Engineer' },
      'lmas-master': { name: 'Morpheus', title: 'Master Orchestrator' },
    };
  }

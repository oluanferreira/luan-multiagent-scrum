...
This guide walks you through creating components in Synkra LMAS using the meta-agent's enhanced template system and interactive workflows.
...
1. **Check component examples**: `lmas-core/agents/examples/`
2. **Review templates**: `lmas-core/templates/`
...
Create custom templates in `lmas-core/templates/custom/`:

/**
 * InstallTransaction - Transaction manager for LMAS installer
 *
...
class InstallTransaction {
   ...
   */
  constructor(options = {}) {
    this.backupDir = options.backupDir || path.join(process.cwd(), '.lmas-backup', this._generateTimestamp());
    this.logFile = options.logFile || path.join(process.cwd(), '.lmas-install.log');
   ...
   *
   * @example
   * await transaction.backupDirectory('.lmas-core/');
   */

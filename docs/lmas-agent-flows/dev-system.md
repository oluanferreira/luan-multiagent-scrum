...
| **Fechamento** | "-- Neo, sempre construindo" |
...
|---------|---------|-----------|
| `.lmas-core/development/tasks/dev-develop-story.md` | `*develop {story-id}` | Task principal - desenvolve story completa com modos YOLO/Interactive/Pre-flight |
| `.lmas-core/development/tasks/dev-improve-code-quality.md` | `*improve-code-quality <path>` | Melhora qualidade do codigo (formatting, linting, modern-syntax) |
| `.lmas-core/development/tasks/dev-optimize-performance.md` | `*optimize-performance <path>` | Analisa e otimiza performance do codigo |
| `.lmas-core/development/tasks/dev-suggest-refactoring.md` | `*suggest-refactoring <path>` | Sugere oportunidades de refactoring automatizado |
| `.lmas-core/development/tasks/dev-backlog-debt.md` | `*backlog-debt` | Registra divida tecnica no backlog |
| `.lmas-core/development/tasks/apply-qa-fixes.md` | `*apply-qa-fixes` | Aplica correcoes baseadas em feedback de QA |
| `.lmas-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Valida documentacao usando checklists |
| `.lmas-core/development/tasks/validate-next-story.md` | `*validate-story-draft` | Valida qualidade e completude de stories |
| `.lmas-core/development/tasks/sync-documentation.md` | `*sync-documentation` | Sincroniza documentacao com mudancas de codigo |
| `.lmas-core/development/tasks/po-manage-story-backlog.md` | (usado internamente) | Gerencia backlog de stories |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/dev.md` | Definição core do agente @dev (persona, comandos, workflows) |
| `.claude/commands/LMAS/agents/dev.md` | Comando Claude Code para ativar @dev |
...
| `.lmas-core/product/checklists/pre-push-checklist.md` | Checklist antes de push |
| `.lmas-core/product/checklists/change-checklist.md` | Validacao de mudancas |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.lmas-core/development/tasks/qa-backlog-add-followup.md` | @qa | QA adiciona follow-ups ao backlog |
| `.lmas-core/development/tasks/qa-review-story.md` | @qa | QA revisa implementacao do @dev |
| `.lmas-core/development/tasks/github-devops-pre-push-quality-gate.md` | @github-devops | Quality gate antes de push |
| `.lmas-core/development/tasks/sm-create-next-story.md` | @sm | Scrum Master cria stories para @dev |

### Arquivos de Workflows que Usam @dev

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/workflows/brownfield-fullstack.yaml` | Workflow full-stack brownfield |
| `.lmas-core/development/workflows/brownfield-service.yaml` | Workflow de servico brownfield |
| `.lmas-core/development/workflows/brownfield-ui.yaml` | Workflow UI brownfield |
| `.lmas-core/development/workflows/greenfield-fullstack.yaml` | Workflow full-stack greenfield |
| `.lmas-core/development/workflows/greenfield-service.yaml` | Workflow de servico greenfield |
| `.lmas-core/development/workflows/greenfield-ui.yaml` | Workflow UI greenfield |
...
flowchart TB
    ...
    subgraph UPSTREAM["UPSTREAM - Fornece Stories"]
        SM["@sm (Niobe)<br/>Scrum Master"]
        PO["@po (Keymaker)<br/>Product Owner"]
    end

    subgraph PEER["PEER - Colaboracao"]
        QA["@qa (Oracle)<br/>Quality Assurance"]
    end

    subgraph DOWNSTREAM["DOWNSTREAM - Recebe Output"]
        GHDEVOPS["@github-devops (Operator)<br/>Git Operations"]
    end
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/core-config.yaml` | Configuracao central (devStoryLocation, coderabbit, etc.) |
| `.lmas-core/development/scripts/unified-activation-pipeline.js` | Pipeline canonico de ativacao e greeting |
| `.lmas-core/scripts/decision-recorder.js` | Logging de decisoes (YOLO mode) |
...
### Tasks do @dev
- [dev-develop-story.md](.lmas-core/development/tasks/dev-develop-story.md)
- [dev-improve-code-quality.md](.lmas-core/development/tasks/dev-improve-code-quality.md)
- [dev-optimize-performance.md](.lmas-core/development/tasks/dev-optimize-performance.md)
- [dev-suggest-refactoring.md](.lmas-core/development/tasks/dev-suggest-refactoring.md)
- [dev-backlog-debt.md](.lmas-core/development/tasks/dev-backlog-debt.md)
- [apply-qa-fixes.md](.lmas-core/development/tasks/apply-qa-fixes.md)

### Checklists
- [story-dod-checklist.md](.lmas-core/product/checklists/story-dod-checklist.md)
- [pre-push-checklist.md](.lmas-core/product/checklists/pre-push-checklist.md)

### Agente
- [dev.md](.lmas-core/development/agents/dev.md)

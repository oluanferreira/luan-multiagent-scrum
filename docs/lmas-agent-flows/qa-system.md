...
| `.lmas-core/development/tasks/qa-nfr-assess.md` | `*nfr-assess {story}` | Validar requisitos não-funcionais |
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/qa.md` | Definição completa do agente QA |

...
| `.lmas-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validação |
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/lmas-master.md` | Definição completa do agente (persona, comandos, dependencias) |
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/templates/agent-template.yaml` | Template para criação de novos agentes |
| `.lmas-core/development/templates/task-template.md` | Template para criação de novas tasks |
| `.lmas-core/development/templates/workflow-template.yaml` | Template para criação de novos workflows |

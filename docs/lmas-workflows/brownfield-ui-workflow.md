...
| @po | po | Keymaker | Product Owner | Validação, fragmentação, retrospectiva |
| @sm | sm | River | Scrum Master | Criação de stories |
| @analyst | analyst | Atlas | Business Analyst | Revisão de stories (opcional) |
| @dev | dev | Neo | Full Stack Developer | Implementação |
| @qa | qa | Oracle | Test Architect | Revisão de qualidade (opcional) |
...
| **Templates LMAS** | Templates instalados | Verificar `.lmas-core/development/templates/` |
| **Agentes Configurados** | Todos os agentes do workflow | Verificar `.lmas-core/development/agents/` |
...
|-----------|-------------|-----------------|
| Templates de PRD | `.lmas-core/development/templates/brownfield-prd-tmpl.yaml` | Step 2 |
| Template Frontend | `.lmas-core/development/templates/front-end-spec-tmpl.yaml` | Step 3 |
| Template Arquitetura | `.lmas-core/development/templates/brownfield-architecture-tmpl.yaml` | Step 4 |
| Checklist PO | `.lmas-core/development/checklists/po-master-checklist.md` | Step 5 |
| Template Story | `.lmas-core/development/templates/story-tmpl.yaml` | Step 8 |
...
```bash
ls .lmas-core/development/templates/
```

2. Verificar nome correto do template no workflow
3. Se necessario, reinstalar templates do LMAS core
...
|-----------|-------------|-----------|
| LMAS Knowledge Base | `.lmas-core/data/lmas-kb.md` | Base de conhecimento LMAS |
| IDE Development Workflow | `.lmas-core/data/lmas-kb.md#IDE Development Workflow` | Workflow de desenvolvimento IDE |
| Brownfield PRD Template | `.lmas-core/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| Frontend Spec Template | `.lmas-core/development/templates/front-end-spec-tmpl.yaml` | Template especificacao frontend |
| Brownfield Architecture Template | `.lmas-core/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| PO Master Checklist | `.lmas-core/development/checklists/po-master-checklist.md` | Checklist de validacao PO |

### Agentes

| Agente | Arquivo | Documentação |
|--------|---------|--------------|
| @architect | `.lmas-core/development/agents/architect.md` | Aria - Holistic System Architect |
| @pm | `.lmas-core/development/agents/pm.md` | Morgan - Product Manager |
| @ux-expert | `.lmas-core/development/agents/ux-design-expert.md` | Uma - UX/UI Designer |
| @po | `.lmas-core/development/agents/po.md` | Keymaker - Product Owner |
| @sm | `.lmas-core/development/agents/sm.md` | River - Scrum Master |
| @analyst | `.lmas-core/development/agents/analyst.md` | Atlas - Business Analyst |
| @dev | `.lmas-core/development/agents/dev.md` | Neo - Full Stack Developer |
| @qa | `.lmas-core/development/agents/qa.md` | Oracle - Test Architect |
...
*Documentacao gerada automaticamente a partir de `.lmas-core/development/workflows/brownfield-ui.yaml`*

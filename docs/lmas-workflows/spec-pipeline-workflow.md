...
| @qa | qa | Oracle | Test Architect | 5 (Critique), 5c (Critique 2) |

### 4.1 Perfil: @pm (Trinity)
...
### 4.2 Perfil: @architect (Architect)
...
|------|------|--------|---------|
| Gather Requirements | 1 | @pm | `.lmas-core/development/tasks/spec-gather-requirements.md` |
| Assess Complexity | 2 | @architect | `.lmas-core/development/tasks/spec-assess-complexity.md` |
| Research Dependencies | 3 | @analyst | `.lmas-core/development/tasks/spec-research-dependencies.md` |
| Write Specification | 4 | @pm | `.lmas-core/development/tasks/spec-write-spec.md` |
| Critique Specification | 5, 5c | @qa | `.lmas-core/development/tasks/spec-critique.md` |
| Create Implementation Plan | 6 | @architect | `.lmas-core/development/tasks/plan-create-implementation.md` |
...
| Arquivo | Localização |
|---------|-------------|
| Definicao do Workflow | `.lmas-core/development/workflows/spec-pipeline.yaml` |
| Task: Gather | `.lmas-core/development/tasks/spec-gather-requirements.md` |
| Task: Assess | `.lmas-core/development/tasks/spec-assess-complexity.md` |
| Task: Research | `.lmas-core/development/tasks/spec-research-dependencies.md` |
| Task: Write Spec | `.lmas-core/development/tasks/spec-write-spec.md` |
| Task: Critique | `.lmas-core/development/tasks/spec-critique.md` |
| Task: Create Plan | `.lmas-core/development/tasks/plan-create-implementation.md` |

### 10.2 Agentes Relacionados

| Agente | Localização |
|--------|-------------|
| @pm (Trinity) | `.lmas-core/development/agents/pm.md` |
| @architect (Architect) | `.lmas-core/development/agents/architect.md` |
...
- [LMAS Documentation Index](../LMAS-DOCUMENTATION-INDEX.md)
...
metadata:
  ...
  baseado_em:
    - .lmas-core/development/workflows/spec-pipeline.yaml
    - .lmas-core/development/tasks/spec-*.md

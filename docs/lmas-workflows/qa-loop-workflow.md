...
**Localização:** `.lmas-core/development/tasks/qa-review-story.md`
...
**Localização:** `.lmas-core/development/tasks/qa-create-fix-request.md`
...
**Localização:** `.lmas-core/development/tasks/dev-apply-qa-fixes.md`

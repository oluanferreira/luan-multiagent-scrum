...
| @po | Keymaker | Validação de artefatos, sharding, retrospectiva | 8, 10, 17 |
| @sm | River | Criação detalhada de stories | 11 |
| @dev | Neo | Implementação de stories | 13, 15 |
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/workflows/brownfield-fullstack.yaml` | Definição do workflow |
...
| `.lmas-core/product/checklists/po-master-checklist.md` | Checklist de validação PO |

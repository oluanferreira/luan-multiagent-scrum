...
O **Story Development Cycle** e o workflow central do LMAS para desenvolvimento de stories. Ele automatiza o fluxo completo desde a criacao ate a entrega com quality gate integrado, seguindo a sequencia: **criar -> validar -> implementar -> QA review**.
...
O Scrum Master (Niobe) identifica e cria a próxima story do backlog utilizando o PRD shardado ou documentação do projeto como fonte.
...
|-------|-------|
| **ID** | `validate` |
| **Agente** | @po (Keymaker - Product Owner) |
...
O Product Owner (Keymaker) valida a story criada usando um checklist rigoroso de 10 pontos, garantindo que a story esta pronta para implementação.
...
|-------|-------|
| **ID** | `implement` |
| **Agente** | @dev (Neo - Full Stack Developer) |
...
O Dev Agent (Neo) implementa a story validada, seguindo os acceptance criteria e as tarefas definidas. Inclui o CodeRabbit Self-Healing Loop para garantir qualidade do codigo.
...
|-------|-------|
| **ID** | `review` |
| **Agente** | @qa (Oracle - Test Architect) |
...
O QA Agent (Oracle) executa o review final com quality gate, validando codigo, testes, e aderencia aos acceptance criteria.
...
1. **core-config.yaml** - Arquivo de configuracao LMAS obrigatorio
...
2. **Story Template** - `story-tmpl.yaml` disponivel em `.lmas-core/development/templates/`
...
| Story template | YAML | `.lmas-core/development/templates/` | Template padrao |
...
cat .lmas-core/core-config.yaml
...
| Arquivo | Caminho |
|---------|---------|
| Workflow Definition | `.lmas-core/development/workflows/story-development-cycle.yaml` |
| SM Agent | `.lmas-core/development/agents/sm.md` |
| PO Agent | `.lmas-core/development/agents/po.md` |
| Dev Agent | `.lmas-core/development/agents/dev.md` |
| QA Agent | `.lmas-core/development/agents/qa.md` |
| Create Story Task | `.lmas-core/development/tasks/create-next-story.md` |
| Validate Story Task | `.lmas-core/development/tasks/validate-next-story.md` |
| Develop Story Task | `.lmas-core/development/tasks/dev-develop-story.md` |
| QA Gate Task | `.lmas-core/development/tasks/qa-gate.md` |
| Story Template | `.lmas-core/development/templates/story-tmpl.yaml` |

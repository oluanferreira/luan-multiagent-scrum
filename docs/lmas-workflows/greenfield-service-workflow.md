...
**Versão:** 1.0
**Criado:** 2026-02-04
**Fonte:** `.lmas-core/development/workflows/greenfield-service.yaml`
...
sequenceDiagram
    ...
    participant AR as Architect (Architect)
...
| `po` | Keymaker | Product Owner | `validacao` | Validar artefatos, fragmentar docs, retrospectiva |
| `sm` | River | Scrum Master | `facilitacao` | Criar stories do epic |
| `dev` | Neo | Full Stack Developer | `implementacao` | Implementar stories |
| `qa` | Oracle | Test Architect | `qualidade` | Revisar implementacao |
...
| Arquivo | Descricao |
|---------|-----------|
| `.lmas-core/core-config.yaml` | Configuracao do framework |
...
|----------|-------------|--------|
| `project-brief-tmpl.yaml` | `.lmas-core/development/templates/` | analyst |
| `prd-tmpl.yaml` | `.lmas-core/development/templates/` | pm |
| `architecture-tmpl.yaml` | `.lmas-core/development/templates/` | architect |
| `story-tmpl.yaml` | `.lmas-core/development/templates/` | sm |
| `qa-gate-tmpl.yaml` | `.lmas-core/development/templates/` | qa |
...
| Tipo | Localizacao |
|------|-------------|
| Logs do agente | `.lmas/logs/agent.log` |
| Status do projeto | `.lmas/project-registry.yaml` |
...
| Arquivo | Descricao |
|---------|-----------|
| `.lmas-core/development/workflows/greenfield-service.yaml` | Definicao do workflow |
| `.lmas-core/data/lmas-kb.md` | Knowledge base do LMAS |

### Agentes

| Arquivo | Agente |
|---------|--------|
| `.lmas-core/development/agents/analyst.md` | Atlas (Analyst) |
| `.lmas-core/development/agents/pm.md` | Morgan (PM) |
| `.lmas-core/development/agents/architect.md` | Aria (Architect) |
| `.lmas-core/development/agents/po.md` | Keymaker (PO) |
| `.lmas-core/development/agents/sm.md` | River (SM) |
| `.lmas-core/development/agents/dev.md` | Neo (Dev) |
| `.lmas-core/development/agents/qa.md` | Oracle (QA) |

### Tasks Principais

| Arquivo | Task |
|---------|------|
| `.lmas-core/development/tasks/create-doc.md` | Criacao de documentos |
| `.lmas-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| `.lmas-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| `.lmas-core/development/tasks/dev-develop-story.md` | Implementacao de stories |
| `.lmas-core/development/tasks/qa-review-story.md` | Revisao de implementacao |
| `.lmas-core/development/tasks/execute-checklist.md` | Execucao de checklists |

### Templates

| Arquivo | Template |
|---------|----------|
| `.lmas-core/development/templates/project-brief-tmpl.yaml` | Project Brief |
| `.lmas-core/development/templates/prd-tmpl.yaml` | PRD |
| `.lmas-core/development/templates/architecture-tmpl.yaml` | Arquitetura |
| `.lmas-core/development/templates/story-tmpl.yaml` | User Story |
| `.lmas-core/development/templates/qa-gate-tmpl.yaml` | QA Gate |

### Checklists

| Arquivo | Checklist |
|---------|-----------|
| `.lmas-core/development/checklists/po-master-checklist.md` | Validacao PO |
| `.lmas-core/development/checklists/story-draft-checklist.md` | Validacao Story Draft |
| `.lmas-core/development/checklists/story-dod-checklist.md` | Definition of Done |
...
*Documentacao gerada automaticamente a partir de `.lmas-core/development/workflows/greenfield-service.yaml`*

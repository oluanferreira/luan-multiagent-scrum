...
| @po | Keymaker | Product Owner | Validação de artefatos, fragmentação de docs, retrospectiva |
| @sm | River | Scrum Master | Criação de stories |
| @analyst | Atlas | Business Analyst | Revisão opcional de story drafts |
| @dev | Neo | Full Stack Developer | Implementacao de stories, correção de feedback |
| @qa | Oracle | Test Architect | Revisão de implementação, quality gates |
...
|---------|-----------|---------|
| Workflow Definition | Definição YAML do workflow | `.lmas-core/development/workflows/brownfield-service.yaml` |
...
| PO Master Checklist | Checklist de validação | `.lmas-core/development/checklists/po-master-checklist.md` |
...
- [Technical Preferences](../../../.lmas-core/development/data/technical-preferences.md) - Preferências técnicas do projeto

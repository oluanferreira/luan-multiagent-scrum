# LMAS Workflows - Documentação Detalhada dos Workflows

> 🌐 **PT** | [EN](../en/lmas-workflows/README.md) | [ES](../es/lmas-workflows/README.md) | [ZH](../zh/lmas-workflows/README.md)
...
Esta pasta contém a documentação detalhada de todos os workflows do LMAS, incluindo:
...
| Agent Flows | [docs/lmas-agent-flows/](../lmas-agent-flows/) | Detalhes de agentes |
...
*LMAS Workflows Documentation v1.0 - Documentação detalhada dos workflows de desenvolvimento*

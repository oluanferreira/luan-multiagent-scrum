...
sequenceDiagram
    ...
    participant DE as @data-engineer<br/>Dozer
    participant UX as @ux-design-expert<br/>Uma
    participant QA as @qa<br/>Oracle
...
| **Agente** | `@data-engineer` (Dozer - Sage) |
...
mindmap
  root((Brownfield<br/>Discovery))
    Coleta
      ...
      data-engineer["@data-engineer<br/>Dozer (Sage)<br/>Database"]
    ...
    Validacao
      ...
      qa["@qa<br/>Oracle (Guardian)<br/>Quality Gate"]
    Finalizacao
...
| Dozer | `@data-engineer` | Sage | PostgreSQL, Supabase, RLS, migrations |
| Uma | `@ux-design-expert` | Empathizer | Atomic Design, design tokens, acessibilidade |
| Oracle | `@qa` | Guardian | Quality gates, testes, rastreabilidade |
...
| Arquivo | Localizacao |
|---------|-------------|
| Definicao do Workflow | `.lmas-core/development/workflows/brownfield-discovery.yaml` |
| Task: brownfield-create-epic | `.lmas-core/development/tasks/brownfield-create-epic.md` |
| Task: brownfield-create-story | `.lmas-core/development/tasks/brownfield-create-story.md` |
| Task: db-schema-audit | `.lmas-core/development/tasks/db-schema-audit.md` |
| Task: security-audit | `.lmas-core/development/tasks/security-audit.md` |
...
| @data-engineer | `.lmas-core/development/agents/data-engineer.md` |
| @ux-design-expert | `.lmas-core/development/agents/ux-design-expert.md` |
...
- [Guia de Workflows LMAS](../LMAS-WORKFLOWS-GUIDE.md)

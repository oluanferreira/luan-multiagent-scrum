...
├── framework/                 # English
├── platforms/                 # English
├── lmas-agent-flows/          # Detailed agent documentation (PT) — legacy root location
├── lmas-workflows/            # Detailed workflow documentation (PT) — legacy root location
│
...
- [Agent System Documentation](./en/lmas-agent-flows/README.md)
- [Workflow Documentation](./en/lmas-workflows/README.md)
...
- [Documentação do Sistema de Agentes](./lmas-agent-flows/README.md)
- [Documentação de Workflows](./lmas-workflows/README.md)
...
- [Documentación del Sistema de Agentes](./es/lmas-agent-flows/README.md)
- [Documentación de Workflows](./es/lmas-workflows/README.md)
...
- [代理系统文档](./zh/lmas-agent-flows/README.md)
- [工作流文档](./zh/lmas-workflows/README.md)

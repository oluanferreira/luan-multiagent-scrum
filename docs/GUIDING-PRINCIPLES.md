# LMAS Method Guiding Principles

> 🌐 **EN** | [PT](./pt/GUIDING-PRINCIPLES.md) | [ES](./es/GUIDING-PRINCIPLES.md)

---

The LMAS Method is a natural language framework for AI-assisted software development. These principles ensure contributions maintain the method's effectiveness.
...
Templates follow the [LMAS Document Template](../common/utils/lmas-doc-template.md) specification using YAML format:

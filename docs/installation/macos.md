# macOS Installation Guide for Synkra LMAS
...
1. Commands are installed to `.claude/commands/LMAS/`
...
2. Synkra LMAS handles both case-sensitive and case-insensitive filesystems automatically

...
2. LMAS can integrate via `.continue\` configuration
...
# - Back up customizations to .lmas-backup\
...
```powershell
# Remove LMAS from project
Remove-Item -Recurse -Force .lmas-core

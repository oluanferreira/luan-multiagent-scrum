# LMAS Installation Documentation
...
This directory contains comprehensive installation and setup documentation for LMAS.
...
2. Search [FAQ](./faq.md)
3. Open a [GitHub Issue](https://github.com/oluanferreira/luan-multiagent-scrum/issues)

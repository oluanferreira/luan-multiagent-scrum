# Synkra LMAS Installation Documentation
...
This directory contains comprehensive installation and setup documentation for Synkra LMAS.
...
2. Search [FAQ](./faq.md)
3. Open a [GitHub Issue](https://github.com/SynkraAI/lmas-core/issues)

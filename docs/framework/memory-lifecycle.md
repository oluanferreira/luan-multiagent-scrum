...
|---|---|---|---|
| Constitution | Framework | L1 | Generated by installer, references `.lmas-core/constitution.md` |
...
| Sistema de Agentes | Framework | L2 | Agent definitions from `.lmas-core/development/agents/` |
...
- `<!-- FRAMEWORK-OWNED: Generated by LMAS installer, do not customize -->` for L1/L2 sections
...
Use `.lmas-core/development/checklists/memory-audit-checklist.md` periodically to:

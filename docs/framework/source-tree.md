...
- [Framework Core (.lmas-core/)](#framework-core-lmas-core)
...
LMAS uses a **modular architecture** with clear separation of concerns:

1. **Framework Core** (`.lmas-core/`) - Portable framework components organized by domain
...
├── .lmas-core/                        # Framework core (modular)
...
│
├── data/                              # Shared Data
│   ├── lmas-kb.md                     # LMAS knowledge base (@lmas-master, lazy-loaded)
...
│   │   ├── lmas-master.md             # Master orchestrator
...
### Shared Data Files (.lmas-core/data/)

| File | Owner | Fill Rule | Update Trigger | Used By |
|------|-------|-----------|----------------|---------|
| `lmas-kb.md` | @lmas-master | Updated on major framework changes | Manual edit | @lmas-master (lazy) |
...
### Product Data Files (.lmas-core/product/data/)
...
│   ├── lmas migration/                # LMAS migration stories
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads are modular extensions that add specialized capabilities to LMAS. Unlike the deprecated Squads, Squads follow a standardized template structure.
...
```
lmas-core/
├── .lmas-core/                        # Framework assets (modular v2.0)
│   ├── cli/                           # CLI commands and utilities
│   ├── core/                          # Framework essentials
│   │   ├── config/                    # Configuration system
...
Location: .lmas-core/development/agents/{agent-name}.md
Example: .lmas-core/development/agents/security-expert.md

# I'm creating a new task:
Location: .lmas-core/development/tasks/{task-name}.md
Example: .lmas-core/development/tasks/deploy-to-production.md

# I'm creating a new workflow:
Location: .lmas-core/development/workflows/{workflow-name}.yaml
Example: .lmas-core/development/workflows/continuous-deployment.yaml

# I'm creating a new template:
Location: .lmas-core/product/templates/{template-name}-tmpl.{yaml|md}
Example: .lmas-core/product/templates/deployment-plan-tmpl.yaml

# I'm creating a new checklist:
Location: .lmas-core/product/checklists/{checklist-name}-checklist.md
Example: .lmas-core/product/checklists/security-review-checklist.md

# I'm creating a CLI command:
Location: .lmas-core/cli/commands/{category}/{command-name}.js
Example: .lmas-core/cli/commands/generate/workflow.js

# I'm creating a core utility:
Location: .lmas-core/core/utils/{utility-name}.js
Example: .lmas-core/core/utils/performance-monitor.js

# I'm creating an infrastructure script:
Location: .lmas-core/infrastructure/scripts/{category}/{script-name}.js
Example: .lmas-core/infrastructure/scripts/llm-routing/router.js

# I'm adding a PM tool adapter:
Location: .lmas-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Example: .lmas-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
The ADE is configured via `.lmas-core/core-config.yaml`:
...
ade:
  ...
  memoryLayer:
    enabled: true
    patternStore: .lmas/patterns/
```

### ADE Runtime State

Runtime state is persisted in `.lmas/`:
...
_This is an official LMAS framework standard. All file placement must follow this structure._

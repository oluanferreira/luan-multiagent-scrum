...
| `@pm` | Trinity | Product Manager | `*create-prd`, `*shard-prd`, `*create-epic` |
| `@ux-expert` | Uma | UX/UI Designer | `*create-front-end-spec`, `*generate-ui-prompt`, `*wireframe` |
| `@architect` | Architect | System Architect | `*create-front-end-architecture`, `*document-project` |
| `@po` | Keymaker | Product Owner | `*execute-checklist-po`, `*shard-doc`, `*validate-story-draft` |
| `@sm` | Niobe | Scrum Master | `*draft`, `*story-checklist` |
| `@dev` | Neo | Full Stack Developer | `*develop`, `*run-tests`, `*apply-qa-fixes` |
| `@qa` | Oracle | Test Architect | `*review`, `*gate`, `*test-design` |
...
2. **LMAS-Core Disponivel**
   - Templates em `.lmas-core/development/templates/`
   - Tasks em `.lmas-core/development/tasks/`
   - Checklists em `.lmas-core/development/checklists/`
...
| Problema | Causa Provável | Solução |
|----------|----------------|---------|
| Templates nao encontrados | Path incorreto | Verificar `.lmas-core/development/templates/` |
...
| Arquivo | Caminho |
|---------|---------|
| Definição do Workflow | `.lmas-core/development/workflows/greenfield-ui.yaml` |
| Knowledge Base | `.lmas-core/data/lmas-kb.md` |

### Agentes

| Agente | Caminho |
|--------|---------|
| @analyst | `.lmas-core/development/agents/analyst.md` |
| @pm | `.lmas-core/development/agents/pm.md` |
| @ux-expert | `.lmas-core/development/agents/ux-design-expert.md` |
| @architect | `.lmas-core/development/agents/architect.md` |
| @po | `.lmas-core/development/agents/po.md` |
| @sm | `.lmas-core/development/agents/sm.md` |
| @dev | `.lmas-core/development/agents/dev.md` |
| @qa | `.lmas-core/development/agents/qa.md` |

### Templates Principais

| Template | Caminho |
|----------|---------|
| Project Brief | `.lmas-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.lmas-core/development/templates/prd-tmpl.yaml` |
| Frontend Spec | `.lmas-core/development/templates/front-end-spec-tmpl.yaml` |
| Frontend Architecture | `.lmas-core/development/templates/front-end-architecture-tmpl.yaml` |
| Story | `.lmas-core/development/templates/story-tmpl.yaml` |

### Checklists

| Checklist | Caminho |
|-----------|---------|
| PO Master | `.lmas-core/development/checklists/po-master-checklist.md` |
| Story Draft | `.lmas-core/development/checklists/story-draft-checklist.md` |
| Story DoD | `.lmas-core/development/checklists/story-dod-checklist.md` |

### Documentação Relacionada

- [LMAS Knowledge Base](.lmas-core/data/lmas-kb.md) - Base de conhecimento central
...
*Documento gerado automaticamente a partir de `.lmas-core/development/workflows/greenfield-ui.yaml`*

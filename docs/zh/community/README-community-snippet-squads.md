...
> **用途:** 将此代码段复制到 `SynkraAI/lmas-squads` 仓库的 README.md 中。
...
| 需要 | 前往位置 |
|------|-------------|
| 📦 **Squad 问题?** | 使用 ["Squad" 类别](https://github.com/SynkraAI/lmas-core/discussions/categories/squads) |
| 💡 **功能创意?** | 在 ["创意" 中启动讨论](https://github.com/SynkraAI/lmas-core/discussions/categories/ideas) |
| 🐛 **发现错误?** | [在此仓库中打开 issue](https://github.com/SynkraAI/lmas-squads/issues/new/choose) |
...
有新的 LMAS Squad 想法？我们很乐意听到！

1. 检查现有的 [Squad 提案](https://github.com/SynkraAI/lmas-squads/labels/new-squad)
2. 打开 [Squad 提案 issue](https://github.com/SynkraAI/lmas-squads/issues/new?template=squad-proposal.md)
3. 在社区中讨论

---

**标语:** *LMAS Squads：与你一起工作的 AI 代理团队* 🤖

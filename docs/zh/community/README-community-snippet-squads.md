...
> **用途:** 将此代码段复制到 `LMAS/lmas-squads` 仓库的 README.md 中。
...
| 需要 | 前往位置 |
|------|-------------|
| 📦 **Squad 问题?** | 使用 ["Squad" 类别](https://github.com/oluanferreira/luan-multiagent-scrum/discussions/categories/squads) |
...
1. 检查现有的 [Squad 提案](https://github.com/oluanferreira/luan-multiagent-scrum/labels/new-squad)
2. 打开 [Squad 提案 issue](https://github.com/oluanferreira/luan-multiagent-scrum/issues/new?template=squad-proposal.md)
3. 在社区中讨论

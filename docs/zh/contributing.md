...
欢迎来到 LMAS！感谢您对贡献的兴趣。本指南将帮助您了解我们的开发工作流程、贡献流程以及如何提交更改。
...
LMAS 使用 Open Core 模型，带有私人 `pro/` git 子模块（见 [ADR-PRO-001](../docs/architecture/adr/adr-pro-001-repository-strategy.md)）。
...
**推送顺序：** 始终先推送 `pro/` 更改，然后是 `lmas-core`。

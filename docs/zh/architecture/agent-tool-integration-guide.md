...
本指南说明如何将工具与 LMAS 代理集成。工具通过提供对外部服务、API 和系统资源的访问来扩展代理的能力。
...
| `tasks`        | 任务工作流文件                 | `.lmas-core/development/tasks/`    |
| `checklists`   | 验证清单                       | `.lmas-core/product/checklists/`   |

### 声明示例

```yaml
# 来自 .lmas-core/development/agents/dev.md
dependencies:
  checklists:
...
- [代理定义](../../../.lmas-core/development/agents/)

---

**维护者**: @architect (Architect)

...
- [ ] **创建 Git 前推送钩子**
  - 位置: `.git/hooks/pre-push`
  - 内容: 检查 `$LMAS_ACTIVE_AGENT`，如果 != "github-devops" 则阻止
...
- [ ] **更新代理激活脚本**
  - 添加环境变量配置: `LMAS_ACTIVE_AGENT={agent_id}`
  - 适当设置 `LMAS_GIT_PUSH_ALLOWED`

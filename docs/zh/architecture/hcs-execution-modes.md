...
本文档定义了 LMAS 健康检查系统 (HCS) 的执行模式,基于 Kubernetes、VS Code、Terraform、npm/yarn 和 CLI "doctor" 模式(Flutter、Homebrew、WP-CLI)的行业最佳实践研究。
...
| **安装/启动时**          | `npx lmas install` | 60-120s | 预期的                 | 设置验证       | ✅ **强制**        |

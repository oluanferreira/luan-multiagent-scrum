...
**LMAS（AI 操作系统）** 是用于 AI 代理、工作者和人类在复杂软件开发工作流中进行编排的精巧框架。v2.1 版本引入了具有 4 个模块的模块化架构、多仓库策略和 3 层质量门槛。
...
| 包 | 注册表 | 许可证 |
| --- | --- | --- |
| `@lmas/core` | npm 公开 | MIT |
| `@lmas/squad-etl` | npm 公开 | MIT |
| `@lmas/squad-creator` | npm 公开 | MIT |
| `@lmas/squad-mmos` | npm 公开 | MIT |
| `@lmas/mcp-presets` | npm 公开 | Apache 2.0 |
...
| 模块 | 路径 | 目的 | 主要内容 |
| --- | --- | --- | --- |
| **核心** | `.lmas-core/core/` | 框架基础 | 配置、注册表、QG、MCP、会话 |
| **开发** | `.lmas-core/development/` | 开发制品 | 代理、任务、工作流、脚本 |
| **产品** | `.lmas-core/product/` | PM 制品 | 模板、检查表、数据 |
| **基础设施** | `.lmas-core/infrastructure/` | 系统配置 | 脚本、工具、集成 |
...
| Dozer | `data-engineer` | 架构师 | 数据工程 |
| Felix | `devops` | 优化者 | CI/CD 和操作 |
| Uma | `ux-expert` | 创造者 | 用户体验 |
| Keymaker | `lmas-master` | 编排者 | 框架编排 |
...
- [LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.lmas-core/docs/standards/LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - 框架完整指南

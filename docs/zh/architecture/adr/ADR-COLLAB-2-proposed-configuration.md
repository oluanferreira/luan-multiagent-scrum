...
**日期:** 2025-12-30
**状态:** 提议
**作者:** @devops (Operator) + @architect (Architect)

---

## 背景

在[当前状态审计](./ADR-COLLAB-1-current-state-audit.md)之后，本文档提议具体的配置更改，以启用对 LMAS 的安全外部贡献。
...
reviews:
  ...
  path_instructions:
    ...
    '.lmas-core/development/agents/**':
      - '验证代理是否遵循 LMAS 代理 YAML 结构（persona_profile、commands、dependencies）'

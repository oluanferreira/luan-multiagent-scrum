...
| 工件                 | 路径                                                      | 类型        | 状态 |
| -------------------- | --------------------------------------------------------- | ----------- | ---- |
| asset-inventory.js   | `.lmas-core/infrastructure/scripts/asset-inventory.js`    | JS 脚本     | ✅   |
| path-analyzer.js     | `.lmas-core/infrastructure/scripts/path-analyzer.js`      | JS 脚本     | ✅   |
| migrate-agent.js     | `.lmas-core/infrastructure/scripts/migrate-agent.js`      | JS 脚本     | ✅   |
...
- **所有代理**同步到 `.claude/commands/LMAS/agents/`

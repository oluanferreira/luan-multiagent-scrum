...
**自主开发引擎 (ADE)** 是 LMAS 用于自主开发工作流的基础设施。它使 AI 代理能够通过智能管道、自愈循环和持久学习独立工作。
...
| 类型         | 描述                    | 存储                              |
| ------------ | ----------------------- | --------------------------------- |
| 代码模式     | 来自代码库的可重用模式  | .lmas/patterns/code-patterns.json |
| 陷阱         | 已知问题和解决方案      | .lmas/patterns/gotchas.json       |
| 会话洞察     | 会话期间的发现          | .lmas/sessions/                   |
| 代码库地图   | 项目结构分析            | .lmas/codebase-map.json           |

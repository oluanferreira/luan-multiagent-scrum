...
ADE 是一个 **提示工程 + 基础设施** 项目，用于在 LMAS 中启用自主开发执行。大约 **60% 的工作是创建 tasks .md、workflows .yaml 和模板** - 而不是传统代码。
...
- `docs/stories/lmas-core-ade/` (7 个 epic 文件 + README)

### Quality Gates

- `docs/qa/gates/lmas-core-ade/` (7 个 gate 文件 + README)

### 参考

- `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md` (Auto-Claude 模式)
- `.lmas-core/core-config.yaml` (中央配置)
...
1. **阅读完整 PRD** - `docs/prd/lmas-autonomous-development-engine.md`

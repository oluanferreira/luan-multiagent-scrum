...
本文档描述在 LMAS 中管理 Model Context Protocol (MCP) 服务器使用的 API 密钥的最佳实践。正确的 API 密钥管理对安全和运营完整性至关重要。

---

## LMAS 中的 MCP 架构

LMAS 使用 Docker MCP Toolkit 作为主要的 MCP 基础设施:
...
**重要:** 所有 MCP 基础设施管理由 **DevOps 代理 (@devops / Operator)** 专门处理。

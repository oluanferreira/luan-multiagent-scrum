...
**@architect 代理 (Architect)** 是 LMAS 的**全系统架构师和全栈技术领导**。该代理负责:
...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.lmas-core/development/tasks/architect-analyze-impact.md` | `*analyze-impact` | 分析修改对框架组件的影响 |
| `.lmas-core/development/tasks/document-project.md` | `*document-project` | 生成现有项目的 brownfield 文档 |
| `.lmas-core/development/tasks/create-doc.md` | `*create-doc` | 从 YAML 模板创建文档 |
| `.lmas-core/development/tasks/collaborative-edit.md` | `*collaborative-edit` | 管理协作编辑会话 |
...
| `.lmas-core/development/tasks/spec-assess-complexity.md` | `*assess-complexity` | 评估故事复杂性(规范管道) |

### 代理定义文件

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/development/agents/architect.md` | 架构师代理的核心定义 |
| `.claude/commands/LMAS/agents/architect.md` | Claude Code 命令用于激活 @architect |

### @architect 的模板文件

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/product/templates/architecture-tmpl.yaml` | 后端架构模板 |
| `.lmas-core/product/templates/front-end-architecture-tmpl.yaml` | 前端架构模板 |
| `.lmas-core/product/templates/fullstack-architecture-tmpl.yaml` | 全栈架构模板 |
| `.lmas-core/product/templates/brownfield-architecture-tmpl.yaml` | Brownfield 项目模板 |

<!--
  翻译：zh-CN（简体中文）
  原文：/docs/lmas-agent-flows/devops-system.md
  最后同步：2026-02-22
-->
...
`@devops` (Operator) 代理是 LMAS 框架的基础设施和运维专家。负责：
...
| 文件 | 路径 | 描述 |
|---------|---------|-----------|
| 代理定义 | `.lmas-core/development/agents/devops.md` | 角色、命令和行为 |

### 任务文件

| 任务 | 路径 | 命令 |
|------|---------|---------|
| 推送前质量门禁 | `.lmas-core/development/tasks/github-devops-pre-push-quality-gate.md` | `*push` |
| 版本管理 | `.lmas-core/development/tasks/github-devops-version-management.md` | `*version-check` |
| 仓库清理 | `.lmas-core/development/tasks/github-devops-repository-cleanup.md` | `*cleanup` |
| CI/CD 配置 | `.lmas-core/development/tasks/ci-cd-configuration.md` | `*ci-cd` |
| 发布管理 | `.lmas-core/development/tasks/release-management.md` | `*release` |
| 环境引导 | `.lmas-core/development/tasks/environment-bootstrap.md` | `*environment-bootstrap` |
| 搜索 MCP | `.lmas-core/development/tasks/search-mcp.md` | `*search-mcp` |
| 添加 MCP | `.lmas-core/development/tasks/add-mcp.md` | `*add-mcp` |
| 设置 MCP Docker | `.lmas-core/development/tasks/setup-mcp-docker.md` | `*setup-mcp-docker` |
| 设置 GitHub | `.lmas-core/development/tasks/setup-github.md` | `*setup-github` |
| 安全审计 | `.lmas-core/development/tasks/security-audit.md` | `*security-audit` |
| 安全扫描 | `.lmas-core/development/tasks/security-scan.md` | `*security-scan` |
...
| 任务 | 描述 |
|------|-----------|
| [推送前质量门禁](.lmas-core/development/tasks/github-devops-pre-push-quality-gate.md) | 推送前验证 |
| [版本管理](.lmas-core/development/tasks/github-devops-version-management.md) | 版本管理 |
| [CI/CD 配置](.lmas-core/development/tasks/ci-cd-configuration.md) | 管道配置 |
| [发布管理](.lmas-core/development/tasks/release-management.md) | 发布管理 |
| [环境引导](.lmas-core/development/tasks/environment-bootstrap.md) | 环境引导 |

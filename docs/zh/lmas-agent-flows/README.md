<!--
  翻译：zh-CN（简体中文）
  原文：/docs/lmas-agent-flows/README.md
  最后同步：2026-02-22
-->

# LMAS 代理流程 - 代理详细文档

> 🌐 [PT](../../lmas-agent-flows/README.md) | [EN](../../en/lmas-agent-flows/README.md) | [ES](../../es/lmas-agent-flows/README.md) | **ZH**
...
| 代理 | 角色 | 原型 | 文档 |
|--------|---------|-----------|-----------|
| **@lmas-master** | Morpheus | 编排者 | [lmas-master-system.md](./lmas-master-system.md) |
| **@analyst** | Atlas | 研究员 | [analyst-system.md](./analyst-system.md) |
| **@architect** | Aria | 愿景者 | [architect-system.md](./architect-system.md) |
| **@data-engineer** | Dozer | 数据圣人 | [data-engineer-system.md](./data-engineer-system.md) |
| **@dev** | Neo | 构建者 | [dev-system.md](./dev-system.md) |
| **@devops** | Operator | 守护者 | [devops-system.md](./devops-system.md) |
| **@pm** | Morgan | 策略师 | [pm-system.md](./pm-system.md) |
| **@qa** | Oracle | 守护者 | [qa-system.md](./qa-system.md) |
...
| LMAS 工作流 | [docs/lmas-workflows/](../lmas-workflows/) | 工作流详情 |

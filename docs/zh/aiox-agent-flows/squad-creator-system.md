<!--
  翻译：zh-CN（简体中文）
  原文：/docs/lmas-agent-flows/squad-creator-system.md
  最后同步：2026-02-22
-->
...
**小队创建者** (Craft) 是 LMAS 用于创建、验证、发布和管理小队的专业代理。小队是代理、任务、工作流和资源的模块化包，可在项目之间重用。

该系统实现了 LMAS 的**任务优先架构**，其中任务是执行的主要入口点，代理编排这些任务。
...
| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/development/agents/squad-creator.md` | 小队创建者代理核心定义 |
| `.claude/commands/LMAS/agents/squad-creator.md` | 用于激活 @squad-creator 的 Claude Code 命令 |

### @squad-creator 任务文件

| 文件 | 命令 | 目的 | 状态 |
|---------|---------|-----------|--------|
| `.lmas-core/development/tasks/squad-creator-create.md` | `*create-squad` | 创建带完整结构的新小队 | 活跃 |
| `.lmas-core/development/tasks/squad-creator-design.md` | `*design-squad` | 分析文档并生成蓝图 | 活跃 |
| `.lmas-core/development/tasks/squad-creator-validate.md` | `*validate-squad` | 验证小队针对 schema 和模式 | 活跃 |
| `.lmas-core/development/tasks/squad-creator-list.md` | `*list-squads` | 列出本地小队 | 活跃 |
| `.lmas-core/development/tasks/squad-creator-analyze.md` | `*analyze-squad` | 分析结构并建议改进 | 活跃 |
| `.lmas-core/development/tasks/squad-creator-extend.md` | `*extend-squad` | 使用新组件扩展小队 | 活跃 |
| `.lmas-core/development/tasks/squad-creator-migrate.md` | `*migrate-to-v2` | 迁移小队到 v2 格式 | 活跃 |
| `.lmas-core/development/tasks/squad-generate-skills.md` | `*generate-skills` | 生成小队知识技能 | 活跃 |
...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.lmas-core/development/tasks/create-agent.md` | `*create-agent` | 创建单个代理定义 |
| `.lmas-core/development/tasks/create-task.md` | `*create-task` | 创建单个任务文件 |
| `.lmas-core/development/tasks/create-workflow.md` | `*create-workflow` | 创建编排工作流 |

### 支持脚本

| 文件 | 类/函数 | 目的 |
|---------|---------------|-----------|
| `.lmas-core/development/scripts/squad/squad-generator.js` | `SquadGenerator` | 生成完整小队结构 |
| `.lmas-core/development/scripts/squad/squad-validator.js` | `SquadValidator` | 验证小队针对 schema 和模式 |
| `.lmas-core/development/scripts/squad/squad-loader.js` | `SquadLoader` | 加载和解析小队 |
| `.lmas-core/development/scripts/squad/squad-designer.js` | `SquadDesigner` | 分析文档并生成蓝图 |
| `.lmas-core/development/scripts/squad/squad-analyzer.js` | `SquadAnalyzer` | 分析小队结构 |
| `.lmas-core/development/scripts/squad/squad-extender.js` | `SquadExtender` | 扩展现有小队 |
| `.lmas-core/development/scripts/squad/squad-migrator.js` | `SquadMigrator` | 迁移小队到 v2 |
| `.lmas-core/development/scripts/squad/squad-downloader.js` | `SquadDownloader` | 从仓库下载小队 |
| `.lmas-core/development/scripts/squad/squad-publisher.js` | `SquadPublisher` | 发布小队 |

### JSON Schema

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/schemas/squad-schema.json` | squad.yaml 验证 schema |
| `.lmas-core/schemas/squad-design-schema.json` | 蓝图验证 schema |
...
flowchart LR
    ...
    subgraph DEVOPS["@devops (Operator)"]
        DEVOPS_PUB["发布"]
        DEVOPS_DEPLOY["部署"]
    end
...
- [任务：squad-creator-create.md](.lmas-core/development/tasks/squad-creator-create.md)
- [任务：squad-creator-validate.md](.lmas-core/development/tasks/squad-creator-validate.md)
- [任务：squad-creator-design.md](.lmas-core/development/tasks/squad-creator-design.md)
- [脚本：squad-generator.js](.lmas-core/development/scripts/squad/squad-generator.js)
- [脚本：squad-validator.js](.lmas-core/development/scripts/squad/squad-validator.js)
- [Schema：squad-schema.json](.lmas-core/schemas/squad-schema.json)
- [代理：squad-creator.md](.lmas-core/development/agents/squad-creator.md)
- [命令：squad-creator.md](.claude/commands/LMAS/agents/squad-creator.md)

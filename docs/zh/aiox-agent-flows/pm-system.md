<!--
  翻译：zh-CN（简体中文）
  原文：/docs/lmas-agent-flows/pm-system.md
  最后同步：2026-02-22
-->
...
本文档描述 LMAS 产品经理 (PM) 代理的完整系统，包括所有涉及的文件、工作流程、可用命令和代理之间的集成。
...
| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/development/agents/pm.md` | PM 代理核心定义 |
| `.claude/commands/LMAS/agents/pm.md` | 用于激活 @pm 的 Claude Code 命令 |

### @pm 任务

| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.lmas-core/development/tasks/create-doc.md` | `*create-prd` | 从 YAML 模板创建文档 |
| `.lmas-core/development/tasks/correct-course.md` | `*correct-course` | 分析并纠正项目偏差 |
| `.lmas-core/development/tasks/create-deep-research-prompt.md` | `*research` | 生成深度研究提示 |
| `.lmas-core/development/tasks/brownfield-create-epic.md` | `*create-epic` | 为棕地项目创建史诗 |
| `.lmas-core/development/tasks/brownfield-create-story.md` | `*create-story` | 为棕地创建故事 |
| `.lmas-core/development/tasks/execute-checklist.md` | `*checklist` | 执行检查清单验证 |
| `.lmas-core/development/tasks/shard-doc.md` | `*shard-prd` | 拆分大型文档 |

### @pm 模板

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/product/templates/prd-tmpl.yaml` | 绿地项目 PRD 模板 |
| `.lmas-core/product/templates/brownfield-prd-tmpl.yaml` | 棕地项目 PRD 模板 |

### @pm 检查清单

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/product/checklists/pm-checklist.md` | PRD 验证检查清单 |
| `.lmas-core/product/checklists/change-checklist.md` | 变更导航检查清单 |

### 使用 @pm 的工作流

| 文件 | 阶段 | 目的 |
|---------|------|-----------|
| `.lmas-core/development/workflows/brownfield-discovery.yaml` | 阶段 10 | 发现后创建史诗和故事 |
...
flowchart TB
    ...
    subgraph PM_CORE["@pm (Trinity) - 核心"]
...
flowchart TB
    ...
    subgraph ARCHITECT_BOX["@architect (Architect) - 架构师"]
...
**解决方案：**
- 检查 `.lmas-core/product/templates/`
...
- [代理定义：pm.md](.lmas-core/development/agents/pm.md)
- [任务：create-doc.md](.lmas-core/development/tasks/create-doc.md)
- [任务：brownfield-create-epic.md](.lmas-core/development/tasks/brownfield-create-epic.md)
- [任务：correct-course.md](.lmas-core/development/tasks/correct-course.md)
- [模板：prd-tmpl.yaml](.lmas-core/product/templates/prd-tmpl.yaml)
- [模板：brownfield-prd-tmpl.yaml](.lmas-core/product/templates/brownfield-prd-tmpl.yaml)
- [检查清单：pm-checklist.md](.lmas-core/product/checklists/pm-checklist.md)

<!--
  翻译：zh-CN（简体中文）
  原文：/docs/lmas-agent-flows/analyst-system.md
  最后同步：2026-02-22
-->

# 分析师代理 (@analyst) 系统 - LMAS
...
| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/development/agents/analyst.md` | 分析师代理核心定义 |
| `.claude/commands/LMAS/agents/analyst.md` | 用于激活 @analyst 的 Claude Code 命令 |

### 分析师任务

| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.lmas-core/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | 主要任务 - 促进结构化头脑风暴会话 |
| `.lmas-core/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | 头脑风暴任务的交互变体 |
| `.lmas-core/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | 生成深度研究调查提示 |
| `.lmas-core/development/tasks/advanced-elicitation.md` | `*elicit` | 高级需求获取会话 |
| `.lmas-core/development/tasks/create-doc.md` | `*doc-out` | 从 YAML 模板创建文档 |
| `.lmas-core/development/tasks/document-project.md` | `*create-project-brief` | 现有项目文档 |
| `.lmas-core/development/tasks/calculate-roi.md` | (相关) | ROI 和成本节约计算 |

### 相关分析任务

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/development/tasks/analyze-brownfield.md` | 棕地项目分析 |
| `.lmas-core/development/tasks/analyze-framework.md` | 现有框架分析 |
| `.lmas-core/development/tasks/analyze-performance.md` | 性能分析 |
| `.lmas-core/development/tasks/analyze-project-structure.md` | 项目结构分析 |
| `.lmas-core/development/tasks/analyze-cross-artifact.md` | 跨工件分析 |

### 分析师模板

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/product/templates/project-brief-tmpl.yaml` | 项目简介模板 |
| `.lmas-core/product/templates/market-research-tmpl.yaml` | 市场研究模板 |
| `.lmas-core/product/templates/competitor-analysis-tmpl.yaml` | 竞争分析模板 |
| `.lmas-core/product/templates/brainstorming-output-tmpl.yaml` | 头脑风暴会话输出模板 |

### 数据文件

| 文件 | 目的 |
|---------|-----------|
| `.lmas-core/development/data/lmas-kb.md` | LMAS 知识库 |
| `.lmas-core/development/data/brainstorming-techniques.md` | 可用的头脑风暴技术 |

### 使用分析师的工作流

| 文件 | 阶段 | 目的 |
|---------|------|-----------|
| `.lmas-core/development/workflows/greenfield-fullstack.yaml` | 阶段 1 | 发现与规划 - 创建 project-brief.md |
| `.lmas-core/development/workflows/brownfield-discovery.yaml` | 阶段 9 | 高管意识报告 |
...
| 代理 | 协作类型 |
|--------|---------------------|
| **@pm (Trinity)** | 分析师为 PRD 创建提供研究和分析 |
| **@po (Keymaker)** | 分析师提供市场见解和竞争分析 |
...
- [任务：facilitate-brainstorming-session.md](.lmas-core/development/tasks/facilitate-brainstorming-session.md)
- [任务：create-deep-research-prompt.md](.lmas-core/development/tasks/create-deep-research-prompt.md)
- [任务：advanced-elicitation.md](.lmas-core/development/tasks/advanced-elicitation.md)
- [任务：create-doc.md](.lmas-core/development/tasks/create-doc.md)
- [任务：document-project.md](.lmas-core/development/tasks/document-project.md)

### 模板

- [模板：project-brief-tmpl.yaml](.lmas-core/product/templates/project-brief-tmpl.yaml)
- [模板：market-research-tmpl.yaml](.lmas-core/product/templates/market-research-tmpl.yaml)
- [模板：competitor-analysis-tmpl.yaml](.lmas-core/product/templates/competitor-analysis-tmpl.yaml)
- [模板：brainstorming-output-tmpl.yaml](.lmas-core/product/templates/brainstorming-output-tmpl.yaml)

### 工作流

- [工作流：greenfield-fullstack.yaml](.lmas-core/development/workflows/greenfield-fullstack.yaml)
- [工作流：brownfield-discovery.yaml](.lmas-core/development/workflows/brownfield-discovery.yaml)

### 代理

- [代理：analyst.md](.lmas-core/development/agents/analyst.md)

...
> **类型：** 棕地项目开发
> **状态：** 官方文档
> **源文件：** `.lmas-core/development/workflows/brownfield-fullstack.yaml`
...
**任务文件：** `.lmas-core/development/tasks/document-project.md`
...
| 属性 | 值 |
|------|-----|
| **代理** | @pm (Trinity) / @architect (Architect) |
| **操作** | 确定是否需要架构文档 |
| **条件** | 创建PRD后 |
...
**清单文件：** `.lmas-core/development/checklists/po-master-checklist.md`
...
**任务文件：** `.lmas-core/development/tasks/shard-doc.md`
...
| @po | Keymaker | 工件验证、分片、回顾 | 8, 10, 17 |
| @sm | River | 详细故事创建 | 11 |
| @dev | Neo | 故事实现 | 13, 15 |
| @qa | Oracle | 实现审查 | 14 |
...
- [ ] LMAS核心配置已配置 (`.lmas-core/core-config.yaml`)
...
| 文件 | 目的 |
|------|------|
| `.lmas-core/development/workflows/brownfield-fullstack.yaml` | 工作流定义 |
| `.lmas-core/development/tasks/brownfield-create-story.md` | 创建简单故事的任务 |
| `.lmas-core/development/tasks/brownfield-create-epic.md` | 创建史诗的任务 |
| `.lmas-core/development/tasks/document-project.md` | 记录现有项目的任务 |
| `.lmas-core/development/tasks/shard-doc.md` | 分割文档的任务 |
| `.lmas-core/development/tasks/create-brownfield-story.md` | 创建棕地故事的任务 |
| `.lmas-core/development/tasks/create-next-story.md` | 从PRD创建故事的任务 |
| `.lmas-core/product/checklists/po-master-checklist.md` | PO验证清单 |
...
| `.lmas-core/working-in-the-brownfield.md` | 棕地工作指南 |

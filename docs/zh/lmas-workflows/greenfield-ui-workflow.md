...
| `@pm` | Trinity | 产品经理 | `*create-prd`, `*shard-prd`, `*create-epic` |
| `@ux-expert` | Uma | UX/UI 设计师 | `*create-front-end-spec`, `*generate-ui-prompt`, `*wireframe` |
| `@architect` | Architect | 系统架构师 | `*create-front-end-architecture`, `*document-project` |
| `@po` | Keymaker | 产品所有者 | `*execute-checklist-po`, `*shard-doc`, `*validate-story-draft` |
| `@sm` | Niobe | Scrum 大师 | `*draft`, `*story-checklist` |
| `@dev` | Neo | 全栈开发人员 | `*develop`, `*run-tests`, `*apply-qa-fixes` |
| `@qa` | Oracle | 测试架构师 | `*review`, `*gate`, `*test-design` |
...
2. **LMAS-Core 可用**
   - `.lmas-core/development/templates/` 中的模板
   - `.lmas-core/development/tasks/` 中的任务
   - `.lmas-core/development/checklists/` 中的检查列表
...
| 问题 | 可能原因 | 解决方案 |
|------|---------|---------|
| 模板未找到 | 路径不正确 | 检查 `.lmas-core/development/templates/` |
...
| 文件 | 路径 |
|------|------|
| 工作流定义 | `.lmas-core/development/workflows/greenfield-ui.yaml` |
| 知识库 | `.lmas-core/data/lmas-kb.md` |
...
| 模板 | 路径 |
|------|------|
| 项目简报 | `.lmas-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.lmas-core/development/templates/prd-tmpl.yaml` |
| 前端规范 | `.lmas-core/development/templates/front-end-spec-tmpl.yaml` |
| 前端架构 | `.lmas-core/development/templates/front-end-architecture-tmpl.yaml` |
| 故事 | `.lmas-core/development/templates/story-tmpl.yaml` |

### 检查列表

| 检查列表 | 路径 |
|---------|------|
| PO 主检查 | `.lmas-core/development/checklists/po-master-checklist.md` |
| 故事草稿 | `.lmas-core/development/checklists/story-draft-checklist.md` |
| 故事完成定义 | `.lmas-core/development/checklists/story-dod-checklist.md` |

### 相关文档

- [LMAS 知识库](.lmas-core/data/lmas-kb.md) - 中央知识库
...
*文档自动从 `.lmas-core/development/workflows/greenfield-ui.yaml` 生成*

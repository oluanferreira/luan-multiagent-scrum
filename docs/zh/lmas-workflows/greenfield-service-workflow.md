...
**版本:** 1.0
**创建:** 2026-02-04
**源:** `.lmas-core/development/workflows/greenfield-service.yaml`
...
sequenceDiagram
    ...
    participant AR as 架构师 (Architect)
...
**参考:** `.lmas-core/data/lmas-kb.md#IDE Development Workflow`
...
| `po` | Keymaker | 产品所有者 | `验证` | 验证工件、分片文档、回顾 |
| `sm` | River | Scrum 大师 | `便利` | 创建史诗的故事 |
| `dev` | Neo | 全栈开发人员 | `实现` | 实施故事 |
| `qa` | Oracle | 测试架构师 | `质量` | 审阅实现 |
...
| 文件 | 描述 |
|------|------|
| `.lmas-core/core-config.yaml` | 框架配置 |
| `.env` | 环境变量 |
...
| 类型 | 位置 |
|------|------|
| 代理日志 | `.lmas/logs/agent.log` |
| 项目状态 | `.lmas/project-registry.yaml` |
...
| 文件 | 描述 |
|------|------|
| `.lmas-core/development/workflows/greenfield-service.yaml` | 工作流定义 |
| `.lmas-core/data/lmas-kb.md` | LMAS 知识库 |

### 代理

| 文件 | 代理 |
|------|------|
| `.lmas-core/development/agents/analyst.md` | Atlas (分析师) |
| `.lmas-core/development/agents/pm.md` | Morgan (PM) |
| `.lmas-core/development/agents/architect.md` | Aria (架构师) |
...
| 文件 | 任务 |
|------|------|
| `.lmas-core/development/tasks/create-doc.md` | 创建文档 |
| `.lmas-core/development/tasks/shard-doc.md` | 分片文档 |
| `.lmas-core/development/tasks/sm-create-next-story.md` | 创建故事 |
| `.lmas-core/development/tasks/dev-develop-story.md` | 实施故事 |
| `.lmas-core/development/tasks/qa-review-story.md` | 审阅实现 |
| `.lmas-core/development/tasks/execute-checklist.md` | 执行检查列表 |

### 模板

| 文件 | 模板 |
|------|------|
| `.lmas-core/development/templates/project-brief-tmpl.yaml` | 项目简报 |
| `.lmas-core/development/templates/prd-tmpl.yaml` | PRD |
| `.lmas-core/development/templates/architecture-tmpl.yaml` | 架构 |
| `.lmas-core/development/templates/story-tmpl.yaml` | 用户故事 |
| `.lmas-core/development/templates/qa-gate-tmpl.yaml` | 质量保证关卡 |

### 检查列表

| 文件 | 检查列表 |
|------|----------|
| `.lmas-core/development/checklists/po-master-checklist.md` | PO 验证 |
| `.lmas-core/development/checklists/story-draft-checklist.md` | 验证故事草稿 |
| `.lmas-core/development/checklists/story-dod-checklist.md` | 完成定义 |
...
*文档自动从 `.lmas-core/development/workflows/greenfield-service.yaml` 生成*

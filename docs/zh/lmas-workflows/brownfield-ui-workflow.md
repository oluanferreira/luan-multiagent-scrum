...
| @po | po | Keymaker | 产品所有者 | 验证、分片、回顾 |
| @sm | sm | River | 敏捷主管 | 故事创建 |
| @analyst | analyst | Atlas | 业务分析师 | 故事审查（可选） |
| @dev | dev | Neo | 全栈开发人员 | 实现 |
| @qa | qa | Oracle | 测试架构师 | 质量审查（可选） |
...
| **LMAS模板** | 已安装的模板 | 检查 `.lmas-core/development/templates/` |
| **已配置的代理** | 工作流的所有代理 | 检查 `.lmas-core/development/agents/` |
...
| 文档 | 位置 | 需要用于 |
|------|------|---------|
| PRD模板 | `.lmas-core/development/templates/brownfield-prd-tmpl.yaml` | 步骤2 |
| 前端模板 | `.lmas-core/development/templates/front-end-spec-tmpl.yaml` | 步骤3 |
| 架构模板 | `.lmas-core/development/templates/brownfield-architecture-tmpl.yaml` | 步骤4 |
| PO清单 | `.lmas-core/development/checklists/po-master-checklist.md` | 步骤5 |
| 故事模板 | `.lmas-core/development/templates/story-tmpl.yaml` | 步骤8 |
...
| 文档 | 位置 | 描述 |
|------|------|------|
| LMAS知识库 | `.lmas-core/data/lmas-kb.md` | LMAS基础知识库 |
| IDE开发工作流 | `.lmas-core/data/lmas-kb.md#IDE Development Workflow` | IDE开发工作流 |
| 棕地PRD模板 | `.lmas-core/development/templates/brownfield-prd-tmpl.yaml` | 棕地PRD模板 |
| 前端规范模板 | `.lmas-core/development/templates/front-end-spec-tmpl.yaml` | 前端规范模板 |
| 棕地架构模板 | `.lmas-core/development/templates/brownfield-architecture-tmpl.yaml` | 棕地架构模板 |
| PO主清单 | `.lmas-core/development/checklists/po-master-checklist.md` | PO验证清单 |

### 代理

| 代理 | 文件 | 文档 |
|------|------|------|
| @architect | `.lmas-core/development/agents/architect.md` | Aria - 整体系统架构师 |
| @pm | `.lmas-core/development/agents/pm.md` | Morgan - 产品经理 |
| @ux-expert | `.lmas-core/development/agents/ux-design-expert.md` | Uma - UX/UI设计师 |
| @po | `.lmas-core/development/agents/po.md` | Keymaker - 产品所有者 |
| @sm | `.lmas-core/development/agents/sm.md` | River - 敏捷主管 |
| @analyst | `.lmas-core/development/agents/analyst.md` | Atlas - 业务分析师 |
| @dev | `.lmas-core/development/agents/dev.md` | Neo - 全栈开发人员 |
| @qa | `.lmas-core/development/agents/qa.md` | Oracle - 测试架构师 |
...
*从`.lmas-core/development/workflows/brownfield-ui.yaml`自动生成的文档*

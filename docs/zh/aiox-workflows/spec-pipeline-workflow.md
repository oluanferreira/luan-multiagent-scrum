...
| @qa | qa | Oracle | 测试架构师 | 5 (批评), 5c (批评 2) |
...
| 任务 | 阶段 | 代理 | 文件 |
|------|------|------|------|
| 收集需求 | 1 | @pm | `.lmas-core/development/tasks/spec-gather-requirements.md` |
| 评估复杂性 | 2 | @architect | `.lmas-core/development/tasks/spec-assess-complexity.md` |
| 研究依赖 | 3 | @analyst | `.lmas-core/development/tasks/spec-research-dependencies.md` |
| 编写规范 | 4 | @pm | `.lmas-core/development/tasks/spec-write-spec.md` |
| 批评规范 | 5, 5c | @qa | `.lmas-core/development/tasks/spec-critique.md` |
| 创建实现计划 | 6 | @architect | `.lmas-core/development/tasks/plan-create-implementation.md` |
...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.lmas-core/development/workflows/spec-pipeline.yaml` |
| 任务: 收集 | `.lmas-core/development/tasks/spec-gather-requirements.md` |
| 任务: 评估 | `.lmas-core/development/tasks/spec-assess-complexity.md` |
| 任务: 研究 | `.lmas-core/development/tasks/spec-research-dependencies.md` |
| 任务: 编写规范 | `.lmas-core/development/tasks/spec-write-spec.md` |
| 任务: 批评 | `.lmas-core/development/tasks/spec-critique.md` |
| 任务: 创建计划 | `.lmas-core/development/tasks/plan-create-implementation.md` |
...
- [LMAS 文档索引](../LMAS-DOCUMENTATION-INDEX.md)

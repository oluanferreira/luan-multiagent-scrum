...
| 文档 | 路径 |
|------|------|
| 工作流定义 | `.lmas-core/development/workflows/design-system-build-quality.yaml` |
| UX 设计专家代理 | `.lmas-core/development/agents/ux-design-expert.md` |
| 任务: 构建组件 | `.lmas-core/development/tasks/build-component.md` |
| 任务: 生成文档 | `.lmas-core/development/tasks/generate-documentation.md` |
| 检查清单: WCAG A11y | `.lmas-core/development/checklists/accessibility-wcag-checklist.md` |
| 任务: 计算 ROI | `.lmas-core/development/tasks/calculate-roi.md` |
...
| 版本 | 日期 | 作者 | 更改 |
|------|------|------|------|
| 1.0.0 | 2025-01-30 | Morpheus (LMAS 主机) | 工作流初始版本 |

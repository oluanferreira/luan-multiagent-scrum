...
graph TB
    ...
    subgraph FS["文件系统"]
        WT[.lmas/worktrees/{storyId}/<br/>工作树目录]
        LOG[.lmas/logs/merges/<br/>合并审计日志]
    end
...
| 属性 | 值 |
|------|-----|
| **位置** | `.lmas-core/development/tasks/create-worktree.md` |
| **代理** | @devops (Operator) |
| **版本** | 1.0 |
| **故事** | 1.3 |
...
| `WorktreeManager not found` | LMAS 不完整 | 重新安装 LMAS |
...
3. 增加限制 (如需): 在 `.lmas/config.yaml` 中
...
| 文件 | 路径 |
|------|------|
| **工作流定义** | `.lmas-core/development/workflows/auto-worktree.yaml` |
| **任务创建** | `.lmas-core/development/tasks/create-worktree.md` |
...
| 版本 | 日期 | 作者 | 更改 |
|------|------|------|------|
| 1.0 | 2026-01-28 | @architect (Architect) | 初始版本 |

---

*自动由 LMAS-FULLSTACK 生成的文档*

...
**位置:** `.lmas-core/development/tasks/qa-review-story.md`
...
**位置:** `.lmas-core/development/tasks/qa-create-fix-request.md`
...
**位置:** `.lmas-core/development/tasks/dev-apply-qa-fixes.md`
...
在 `.lmas-core/core-config.yaml` 文件中:
...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.lmas-core/development/workflows/qa-loop.yaml` |
| QA 审查任务 | `.lmas-core/development/tasks/qa-review-story.md` |
| 创建修复请求任务 | `.lmas-core/development/tasks/qa-create-fix-request.md` |
| 应用 QA 修复任务 | `.lmas-core/development/tasks/dev-apply-qa-fixes.md` |
...
| 模板 | 位置 | 用途 |
|------|------|------|
| `qa-gate-tmpl.yaml` | `.lmas-core/development/templates/` | 网关文件结构 |
| `story-tmpl.yaml` | `.lmas-core/development/templates/` | 故事文件结构 |

...
mindmap
  root((棕地项目<br/>发现))
    收集
      ...
      data-engineer["@data-engineer<br/>Dozer (智者)<br/>数据库"]
...
| Dozer | `@data-engineer` | 智者 | PostgreSQL、Supabase、RLS、迁移 |
| Uma | `@ux-design-expert` | 同情者 | 原子设计、设计令牌、可访问性 |
| Oracle | `@qa` | 守护者 | 质量关卡、测试、可追溯性 |
...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.lmas-core/development/workflows/brownfield-discovery.yaml` |
| 任务：brownfield-create-epic | `.lmas-core/development/tasks/brownfield-create-epic.md` |
| 任务：brownfield-create-story | `.lmas-core/development/tasks/brownfield-create-story.md` |
| 任务：db-schema-audit | `.lmas-core/development/tasks/db-schema-audit.md` |
| 任务：security-audit | `.lmas-core/development/tasks/security-audit.md` |

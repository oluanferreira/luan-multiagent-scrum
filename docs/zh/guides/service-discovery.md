...
服务发现系统能够在LMAS框架中找到和使用工作者（任务、模板、脚本、工作流）。**服务注册表**是包含所有可用工作者元数据的中央目录。
...
找到5个与"create story"匹配的工作者:
  ...
  [task] po-create-story
         路径: .lmas-core/development/tasks/po-create-story.md
         标签: task, creation, story, product
         代理: po

  [task] dev-create-brownfield-story
         路径: .lmas-core/development/tasks/dev-create-brownfield-story.md
...
**位置:** `.lmas-core/development/tasks/`
...
**位置:** `.lmas-core/infrastructure/scripts/`
...
**位置:** `.lmas-core/development/workflows/`

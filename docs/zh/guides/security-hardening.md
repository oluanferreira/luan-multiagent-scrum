...
LMAS在AI模型和您的系统之间的特权层运行。本指南涵盖特定于AI编排开发环境的加固策略。
...
如果您在LMAS中发现安全漏洞，请遵循负责任的披露做法：

### 报告流程

1. **不要**为安全漏洞创建公共GitHub问题
2. 将安全问题发送至: **security@lmas.ai**
3. 在报告中包括以下内容:
   - 漏洞描述
   - 复现步骤
   - 潜在影响评估
...
目前，LMAS没有正式的Bug赏金计划。但是，重大安全贡献会被认可，可能会获得LMAS Pro许可或其他认可。

...
- **工具定义:** `.lmas-core/infrastructure/tools/cli/llm-routing.yaml`
- **安装脚本:** `.lmas-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **任务定义:** `.lmas-core/development/tasks/setup-llm-routing.md`

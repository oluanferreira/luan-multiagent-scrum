...
| **@pm** (Trinity) | 📋 | PRD、史诗、产品战略、需求收集、规范编写 | 研究、架构、详细故事 |
| **@architect** (Architect) | 🏛️ | 系统架构、API设计、技术栈、复杂度评估、实现规划 | 研究、PRD、数据库架构 |
| **@data-engineer** (Dozer) | 📊 | 数据库架构、RLS、迁移、查询优化 | 应用架构、DB技术选择 |
| **@sm** (Niobe) | 🌊 | 用户故事、冲刺规划、待办事项整理 | PRD、史诗、研究、实现 |
| **@dev** (Neo) | 💻 | 故事实现、编码、测试、子任务执行、恢复 | 故事创建、部署 |
| **@qa** (Oracle) | 🧪 | 代码审查、测试、质量保证、规范批评、结构化审查 | 实现 |
| **@po** (Keymaker) | 🎯 | 待办事项管理、验收标准、优先级排序 | 史诗创建、架构 |
| **@ux-design-expert** (Nova) | 🎨 | UI/UX设计、线框图、设计系统 | 实现 |
| **@devops** (Operator) | ⚙️ | Git操作、PR创建、部署、CI/CD、工作树管理、迁移 | 本地Git、实现 |
| **@lmas-master** (Morpheus) | 👑 | 框架开发、多代理编排 | 日常任务（使用专门代理） |

---

## 🤖 ADE命令按代理 (v2.2.0)

### @devops (Operator) - 基础设施与运营
...
| `*list-gotchas` | 列出.lmas/gotchas.md中的已知陷阱 |

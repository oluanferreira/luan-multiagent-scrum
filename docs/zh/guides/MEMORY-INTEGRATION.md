...
集成遵循 LMAS Open Core 模型:
- **lmas-core:** UnifiedActivationPipeline 中的扩展点 (本指南)
- **lmas-pro:** 记忆智能实现 (检索, 评分, 学习)
...
**解决方案:**
1. 减少摘要数量 (将旧摘要归档到 `.lmas/session-digests/archive/`)

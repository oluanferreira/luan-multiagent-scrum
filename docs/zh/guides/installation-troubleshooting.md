...
2. **运行诊断**: `npx lmas-core@latest doctor`
3. **检查系统信息**: `npx lmas-core@latest info`
...
| 命令                             | 描述                    |
| -------------------------------- | ----------------------- |
| `npx lmas-core@latest`           | 安装/运行向导            |
| `npx lmas-core@latest --version` | 显示版本                 |
| `npx lmas-core@latest --help`    | 显示帮助                 |
| `npx lmas-core@latest install`   | 在当前目录安装           |
| `npx lmas-core@latest init <名称>` | 创建新项目             |
| `npx lmas-core@latest doctor`    | 运行诊断                 |
| `npx lmas-core@latest info`      | 显示系统信息             |

---

*最后更新: 2025年12月 | LMAS-Core v2.2.0*

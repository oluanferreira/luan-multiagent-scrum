...
├── framework/                 # English
├── platforms/                 # English
├── lmas-agent-flows/          # Detailed agent documentation (PT)
├── lmas-workflows/            # Detailed workflow documentation (PT)
│
├── pt/                        # Português
├── es/                        # Español
└── zh/                        # 中文（简体）
...
- [代理系统文档](./lmas-agent-flows/README.md)
- [工作流文档](./lmas-workflows/README.md)

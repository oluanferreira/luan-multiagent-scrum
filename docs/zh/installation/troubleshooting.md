...
### 问题 1："npx @lmas/lmas-core is not recognized"
...
```
npm ERR! code E404
npm ERR! 404 Not Found - GET https://registry.npmjs.org/@lmas/lmas-core
```
...
npm ERR! network request to https://registry.npmjs.org/@lmas/lmas-core failed
```
...
# 以详细日志重试
npm install @lmas/lmas-core --verbose
```
...
# 显示详细日志
npx @lmas/lmas-core install --verbose
```
...
1. 运行 `npx @lmas/lmas-core status` 并记录输出
2. 查看此故障排除指南
3. 搜索现有 [GitHub 问题](https://github.com/oluanferreira/luan-multiagent-scrum/issues)

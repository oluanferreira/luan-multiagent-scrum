...
本文档描述了将 Synkra LMAS 文档翻译成中文的完整计划。
...
**代理流程文档 (lmas-agent-flows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 代理流程 README | `lmas-agent-flows/README.md` | `zh/lmas-agent-flows/README.md` | ⬜ |
| LMAS Master 系统 | `lmas-agent-flows/lmas-master-system.md` | `zh/lmas-agent-flows/lmas-master-system.md` | ⬜ |
| 开发者系统 | `lmas-agent-flows/dev-system.md` | `zh/lmas-agent-flows/dev-system.md` | ⬜ |
| 架构师系统 | `lmas-agent-flows/architect-system.md` | `zh/lmas-agent-flows/architect-system.md` | ⬜ |
| QA 系统 | `lmas-agent-flows/qa-system.md` | `zh/lmas-agent-flows/qa-system.md` | ⬜ |
| UX 设计专家系统 | `lmas-agent-flows/ux-design-expert-system.md` | `zh/lmas-agent-flows/ux-design-expert-system.md` | ⬜ |
| 数据工程师系统 | `lmas-agent-flows/data-engineer-system.md` | `zh/lmas-agent-flows/data-engineer-system.md` | ⬜ |
| 分析师系统 | `lmas-agent-flows/analyst-system.md` | `zh/lmas-agent-flows/analyst-system.md` | ⬜ |
| 产品经理系统 | `lmas-agent-flows/pm-system.md` | `zh/lmas-agent-flows/pm-system.md` | ⬜ |
| Scrum Master 系统 | `lmas-agent-flows/sm-system.md` | `zh/lmas-agent-flows/sm-system.md` | ⬜ |
| DevOps 系统 | `lmas-agent-flows/devops-system.md` | `zh/lmas-agent-flows/devops-system.md` | ⬜ |
| Squad 创建者系统 | `lmas-agent-flows/squad-creator-system.md` | `zh/lmas-agent-flows/squad-creator-system.md` | ⬜ |

**工作流文档 (lmas-workflows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 工作流 README | `lmas-workflows/README.md` | `zh/lmas-workflows/README.md` | ⬜ |
| 绿地全栈工作流 | `lmas-workflows/greenfield-fullstack-workflow.md` | `zh/lmas-workflows/greenfield-fullstack-workflow.md` | ⬜ |
| 绿地服务工作流 | `lmas-workflows/greenfield-service-workflow.md` | `zh/lmas-workflows/greenfield-service-workflow.md` | ⬜ |
| 绿地 UI 工作流 | `lmas-workflows/greenfield-ui-workflow.md` | `zh/lmas-workflows/greenfield-ui-workflow.md` | ⬜ |
| 棕地全栈工作流 | `lmas-workflows/brownfield-fullstack-workflow.md` | `zh/lmas-workflows/brownfield-fullstack-workflow.md` | ⬜ |
| 棕地服务工作流 | `lmas-workflows/brownfield-service-workflow.md` | `zh/lmas-workflows/brownfield-service-workflow.md` | ⬜ |
| 棕地 UI 工作流 | `lmas-workflows/brownfield-ui-workflow.md` | `zh/lmas-workflows/brownfield-ui-workflow.md` | ⬜ |
| 棕地发现工作流 | `lmas-workflows/brownfield-discovery-workflow.md` | `zh/lmas-workflows/brownfield-discovery-workflow.md` | ⬜ |
| 规格流水线工作流 | `lmas-workflows/spec-pipeline-workflow.md` | `zh/lmas-workflows/spec-pipeline-workflow.md` | ⬜ |
| QA 循环工作流 | `lmas-workflows/qa-loop-workflow.md` | `zh/lmas-workflows/qa-loop-workflow.md` | ⬜ |
| Story 开发周期 | `lmas-workflows/story-development-cycle-workflow.md` | `zh/lmas-workflows/story-development-cycle-workflow.md` | ⬜ |
...
| LMAS 视觉概览 | `architecture/LMAS-VISUAL-OVERVIEW.md` | `zh/architecture/LMAS-VISUAL-OVERVIEW.md` | ⬜ |
...
| Gate | 门控 | 門控 | 质量门控 |
| Persona | 角色 / 人格 | 角色 / 人格 | |
| Constitution | 宪法 / 准则 | 憲法 / 準則 | LMAS Constitution |
| CLI | CLI / 命令行 | CLI / 命令列 | |
| Hook | 钩子 | 鉤子 | |
| MCP | MCP | MCP | 不翻译 |
...
3. **保留品牌名** - Synkra、LMAS、Claude 等品牌名不翻译
...
│       └── README.md
│
├── lmas-agent-flows/                   # 代理流程
│   ├── README.md
│   ├── lmas-master-system.md
│   ├── dev-system.md
│   ├── architect-system.md
│   ├── qa-system.md

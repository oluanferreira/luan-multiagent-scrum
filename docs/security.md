...
When using LMAS Framework, we recommend:
...
LMAS Framework executes AI-generated code and commands. Users should:
...
- LMAS may process sensitive data through AI providers

...
> **EN** | [PT](../../lmas-workflows/spec-pipeline-workflow.md) | [ES](../../es/lmas-workflows/spec-pipeline-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../lmas-workflows/spec-pipeline-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../lmas-workflows/spec-pipeline-workflow.md).*

...
> **EN** | [PT](../../lmas-agent-flows/squad-creator-system.md) | [ES](../../es/lmas-agent-flows/squad-creator-system.md)

---

## Summary

**@squad-creator** (Nova) is the **Creator** of the LMAS agent system. This agent is responsible for:
...
**[View Full Documentation (PT)](../../lmas-agent-flows/squad-creator-system.md)**

---

*LMAS Agent Flows - @squad-creator System v1.0*

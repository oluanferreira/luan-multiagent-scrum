# LMAS Agent Flows - Detailed Agent Documentation

> **EN** | [PT](../../lmas-agent-flows/README.md) | [ES](../../es/lmas-agent-flows/README.md) | [ZH](../../zh/lmas-agent-flows/README.md)
...
This folder contains detailed documentation for all LMAS agents, including:
...
| LMAS Workflows | [docs/lmas-workflows/](../../lmas-workflows/) | Detailed workflows |
...
*LMAS Agent Flows Documentation v1.0 - Detailed documentation of the agent system*

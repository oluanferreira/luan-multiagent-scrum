...
> **EN** | [PT](../../lmas-workflows/brownfield-fullstack-workflow.md) | [ES](../../es/lmas-workflows/brownfield-fullstack-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../lmas-workflows/brownfield-fullstack-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../lmas-workflows/brownfield-fullstack-workflow.md).*

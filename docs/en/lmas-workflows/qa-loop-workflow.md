...
> **EN** | [PT](../../lmas-workflows/qa-loop-workflow.md) | [ES](../../es/lmas-workflows/qa-loop-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../lmas-workflows/qa-loop-workflow.md)

---

## Summary

The **QA Loop Workflow** defines the quality assurance cycle within LMAS development. It ensures:
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../lmas-workflows/qa-loop-workflow.md).*

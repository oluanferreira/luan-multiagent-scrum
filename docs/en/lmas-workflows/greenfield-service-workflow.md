...
> **EN** | [PT](../../lmas-workflows/greenfield-service-workflow.md) | [ES](../../es/lmas-workflows/greenfield-service-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../lmas-workflows/greenfield-service-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../lmas-workflows/greenfield-service-workflow.md).*

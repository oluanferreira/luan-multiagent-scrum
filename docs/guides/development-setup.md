...
Complete guide for developers who want to contribute to the LMAS project.
...
| Tool                 | Purpose                                 |
| -------------------- | --------------------------------------- |
| **Claude Code**      | AI-powered development with LMAS agents |
| **VS Code / Cursor** | IDE with LMAS integration               |
...
1. Navigate to [github.com/oluanferreira/luan-multiagent-scrum](https://github.com/oluanferreira/luan-multiagent-scrum)
...
Understanding the `lmas-core` directory structure:

```
lmas-core/
├── .lmas-core/                    # Framework source (committed)
...
│   ├── commands/LMAS/agents/      # Agent skill commands
│   ├── hooks/                     # Governance hooks
│   └── rules/                     # AI behavior rules
│
├── bin/                           # CLI entry points
│   ├── lmas.js                    # Main CLI
│   └── lmas-minimal.js            # Minimal CLI
│
...
| ----------------------------------- | ---------------------------- | ----------------------- |
| `.lmas-core/development/agents/`    | Agent personas and behaviors | Adding/modifying agents |
| `.lmas-core/development/tasks/`     | Executable task workflows    | Adding/modifying tasks  |
| `.lmas-core/development/workflows/` | Multi-step orchestrations    | Creating workflows      |
...
Create a new file in `.lmas-core/development/agents/`:

```bash
# File: .lmas-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Create in .lmas-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Create in .lmas-core/development/checklists/
  tools:
    - git
    - context7
````
...
Create a new file in `.lmas-core/development/tasks/`:
...
# Examples:
# .lmas-core/development/tasks/dev-build-component.md  (dev agent)
# .lmas-core/development/tasks/create-doc.md          (shared)
```
...
Create a new file in `.lmas-core/development/workflows/`:

```bash
# File: .lmas-core/development/workflows/my-workflow.yaml
```
...
- Tag `@LMAS/core-team` for urgent issues

# LMAS Quality Gate System Guide

> **EN** | [PT](../pt/guides/quality-gates.md) | [ES](../es/guides/quality-gates.md)

---

> Comprehensive guide to the 3-layer quality gate system for Synkra LMAS.
...
The LMAS Quality Gate System provides automated quality assurance through three progressive layers of validation. Each layer catches different types of issues at the appropriate stage of development.
...
| **Oracle (@qa)** | Automated QA review | CRITICAL          |
...
```javascript
// Programmatic Oracle invocation
...
# Run with options
lmas qa run --verbose          # Detailed output
lmas qa run --fail-fast        # Stop on first failure
lmas qa run --continue-on-fail # Continue despite failures
```
...
| Oracle blocked       | Review @qa feedback, update code        |
...
_Synkra LMAS v4 Quality Gate System Guide_

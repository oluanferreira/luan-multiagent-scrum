...
| **Oracle Findings**      | Issues found by @qa agent                |
...
```bash
# Sync from .lmas/data to dashboard
npm run sync-metrics
...
This copies `.lmas/data/quality-metrics.json` to `tools/quality-dashboard/public/.lmas/data/`.

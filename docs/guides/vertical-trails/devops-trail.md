...
Você está em um projeto LMAS e precisa:
...
```bash
# Projeto LMAS inicializado
npx lmas-core doctor  # deve retornar healthy
...
**Output esperado:**
```
-- Operator aqui! DevOps & Infrastructure Specialist.
...
**Interação:**
```
Operator: Qual nome do repositório?
Você: my-lmas-project

Operator: Visibilidade?
Você: private

Operator: Criar issues templates?
Você: sim

Operator: Habilitar branch protection em main?
Você: sim
```
...
✅ Repositório criado: github.com/seu-user/my-lmas-project
...
**Interação:**
```
Operator: Qual stack tecnológica?
Você: Node.js

Operator: Versão do Node?
Você: 20

Operator: Incluir CodeRabbit?
Você: sim

Operator: Stages do pipeline?
...
📋 CI Pipeline triggered:
  https://github.com/seu-user/my-lmas-project/actions/runs/xxxxx
```
...
Release URL:
  https://github.com/seu-user/my-lmas-project/releases/tag/v1.1.0
```
...
*Trilha criada para Story LMAS-DIFF-4.3.1*
*-- Operator, automatizando tudo*

...
**Output esperado:**
```
-- Dozer aqui! Database Architect & Operations Engineer.
...
|------|---------|-----------------|---|
| 1 | `@data-engineer` | Greeting de Dozer | [ ] |

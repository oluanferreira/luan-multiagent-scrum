# Synkra LMAS Testing Guide

> **EN** | [PT](../pt/guides/testing-guide.md) | [ES](../es/guides/testing-guide.md)

---

> Comprehensive guide to the testing strategy, tools, and best practices for Synkra LMAS.
...
LMAS follows a comprehensive testing strategy that ensures code quality across all layers of the framework. Our testing philosophy is built on:
 ...
 * Agent Backward Compatibility Tests
 *
 * Ensures agents from previous LMAS versions continue to work.
 */
...
LMAS supports Windows, macOS, and Linux. Cross-platform testing ensures consistent behavior.
...
The LMAS Quality Gate System (see [Quality Gates Guide](./quality-gates.md)) integrates testing at multiple layers:
...
_Synkra LMAS v4 Testing Guide_

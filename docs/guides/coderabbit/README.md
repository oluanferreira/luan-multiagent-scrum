...
**Applicable Agents:** @qa (Oracle), @devops (Operator)
...
## LMAS Integration Overview

In LMAS, CodeRabbit is integrated into the Quality Gates system as part of **Layer 2: PR Automation**.
...
### @qa (Oracle) - Quality Assurance Agent

Oracle uses CodeRabbit for comprehensive story reviews with self-healing capabilities.
...
### @devops (Operator) - DevOps Agent

Operator uses CodeRabbit as a quality gate before push and PR creation.
...
### LMAS Agent Configuration

CodeRabbit is configured in agent definition files:

**Location:** `.lmas-core/development/agents/qa.md` and `devops.md`
...
coderabbit_integration:
  ...
  wsl_config:
    ...
    working_directory: /mnt/c/Users/.../lmas-core
```
...
# Direct command
wsl bash -c 'cd /mnt/c/.../lmas-core && ~/.local/bin/coderabbit --prompt-only --base main'
```
...
| Severity     | Description                               | LMAS Action                      |
| ------------ | ----------------------------------------- | -------------------------------- |
...
## Integration with LMAS Workflow
...
- [Quality Gates Specification](../../../.lmas-core/docs/standards/QUALITY-GATES-SPECIFICATION.md)
- [@qa Agent Definition](../../../.lmas-core/development/agents/qa.md)
- [@devops Agent Definition](../../../.lmas-core/development/agents/devops.md)
- [Pre-Push Quality Gate Task](../../../.lmas-core/development/tasks/github-devops-pre-push-quality-gate.md)
...
_Last Updated: 2026-01-28 | LMAS Framework Team_

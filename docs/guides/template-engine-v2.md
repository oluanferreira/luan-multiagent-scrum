...
> Document generation and variable substitution engine for Synkra LMAS.
...
The Template Engine provides a consistent way to generate documents (PRDs, ADRs, Stories, etc.) with variable substitution, conditionals, and loops. It powers all document generation tasks in LMAS.

...
| **@pm** (Trinity)             | 📋   | PRD, epics, product strategy, requirements gathering, spec writing                          | Research, architecture, detailed stories |
| **@architect** (Architect)        | 🏛️   | System architecture, API design, tech stack, complexity assessment, implementation planning | Research, PRD, database schema           |
| **@data-engineer** (Dozer)    | 📊   | Database schema, RLS, migrations, query optimization                                        | App architecture, DB tech selection      |
| **@sm** (Niobe)              | 🌊   | User stories, sprint planning, backlog grooming                                             | PRD, epics, research, implementation     |
| **@dev** (Neo)               | 💻   | Story implementation, coding, testing, subtask execution, recovery                          | Story creation, deployment               |
| **@qa** (Oracle)              | 🧪   | Code review, testing, quality assurance, spec critique, structured review                   | Implementation                           |
| **@po** (Keymaker)                | 🎯   | Backlog management, acceptance criteria, prioritization                                     | Epic creation, architecture              |
| **@ux-design-expert** (Nova) | 🎨   | UI/UX design, wireframes, design systems                                                    | Implementation                           |
| **@devops** (Operator)           | ⚙️   | Git ops, PR creation, deployment, CI/CD, worktree management, migrations                    | Local Git, implementation                |
| **@lmas-master** (Morpheus)     | 👑   | Framework development, multi-agent orchestration                                            | Routine tasks (use specialized agents)   |

---

## 🤖 ADE Commands by Agent (v2.2.0)

### @devops (Operator) - Infrastructure & Operations
...
| `*list-gotchas` | List known gotchas from .lmas/gotchas.md |

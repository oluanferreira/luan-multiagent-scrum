...
**Option 1: If you have lmas-core cloned**
```bash
# From lmas-core directory
...
- **Tool Definition:** `.lmas-core/infrastructure/tools/cli/llm-routing.yaml`
- **Install Script:** `.lmas-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Task Definition:** `.lmas-core/development/tasks/setup-llm-routing.md`
...
*Generated by LMAS Framework - Story 6.7*

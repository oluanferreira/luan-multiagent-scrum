...
LMAS Workflows are orchestrated sequences of agent activities that automate complex development processes. They provide structured, repeatable patterns for common development scenarios.
...
- **Core**: `.lmas-core/development/workflows/{name}.yaml`
...
State is persisted in `.lmas/{instance-id}-state.yaml`:
...
LMAS detects common workflow patterns based on command history:
...
| **Location** | `.lmas-core/development/workflows/` | `.lmas-core/development/tasks/` |
...
ls .lmas-core/development/workflows/

# Validate a workflow
*validate-workflow {name}

# View workflow details
cat .lmas-core/development/workflows/{name}.yaml
```
...
- [LMAS Workflows](../lmas-workflows/README.md) - Complete documentation for each workflow
...
*LMAS Workflows Guide v1.0 - Orchestrating AI-Human Collaboration*

# LMAS Service Discovery Guide

> **EN** | [PT](../pt/guides/service-discovery.md) | [ES](../es/guides/service-discovery.md)

---

> How to discover, query, and use workers in the LMAS framework.
...
The Service Discovery system enables finding and using workers (tasks, templates, scripts, workflows) across the LMAS framework. The **Service Registry** is the central catalog containing metadata about all available workers.
...
**Location:** `.lmas-core/infrastructure/scripts/`

...
> **Scope:** `.lmas-core/development/scripts/` (38 files)
...
| 26 | `workflow-validator.js` | Validates workflow YAML files against LMAS conventions (9 checks) | `fs.promises`, `path`, `js-yaml` | 18 files: `validate-workflow.md`, `squad-validator.js`, tasks | @qa, @architect | No |
...
| S6 | `squad-migrator.js` | Migrates legacy squad formats to LMAS 2.1 standard (SQS-7) | `fs.promises`, `path`, `js-yaml` | `index.js`, `squad-creator-migrate.md`, tests | @squad-creator | No |
| S7 | `squad-downloader.js` | Downloads squads from lmas-squads GitHub repository (SQS-6) | `https`, `fs.promises`, `path` | `index.js`, `squad-creator-download.md`, tests | @squad-creator | No |
| S8 | `squad-publisher.js` | Publishes squads to lmas-squads GitHub repo via PR (SQS-6) | `child_process`, `fs.promises`, `path` | `index.js`, `squad-creator-publish.md`, tests | @squad-creator | No |
...
The LMAS greeting system generates contextual, session-aware greetings when agents are activated. It consists of **8 greeting-related files** in the development scripts directory plus supporting infrastructure.
...
| `.lmas-core/product/templates/activation-instructions-inline-greeting.yaml` | Template | ~64 | YAML template for inline greeting logic in agent files |
| `.claude/commands/greet.md` | Slash Command | ~102 | `/greet` slash command definition for Claude Code |

**External copies (in `.claude/commands/LMAS/scripts/`):**
| File | Purpose |
|------|---------|
...
The preference is stored in `.lmas-core/core-config.yaml` under `agentIdentity.greeting.preference`.
...
Used by: @dev, @qa, @architect, @pm, @po, @sm, @analyst, @lmas-master, @squad-creator

```yaml
activation-instructions:
  - STEP 3: |
      Build intelligent greeting using .lmas-core/development/scripts/greeting-builder.js
...
|-------|------|-----------|--------|------------------------|
| @dev (Neo) | `\U0001f4bb` | Builder | Aquarius | "Neo the Builder ready to construct excellence!" |
| @qa (Oracle) | `\U0001f6e1\ufe0f` | Guardian | Virgo | "Oracle the Guardian ready!" |
| @po (Keymaker) | `\u2696\ufe0f` | Balancer | Libra | "Keymaker the Balancer ready!" |
| @pm (Trinity) | `\U0001f4cb` | Strategist | Capricorn | "Morgan the Strategist ready!" |
| @sm (Niobe) | `\U0001f30a` | Facilitator | Sagittarius | "River the Facilitator ready!" |
| @architect (Architect) | `\U0001f3d7\ufe0f` | Visionary | Gemini | "Aria the Visionary ready!" |
| @analyst (Link) | `\U0001f50d` | Decoder | Scorpio | "Alex the Decoder ready!" |
| @devops (Operator) | `\u2699\ufe0f` | Automator | Aries | "Operator the Automator ready!" |
| @data-engineer (Dozer) | `\U0001f4ca` | Sage | Taurus | "Dozer the Sage ready!" |
| @ux-design-expert (Uma) | `\U0001f3a8` | Empathizer | Pisces | "Uma the Empathizer ready!" |
| @lmas-master | `\U0001f9e0` | Orchestrator | Leo | "LMAS Master Orchestrator ready!" |
...
```
greeting-builder.js
  |-- context-detector.js          (.lmas-core/core/session/)
  |-- git-config-detector.js       (.lmas-core/infrastructure/scripts/)
  |-- workflow-navigator.js        (sibling in development/scripts/)
  |-- greeting-preference-manager.js (sibling)
  |-- project-status-loader.js     (.lmas-core/infrastructure/scripts/)
  |-- PermissionMode               (.lmas-core/core/permissions/)
  |-- js-yaml
  |-- fs, path

generate-greeting.js
  |-- greeting-builder.js          (sibling)
  |-- session-context-loader.js    (.lmas-core/scripts/)
  |-- project-status-loader.js     (.lmas-core/infrastructure/scripts/)
...
| @lmas-master | greeting-builder, agent-config-loader | 2 |
...
```
C:\Users\AllFluence-User\Workspaces\LMAS\SynkraAI\lmas-core\.lmas-core\development\scripts\
```

Full absolute paths for top-level scripts:
```
.lmas-core/development/scripts/agent-assignment-resolver.js
.lmas-core/development/scripts/agent-config-loader.js
.lmas-core/development/scripts/agent-exit-hooks.js
.lmas-core/development/scripts/apply-inline-greeting-all-agents.js
.lmas-core/development/scripts/audit-agent-config.js
.lmas-core/development/scripts/backlog-manager.js
.lmas-core/development/scripts/batch-update-agents-session-context.js
.lmas-core/development/scripts/decision-context.js
.lmas-core/development/scripts/decision-log-generator.js
.lmas-core/development/scripts/decision-log-indexer.js
.lmas-core/development/scripts/decision-recorder.js
.lmas-core/development/scripts/dev-context-loader.js
.lmas-core/development/scripts/generate-greeting.js
.lmas-core/development/scripts/greeting-builder.js
.lmas-core/development/scripts/greeting-config-cli.js
.lmas-core/development/scripts/greeting-preference-manager.js
.lmas-core/development/scripts/migrate-task-to-v2.js
.lmas-core/development/scripts/story-index-generator.js
.lmas-core/development/scripts/story-manager.js
.lmas-core/development/scripts/story-update-hook.js
.lmas-core/development/scripts/task-identifier-resolver.js
.lmas-core/development/scripts/test-greeting-system.js
.lmas-core/development/scripts/validate-task-v2.js
.lmas-core/development/scripts/verify-workflow-gaps.js
.lmas-core/development/scripts/workflow-navigator.js
.lmas-core/development/scripts/workflow-state-manager.js
.lmas-core/development/scripts/workflow-validator.js
```

Squad sub-module:
```
.lmas-core/development/scripts/squad/index.js
.lmas-core/development/scripts/squad/squad-analyzer.js
.lmas-core/development/scripts/squad/squad-designer.js
.lmas-core/development/scripts/squad/squad-downloader.js
.lmas-core/development/scripts/squad/squad-extender.js
.lmas-core/development/scripts/squad/squad-generator.js
.lmas-core/development/scripts/squad/squad-loader.js
.lmas-core/development/scripts/squad/squad-migrator.js
.lmas-core/development/scripts/squad/squad-publisher.js
.lmas-core/development/scripts/squad/squad-validator.js
```

---

*Cross-Reference Phase 3 Analysis - LMAS Framework*
*Generated: 2026-02-05*

...
> **Arquivo Fonte:** `.lmas-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo de Task:** `.lmas-core/development/tasks/document-project.md`
...
| Atributo | Valor |
|----------|-------|
| **Agentes** | @pm (Trinity) / @architect (Architect) |
...
**Arquivo de Checklist:** `.lmas-core/product/checklists/po-master-checklist.md`
...
**Arquivo de Task:** `.lmas-core/development/tasks/shard-doc.md`
...
**Arquivos de Task:**
- `.lmas-core/development/tasks/create-next-story.md`
- `.lmas-core/development/tasks/create-brownfield-story.md`
...
| @po | Keymaker | Validacao de artefatos, sharding, retrospectiva | 8, 10, 17 |
| @sm | River | Criacao detalhada de stories | 11 |
| @dev | Neo | Implementacao de stories | 13, 15 |
| @qa | Oracle | Review de implementacao | 14 |
...
- [ ] Core config LMAS configurado (`.lmas-core/core-config.yaml`)
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/workflows/brownfield-fullstack.yaml` | Definicao do workflow |
| `.lmas-core/development/tasks/brownfield-create-story.md` | Task para criar story simples |
| `.lmas-core/development/tasks/brownfield-create-epic.md` | Task para criar epic |
| `.lmas-core/development/tasks/document-project.md` | Task para documentar projeto existente |
| `.lmas-core/development/tasks/shard-doc.md` | Task para fragmentar documentos |
| `.lmas-core/development/tasks/create-brownfield-story.md` | Task para criar story brownfield |
| `.lmas-core/development/tasks/create-next-story.md` | Task para criar story de PRD |
| `.lmas-core/product/checklists/po-master-checklist.md` | Checklist de validacao PO |

### Arquivos de Agentes

| Arquivo | Agente |
|---------|--------|
| `.lmas-core/development/agents/analyst.md` | @analyst (Atlas) |
| `.lmas-core/development/agents/architect.md` | @architect (Architect) |
| `.lmas-core/development/agents/pm.md` | @pm (Trinity) |
| `.lmas-core/development/agents/po.md` | @po (Keymaker) |
| `.lmas-core/development/agents/sm.md` | @sm (Niobe) |
| `.lmas-core/development/agents/dev.md` | @dev (Neo) |
| `.lmas-core/development/agents/qa.md` | @qa (Oracle) |
...
| `.lmas-core/working-in-the-brownfield.md` | Guia de trabalho brownfield |

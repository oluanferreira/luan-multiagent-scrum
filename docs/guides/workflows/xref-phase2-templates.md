...
**Scope:** All templates, checklists, and data files in `.lmas-core/` mapped to consuming tasks, agents, and workflows.
...
15. [Framework Data Files (.lmas-core/data/)](#15-framework-data-files)
...
Location: `.lmas-core/product/templates/`
...
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `architecture-tmpl.yaml` | create-doc | architect, lmas-master | greenfield-service (architecture step) | No |
| 2 | `brainstorming-output-tmpl.yaml` | analyst-facilitate-brainstorming | analyst, lmas-master | -- | No |
| 3 | `brownfield-architecture-tmpl.yaml` | create-doc | architect, lmas-master | brownfield-ui, brownfield-service, brownfield-fullstack | No |
| 4 | `brownfield-prd-tmpl.yaml` | create-doc | pm, lmas-master | brownfield-ui, brownfield-service, brownfield-fullstack | No |
| 5 | `competitor-analysis-tmpl.yaml` | create-doc | analyst, lmas-master | -- | No |
| 6 | `design-story-tmpl.yaml` | create-doc (implicit) | -- | -- | **WEAK** |
| 7 | `front-end-architecture-tmpl.yaml` | create-doc | architect, lmas-master, ux-design-expert | greenfield-ui, greenfield-fullstack | No |
| 8 | `front-end-spec-tmpl.yaml` | create-doc | ux-design-expert, lmas-master | greenfield-ui, greenfield-fullstack, brownfield-ui | No |
| 9 | `fullstack-architecture-tmpl.yaml` | create-doc | architect, lmas-master | greenfield-fullstack | No |
| 10 | `index-strategy-tmpl.yaml` | create-doc | data-engineer | -- | No |
| 11 | `market-research-tmpl.yaml` | create-doc | analyst, lmas-master | -- | No |
| 12 | `migration-plan-tmpl.yaml` | create-doc | data-engineer | -- | No |
| 13 | `prd-tmpl.yaml` | create-doc | pm, lmas-master | greenfield-ui, greenfield-service, greenfield-fullstack (implicit) | No |
| 14 | `project-brief-tmpl.yaml` | create-doc | analyst, lmas-master | -- | No |
...
| 19 | `story-tmpl.yaml` | create-doc, create-next-story, sm-create-next-story, dev-validate-next-story, validate-next-story | po, sm, qa, lmas-master | story-development-cycle (implicit) | No |
...
| 8 | `task.hbs` | create-doc (via template engine) | lmas-master (implicit) | -- | **WEAK** |
...
Location: `.lmas-core/product/templates/ide-rules/`
...
| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `personalized-agent-template.md` | create-doc (implicit), modify-agent | lmas-master (implicit) | -- | No |
...
| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `agent-template.yaml` | modify-agent, create-doc | lmas-master | -- | No |
| 2 | `task-template.md` | create-task (implicit), squad-creator-extend | lmas-master | -- | No |
| 3 | `workflow-template.yaml` | squad-creator-extend, verify-workflow-gaps (script) | lmas-master | -- | No |
...
Location: `.lmas-core/product/templates/engine/`
...
Location: `.lmas-core/development/templates/squad/`
...
Location: `.lmas-core/development/templates/service-template/`
...
Location: `.lmas-core/development/templates/squad-template/`
...
Location: `.lmas-core/development/templates/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `lmas-doc-template.md` | create-doc (implicit) | -- | -- | **WEAK** |
| 2 | `subagent-step-prompt.md` | run-workflow-engine | lmas-master | -- | No |

---

## 13. Product Checklists

Location: `.lmas-core/product/checklists/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `architect-checklist.md` | execute-checklist, analyze-cross-artifact | architect, lmas-master | -- | No |
| 2 | `change-checklist.md` | correct-course, modify-agent, modify-task, modify-workflow, update-manifest, qa-review-proposal, propose-modification, brownfield-create-epic | pm, po, lmas-master | -- | No |
| 3 | `pm-checklist.md` | execute-checklist (via prd-tmpl.yaml), analyze-cross-artifact | pm, lmas-master | -- | No |
| 4 | `po-master-checklist.md` | execute-checklist, validate-next-story, create-next-story, sm-create-next-story, create-brownfield-story, brownfield-create-story, brownfield-create-epic, qa-trace-requirements, dev-validate-next-story, po-sync-story-to-clickup, po-pull-story-from-clickup | po, lmas-master | greenfield-ui, greenfield-service, greenfield-fullstack, brownfield-ui, brownfield-service, brownfield-fullstack | No |
| 5 | `story-dod-checklist.md` | execute-checklist, dev-develop-story, analyze-cross-artifact, build-autonomous | dev, lmas-master | story-development-cycle (implicit) | No |
| 6 | `story-draft-checklist.md` | create-next-story, sm-create-next-story, analyze-cross-artifact | sm, lmas-master | -- | No |
...
Location: `.lmas-core/product/data/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `brainstorming-techniques.md` | analyst-facilitate-brainstorming | analyst, lmas-master | -- | No |
| 2 | `elicitation-methods.md` | advanced-elicitation, create-doc | lmas-master | -- | No |
...
Location: `.lmas-core/data/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `lmas-kb.md` | -- (knowledge base) | analyst, lmas-master | greenfield-ui, greenfield-service, greenfield-fullstack, brownfield-ui, brownfield-service, brownfield-fullstack | No |
...
| 6 | `technical-preferences.md` | qa-nfr-assess, qa-review-story, spec-research-dependencies | architect, pm, qa, ux-design-expert, lmas-master | -- | No |
...
- **WEAK (27 files):** Referenced only in passive registries (install-manifest, service-registry, workers.csv, documentation) but not actively consumed by any task execution path. These include:
  ...
  - IDE rules (deployed to target projects, not consumed by LMAS agents)
...
These files exist in `.lmas-core/product/templates/` and are listed in the install-manifest, but are not referenced by any task, agent, workflow, or script:
...
- **IDE rules (7):** Output artifacts for target projects. Consumed externally, not by LMAS tasks.
...
The `create-doc.md` task is the primary template consumer. It dynamically loads templates from `.lmas-core/product/templates/` based on user selection at runtime. The following templates are consumable through `create-doc`:

...
**Arquivo Fonte:** `.lmas-core/development/workflows/greenfield-fullstack.yaml`

---

## Visao Geral

O **Greenfield Full-Stack Workflow** e o fluxo de trabalho principal do LMAS para construcao de aplicacoes full-stack desde o conceito ate o desenvolvimento. Este workflow suporta tanto planejamento abrangente para projetos complexos quanto prototipagem rapida para projetos simples.
...
flowchart TD
    subgraph FASE0["FASE 0: Environment Bootstrap"]
        ...
        CHECK -->|Verificar| ENV_REPORT[".lmas/environment-report.json existe?"]
...
|------|--------|------|---------|-------|-------------|
| 1 | @devops (Operator) | `environment-bootstrap.md` | `project_name`, `project_path`, `github_org` | `.lmas/config.yaml`, `.lmas/environment-report.json`, `.gitignore`, `README.md`, `package.json` | Sim |

### Artefatos Criados

| Arquivo | Descricao |
|---------|-----------|
| `.lmas/config.yaml` | Configuracao do projeto LMAS |
| `.lmas/environment-report.json` | Relatorio completo do ambiente |
...
- Pular apenas se o projeto ja tiver `.lmas/environment-report.json`
...
| 2 | @pm (Trinity) | `prd-tmpl.yaml` | `project-brief.md` | `prd.md` | Sim |
...
| 5 | @architect (Architect) | `fullstack-architecture-tmpl.yaml` | `prd.md`, `front-end-spec.md` | `fullstack-architecture.md` | Sim |
| 6 | @pm (Trinity) | Atualizacao | `fullstack-architecture.md` | `prd.md` atualizado | Condicional |
| 7 | @po (Keymaker) | `po-master-checklist.md` | Todos os artefatos | Validacao | Sim |
...
| Step | Agente | Task | Entrada | Saida | Obrigatorio |
|------|--------|------|---------|-------|-------------|
| 1 | @po (Keymaker) | `shard-doc.md` | `docs/prd.md` | Pasta `docs/prd/` com arquivos fragmentados | Sim |
...
| Step | Agente | Task | Entrada | Saida | Obrigatorio |
|------|--------|------|---------|-------|-------------|
| 1 | @sm (Niobe) | `sm-create-next-story.md` | Docs fragmentados | `{epic}.{story}.story.md` | Sim |
| 2 | @analyst/@pm | Revisao | Story draft | Story aprovada | Opcional |
| 3 | @dev (Neo) | `dev-develop-story.md` | Story aprovada | Implementacao | Sim |
| 4 | @qa (Oracle) | `qa-review-story.md` | Implementacao | Feedback de QA | Opcional |
| 5 | @dev (Neo) | `dev-apply-qa-fixes.md` | Feedback de QA | Correcoes aplicadas | Condicional |
| 6 | @po (Keymaker) | Retrospectiva | Epic completo | Retrospectiva | Opcional |
...
|--------|----|----|-----------|-------------------|
| Operator | @devops | ⚡ | Operator | Bootstrap de ambiente, push Git, releases, CI/CD |
...
| Keymaker | @po | 🎯 | Balancer | Validacao de artefatos, backlog, fragmentacao |
| River | @sm | 🌊 | Facilitator | Criacao de stories, sprint planning |
| Neo | @dev | 💻 | Builder | Implementacao de codigo, testes |
| Oracle | @qa | ✅ | Guardian | Revisao de qualidade, testes, gates |
...
| Fase | Entrada | Saida |
|------|---------|-------|
| 0 | Nome do projeto, organizacao GitHub | Config LMAS, repo Git, estrutura de pastas |
...
|------|------------------|--------|----------|
| 0 | Ambiente pronto? | Pular / Executar bootstrap | Existencia de `.lmas/environment-report.json` |
...
flowchart TD
    D1{Ambiente pronto?}
    D1 -->|Verificar .lmas/environment-report.json| D1_CHECK
...
| Problema | Causa | Solucao |
|----------|-------|---------|
| Template nao encontrado | Caminho incorreto | Verificar `.lmas-core/development/templates/` |
...
```bash
# Verificar ambiente
cat .lmas/environment-report.json
...
|------|---------|-----------|
| Workflow | `.lmas-core/development/workflows/greenfield-fullstack.yaml` | Definicao do workflow |
| Task | `.lmas-core/development/tasks/environment-bootstrap.md` | Bootstrap do ambiente |
| Task | `.lmas-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| Task | `.lmas-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| Agente | `.lmas-core/development/agents/*.md` | Definicoes de agentes |
| Template | `.lmas-core/development/templates/*.yaml` | Templates de documentos |
| Checklist | `.lmas-core/development/checklists/*.md` | Checklists de validacao |
...
**Mantido por:** LMAS Development Team

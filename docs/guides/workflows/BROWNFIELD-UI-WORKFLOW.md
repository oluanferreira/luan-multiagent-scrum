...
| @po | po | Keymaker | Product Owner | Validacao, fragmentacao, retrospectiva |
| @sm | sm | River | Scrum Master | Criacao de stories |
| @analyst | analyst | Atlas | Business Analyst | Revisao de stories (opcional) |
| @dev | dev | Neo | Full Stack Developer | Implementacao |
| @qa | qa | Oracle | Test Architect | Revisao de qualidade (opcional) |

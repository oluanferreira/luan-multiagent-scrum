# LMAS Complete Cross-Reference Analysis

**Story:** LMAS-XREF-001
**Generated:** 2026-02-05
**Owners:** @analyst (Atlas) + @architect (Architect)
...
|-------------|-------|----------|
| Agents | 12 | `.lmas-core/development/agents/` |
| Tasks | 191 | `.lmas-core/development/tasks/` |
| Workflows | 12 | `.lmas-core/development/workflows/` |
| Product Templates | 92 | `.lmas-core/product/templates/` |
| Development Templates | 29 | `.lmas-core/development/templates/` |
| Product Checklists | 16 | `.lmas-core/product/checklists/` |
| Product Data | 16 | `.lmas-core/product/data/` |
| Framework Data | 8 | `.lmas-core/data/` |
| Dev Scripts | 37 | `.lmas-core/development/scripts/` |
| Infra Scripts | 90 | `.lmas-core/infrastructure/scripts/` |
| Infra Integrations | 5 | `.lmas-core/infrastructure/integrations/` |
| Infra Tools | 15 | `.lmas-core/infrastructure/tools/` |
| Infra Templates | 15 | `.lmas-core/infrastructure/templates/` |
| Core Modules | 130 | `.lmas-core/core/` |
| CLI Commands | 37 | `.lmas-core/cli/commands/` |
| Schemas | 6 | `.lmas-core/schemas/` |
| Manifests | 4 | `.lmas-core/manifests/` |
| Monitor Hooks | 10 | `.lmas-core/monitor/hooks/` |
| Quality Gates | 10 | `.lmas-core/core/quality-gates/` |
| Quality Metrics | 4 | `.lmas-core/quality/` |
| Workflow Intelligence | 19 | `.lmas-core/workflow-intelligence/` |
| Docs/Standards | 16 | `.lmas-core/docs/standards/` |
| Root Config | 8 | `.lmas-core/` root |
| Elicitation | 8 | `.lmas-core/core/elicitation/` + `.lmas-core/elicitation/` |
| **TOTAL** | **~745** | |
...
### 3.1 @dev (Neo) - Full Stack Developer
...
### 3.4 @pm (Trinity) - Product Manager
...
### 3.6 @architect (Architect) - Holistic System Architect
...
### 3.8 @devops (Operator) - DevOps Specialist
...
### 3.9 @data-engineer (Dozer) - Database Architect
...
### 3.11 @lmas-master (Morpheus) - Meta Orchestrator
...
DATA FILES (4):
  lmas-kb.md, agent-config-requirements.yaml,
...
| File | Location |
|------|----------|
| `LMAS-LIVRO-DE-OURO.md` | `docs/standards/` |
| `LMAS-LIVRO-DE-OURO-V2.1.md` | `docs/standards/` |
| `LMAS-LIVRO-DE-OURO-V2.1-SUMMARY.md` | `docs/standards/` |
| `LMAS-FRAMEWORK-MASTER.md` | `docs/standards/` |
...
|-----------|--------|---------------|
| `.lmas-core/agent-teams/` | Does not exist | install-manifest, source-tree docs, core-architecture |
| `.lmas-core/tools/` | Exists but empty | core-config.yaml, framework-config.yaml |
| `.lmas-core/processes/` | Does not exist | Not referenced |
...
- **infrastructure/** has ZERO dependencies on other LMAS modules
...
10. **Populate or remove `.lmas-core/tools/`** -- Currently empty despite config references.

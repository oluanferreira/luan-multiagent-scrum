...
**Localizacao:** `.lmas-core/development/tasks/qa-review-story.md`
...
**Localizacao:** `.lmas-core/development/tasks/qa-create-fix-request.md`
...
**Localizacao:** `.lmas-core/development/tasks/dev-apply-qa-fixes.md`
...
config:
  ...
  dashboardStatusPath: .lmas/dashboard/status.json
  legacyStatusPath: .lmas/status.json
...
No arquivo `.lmas-core/core-config.yaml`:
...
| Arquivo | Localizacao |
|---------|-------------|
| Workflow Definition | `.lmas-core/development/workflows/qa-loop.yaml` |
| QA Review Task | `.lmas-core/development/tasks/qa-review-story.md` |
| Create Fix Request Task | `.lmas-core/development/tasks/qa-create-fix-request.md` |
| Apply QA Fixes Task | `.lmas-core/development/tasks/dev-apply-qa-fixes.md` |
...
|----------|-------------|-----|
| `qa-gate-tmpl.yaml` | `.lmas-core/development/templates/` | Gate file structure |
| `story-tmpl.yaml` | `.lmas-core/development/templates/` | Story file structure |

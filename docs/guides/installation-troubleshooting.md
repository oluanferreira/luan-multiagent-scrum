# LMAS-Core Installation & Troubleshooting Guide
...
This command downloads and runs the latest version of LMAS-Core installer.
...
2. **Run diagnostics**: `npx lmas-core@latest doctor`
3. **Check system info**: `npx lmas-core@latest info`
...
| Command | Description |
|---------|-------------|
| `npx lmas-core@latest` | Install/run wizard |
| `npx lmas-core@latest --version` | Show version |
| `npx lmas-core@latest --help` | Show help |
| `npx lmas-core@latest install` | Install in current dir |
...
*Last updated: December 2025 | LMAS-Core v2.2.0*

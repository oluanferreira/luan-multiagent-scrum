...
> **Versao:** 1.0.0
> **Criado:** 2026-02-04
> **Owner:** @data-engineer (Dozer - The Sage)
...
O agente **@data-engineer (Dozer)** e o Database Architect & Operations Engineer do LMAS, responsavel pelo design de schemas, migracoes, seguranca (RLS), otimizacao de performance e operacoes de DBA. Este agente atua como um **Sage** que modela dominios de negocio, implementa migracoes seguras com snapshots e rollback, e garante integridade e seguranca dos dados.

### Caracteristicas Principais

| Caracteristica | Descricao |
|----------------|-----------|
| **Persona** | Dozer - The Sage |
...
| **Fechamento** | "-- Dozer, arquitetando dados" |
...
|---------|---------|-----------|
| `.lmas-core/development/tasks/db-domain-modeling.md` | `*model-domain` | Sessao interativa de modelagem de dominio |
| `.lmas-core/development/tasks/setup-database.md` | `*setup-database [type]` | Setup de projeto de database (Supabase, PostgreSQL, MongoDB, MySQL, SQLite) |
| `.lmas-core/development/tasks/db-bootstrap.md` | `*bootstrap` | Cria estrutura padrao de projeto Supabase |
| `.lmas-core/development/tasks/db-env-check.md` | `*env-check` | Valida variaveis de ambiente do database |
| `.lmas-core/development/tasks/db-apply-migration.md` | `*apply-migration {path}` | Aplica migracao com snapshot e lock advisory |
| `.lmas-core/development/tasks/db-dry-run.md` | `*dry-run {path}` | Testa migracao sem commit |
| `.lmas-core/development/tasks/db-seed.md` | `*seed {path}` | Aplica seed data (idempotent) |
| `.lmas-core/development/tasks/db-snapshot.md` | `*snapshot {label}` | Cria snapshot do schema |
| `.lmas-core/development/tasks/db-rollback.md` | `*rollback {snapshot_or_file}` | Restaura snapshot ou executa rollback |
| `.lmas-core/development/tasks/db-smoke-test.md` | `*smoke-test {version}` | Testes abrangentes de database |
| `.lmas-core/development/tasks/security-audit.md` | `*security-audit {scope}` | Auditoria de seguranca (rls, schema, full) |
| `.lmas-core/development/tasks/analyze-performance.md` | `*analyze-performance {type}` | Analise de performance (query, hotpaths, interactive) |
| `.lmas-core/development/tasks/db-policy-apply.md` | `*policy-apply {table} {mode}` | Instala politica RLS (KISS ou granular) |
| `.lmas-core/development/tasks/test-as-user.md` | `*test-as-user {user_id}` | Emula usuario para testar RLS |
| `.lmas-core/development/tasks/db-verify-order.md` | `*verify-order {path}` | Valida ordenacao DDL para dependencias |
| `.lmas-core/development/tasks/db-load-csv.md` | `*load-csv {table} {file}` | Carregador seguro de CSV (staging->merge) |
| `.lmas-core/development/tasks/db-run-sql.md` | `*run-sql {file_or_inline}` | Executa SQL raw com transacao |
| `.lmas-core/development/tasks/create-deep-research-prompt.md` | `*research {topic}` | Gera prompt de pesquisa profunda |
| `.lmas-core/development/tasks/execute-checklist.md` | `*execute-checklist {checklist}` | Executa checklist DBA |
| `.lmas-core/development/tasks/create-doc.md` | `*doc-out` | Output de documento completo |
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/data-engineer.md` | Definicao core do agente @data-engineer (persona, comandos, workflows) |
| `.claude/commands/LMAS/agents/data-engineer.md` | Comando Claude Code para ativar @data-engineer |
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/workflows/brownfield-discovery.yaml` | Workflow de discovery brownfield (Fase 2 e 5) |
...
- [db-domain-modeling.md](.lmas-core/development/tasks/db-domain-modeling.md)
- [setup-database.md](.lmas-core/development/tasks/setup-database.md)
- [db-apply-migration.md](.lmas-core/development/tasks/db-apply-migration.md)
- [security-audit.md](.lmas-core/development/tasks/security-audit.md)
- [analyze-performance.md](.lmas-core/development/tasks/analyze-performance.md)
- [db-snapshot.md](.lmas-core/development/tasks/db-snapshot.md)
- [db-rollback.md](.lmas-core/development/tasks/db-rollback.md)
- [db-bootstrap.md](.lmas-core/development/tasks/db-bootstrap.md)

### Agente

- [data-engineer.md](.lmas-core/development/agents/data-engineer.md)

### Workflows

- [brownfield-discovery.yaml](.lmas-core/development/workflows/brownfield-discovery.yaml)

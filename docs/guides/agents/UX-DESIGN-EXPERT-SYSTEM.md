...
Este documento descreve o sistema completo do agente **UX-Design Expert (Uma)**, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis, integracoes com outros agentes e workflows LMAS.
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/ux-design-expert.md` | Definicao completa do agente (persona, comandos, workflows) |
| `.claude/commands/LMAS/agents/ux-design-expert.md` | Comando Claude Code para ativar @ux-design-expert |
...
|---------|---------|-----------|
| `.lmas-core/development/tasks/ux-user-research.md` | `*research` | Conduzir pesquisa de usuario, criar personas e jornadas |
| `.lmas-core/development/tasks/ux-create-wireframe.md` | `*wireframe` | Criar wireframes low/mid/high fidelity |
| `.lmas-core/development/tasks/generate-ai-frontend-prompt.md` | `*generate-ui-prompt` | Gerar prompts para v0.dev, Lovable.ai |
| `.lmas-core/development/tasks/create-doc.md` | `*create-front-end-spec` | Criar especificacao frontend detalhada |

#### Fase 2: Design System Audit (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/audit-codebase.md` | `*audit {path}` | Escanear codebase para redundancias UI |
| `.lmas-core/development/tasks/consolidate-patterns.md` | `*consolidate` | Reduzir redundancia com clustering HSL |
| `.lmas-core/development/tasks/generate-shock-report.md` | `*shock-report` | Gerar relatorio visual HTML |

#### Fase 3: Design Tokens & Setup (7 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/extract-tokens.md` | `*tokenize` | Extrair design tokens (YAML, JSON, CSS, DTCG) |
| `.lmas-core/development/tasks/setup-design-system.md` | `*setup` | Inicializar estrutura do design system |
| `.lmas-core/development/tasks/generate-migration-strategy.md` | `*migrate` | Gerar estrategia de migracao em 4 fases |
| `.lmas-core/development/tasks/tailwind-upgrade.md` | `*upgrade-tailwind` | Upgrade para Tailwind CSS v4 |
| `.lmas-core/development/tasks/audit-tailwind-config.md` | `*audit-tailwind-config` | Validar configuracao Tailwind |
| `.lmas-core/development/tasks/export-design-tokens-dtcg.md` | `*export-dtcg` | Exportar tokens W3C DTCG |
| `.lmas-core/development/tasks/bootstrap-shadcn-library.md` | `*bootstrap-shadcn` | Instalar Shadcn/Radix UI |

#### Fase 4: Atomic Component Building (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/build-component.md` | `*build {component}` | Construir componente atomico (React + TypeScript) |
| `.lmas-core/development/tasks/compose-molecule.md` | `*compose {molecule}` | Compor molecule de atoms existentes |
| `.lmas-core/development/tasks/extend-pattern.md` | `*extend {component}` | Adicionar variante a componente existente |

#### Fase 5: Quality & Documentation (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/generate-documentation.md` | `*document` | Gerar documentacao do pattern library |
| `.lmas-core/development/tasks/calculate-roi.md` | `*calculate-roi` | Calcular ROI e cost savings |
| `.lmas-core/development/checklists/accessibility-wcag-checklist.md` | `*a11y-check` | Auditoria de acessibilidade WCAG |

#### Tasks Universais (2 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/ux-ds-scan-artifact.md` | `*scan {path\|url}` | Analisar HTML/React para extrair padroes |
| `.lmas-core/development/tasks/integrate-Squad.md` | `*integrate {squad}` | Conectar com expansion squad |

### Templates

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/templates/front-end-spec-tmpl.yaml` | Template de especificacao frontend |
| `.lmas-core/development/templates/tokens-schema-tmpl.yaml` | Schema de design tokens |
| `.lmas-core/development/templates/component-react-tmpl.tsx` | Template de componente React |
| `.lmas-core/development/templates/state-persistence-tmpl.yaml` | Template de persistencia de estado |
| `.lmas-core/development/templates/shock-report-tmpl.html` | Template de shock report HTML |
| `.lmas-core/development/templates/migration-strategy-tmpl.md` | Template de estrategia de migracao |
| `.lmas-core/development/templates/token-exports-css-tmpl.css` | Template de export CSS |
| `.lmas-core/development/templates/token-exports-tailwind-tmpl.js` | Template de export Tailwind |
| `.lmas-core/development/templates/ds-artifact-analysis.md` | Template de analise de artefato |

### Checklists

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/checklists/pattern-audit-checklist.md` | Checklist de auditoria de padroes |
| `.lmas-core/development/checklists/component-quality-checklist.md` | Checklist de qualidade de componente |
| `.lmas-core/development/checklists/accessibility-wcag-checklist.md` | Checklist WCAG AA/AAA |
| `.lmas-core/development/checklists/migration-readiness-checklist.md` | Checklist de readiness para migracao |

### Data Files

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/data/technical-preferences.md` | Preferencias tecnicas padrao |
| `.lmas-core/development/data/atomic-design-principles.md` | Principios Atomic Design |
| `.lmas-core/development/data/design-token-best-practices.md` | Best practices de design tokens |
| `.lmas-core/development/data/consolidation-algorithms.md` | Algoritmos de consolidacao |
| `.lmas-core/development/data/roi-calculation-guide.md` | Guia de calculo de ROI |
| `.lmas-core/development/data/integration-patterns.md` | Padroes de integracao |
| `.lmas-core/development/data/wcag-compliance-guide.md` | Guia de conformidade WCAG |

### Workflows Relacionados

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/workflows/design-system-build-quality.yaml` | Pipeline pos-migracao (build, docs, a11y, ROI) |
| `.lmas-core/development/workflows/brownfield-ui.yaml` | Workflow para UI brownfield |
| `.lmas-core/development/workflows/brownfield-discovery.yaml` | Discovery para projetos existentes |
| `.lmas-core/development/workflows/greenfield-ui.yaml` | Workflow para UI greenfield |
...
- [ux-user-research.md](../../.lmas-core/development/tasks/ux-user-research.md)
- [ux-create-wireframe.md](../../.lmas-core/development/tasks/ux-create-wireframe.md)
- [audit-codebase.md](../../.lmas-core/development/tasks/audit-codebase.md)
- [consolidate-patterns.md](../../.lmas-core/development/tasks/consolidate-patterns.md)
- [extract-tokens.md](../../.lmas-core/development/tasks/extract-tokens.md)
- [build-component.md](../../.lmas-core/development/tasks/build-component.md)
- [calculate-roi.md](../../.lmas-core/development/tasks/calculate-roi.md)

### Arquivos de Workflow

- [design-system-build-quality.yaml](../../.lmas-core/development/workflows/design-system-build-quality.yaml)
- [brownfield-ui.yaml](../../.lmas-core/development/workflows/brownfield-ui.yaml)

### Definicao do Agente

- [ux-design-expert.md](../../.lmas-core/development/agents/ux-design-expert.md)

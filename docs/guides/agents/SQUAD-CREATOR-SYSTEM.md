...
O **Squad Creator** (Craft) e o agente especializado do LMAS para criacao, validacao, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/squad-creator.md` | Definicao core do agente Squad Creator |
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/schemas/squad-schema.json` | Schema de validacao do squad.yaml |
| `.lmas-core/schemas/squad-design-schema.json` | Schema de validacao de blueprints |

...
O **@lmas-master** (Morpheus - The Orchestrator) e o meta-agente principal do framework LMAS-FULLSTACK. Ele atua como orquestrador universal, desenvolvedor de framework e especialista no metodo LMAS. Suas principais responsabilidades incluem:
...
- **Knowledge Base**: Acesso ao conhecimento completo do LMAS Method
...
- Acessar o Knowledge Base do LMAS (*kb)

---

## Lista Completa de Arquivos

### Arquivos Core de Tasks do @lmas-master

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/create-agent.md` | `*create agent` | Cria nova definicao de agente usando sistema de templates |
| `.lmas-core/development/tasks/create-task.md` | `*create task` | Cria novo arquivo de task com estrutura padronizada |
| `.lmas-core/development/tasks/create-workflow.md` | `*create workflow` | Cria nova definicao de workflow multi-agente |
| `.lmas-core/development/tasks/modify-agent.md` | `*modify agent` | Modifica agente existente com backup e rollback |
| `.lmas-core/development/tasks/modify-task.md` | `*modify task` | Modifica task existente preservando compatibilidade |
| `.lmas-core/development/tasks/modify-workflow.md` | `*modify workflow` | Modifica workflow existente mantendo integridade |
| `.lmas-core/development/tasks/analyze-framework.md` | `*analyze-framework` | Analisa estrutura do framework, redundancias e performance |
| `.lmas-core/development/tasks/deprecate-component.md` | `*deprecate-component` | Deprecia componente com timeline e migracao |
| `.lmas-core/development/tasks/propose-modification.md` | `*propose-modification` | Cria proposta de modificacao para revisao colaborativa |
| `.lmas-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validacao |
| `.lmas-core/development/tasks/create-doc.md` | `*create-doc` | Cria documento a partir de template YAML |
| `.lmas-core/development/tasks/advanced-elicitation.md` | `*advanced-elicitation` | Executa elicitacao avancada com multiplos metodos |
| `.lmas-core/development/tasks/kb-mode-interaction.md` | `*kb` | Habilita modo Knowledge Base interativo |
| `.lmas-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo/qualidade |
| `.lmas-core/development/tasks/update-manifest.md` | `*update-manifest` | Atualiza manifesto de equipe com novos agentes |
| `.lmas-core/development/tasks/create-next-story.md` | `*create-next-story` | Cria proxima user story |
| `.lmas-core/development/tasks/create-deep-research-prompt.md` | - | Gera prompts de pesquisa profunda |
| `.lmas-core/development/tasks/improve-self.md` | - | Auto-melhoria do agente |
| `.lmas-core/development/tasks/shard-doc.md` | `*shard-doc` | Quebra documento em partes menores |
| `.lmas-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao do projeto |
| `.lmas-core/development/tasks/index-docs.md` | `*index-docs` | Indexa documentacao para busca |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/lmas-master.md` | Definicao completa do agente (persona, comandos, dependencias) |
| `.claude/commands/LMAS/agents/lmas-master.md` | Comando Claude Code para ativar @lmas-master |

### Arquivos de Templates do @lmas-master

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/templates/agent-template.yaml` | Template para criacao de novos agentes |
| `.lmas-core/development/templates/task-template.md` | Template para criacao de novas tasks |
| `.lmas-core/development/templates/workflow-template.yaml` | Template para criacao de novos workflows |
| `.lmas-core/development/templates/prd-tmpl.yaml` | Template para PRD |
| `.lmas-core/development/templates/story-tmpl.yaml` | Template para stories |
| `.lmas-core/development/templates/architecture-tmpl.yaml` | Template para arquitetura |
| `.lmas-core/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| `.lmas-core/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| `.lmas-core/development/templates/competitor-analysis-tmpl.yaml` | Template analise de concorrentes |
| `.lmas-core/development/templates/market-research-tmpl.yaml` | Template pesquisa de mercado |
| `.lmas-core/development/templates/project-brief-tmpl.yaml` | Template brief de projeto |
| `.lmas-core/development/templates/front-end-architecture-tmpl.yaml` | Template arquitetura frontend |
| `.lmas-core/development/templates/front-end-spec-tmpl.yaml` | Template spec frontend |
| `.lmas-core/development/templates/fullstack-architecture-tmpl.yaml` | Template arquitetura fullstack |

### Arquivos de Dados e Utilidades

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/data/lmas-kb.md` | Knowledge Base do LMAS Method |
| `.lmas-core/development/data/brainstorming-techniques.md` | Tecnicas de brainstorming |
| `.lmas-core/development/data/elicitation-methods.md` | Metodos de elicitacao |
| `.lmas-core/development/data/technical-preferences.md` | Preferencias tecnicas |
| `.lmas-core/development/utils/security-checker.js` | Validador de seguranca |
| `.lmas-core/development/utils/yaml-validator.js` | Validador de YAML |
| `.lmas-core/development/utils/workflow-management.md` | Gestao de workflows |

### Arquivos de Workflows do @lmas-master

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/workflows/brownfield-fullstack.md` | Workflow fullstack brownfield |
| `.lmas-core/development/workflows/brownfield-service.md` | Workflow servico brownfield |
| `.lmas-core/development/workflows/brownfield-ui.md` | Workflow UI brownfield |
| `.lmas-core/development/workflows/greenfield-fullstack.md` | Workflow fullstack greenfield |
| `.lmas-core/development/workflows/greenfield-service.md` | Workflow servico greenfield |
| `.lmas-core/development/workflows/greenfield-ui.md` | Workflow UI greenfield |

### Arquivos de Checklists do @lmas-master

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/checklists/architect-checklist.md` | Checklist de arquitetura |
| `.lmas-core/development/checklists/change-checklist.md` | Checklist de mudancas |
| `.lmas-core/development/checklists/pm-checklist.md` | Checklist de PM |
| `.lmas-core/development/checklists/po-master-checklist.md` | Checklist de PO |
| `.lmas-core/development/checklists/story-dod-checklist.md` | Checklist DoD de stories |
| `.lmas-core/development/checklists/story-draft-checklist.md` | Checklist draft de stories |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Proposito |
|---------|--------|-----------|
| `.lmas-core/development/tasks/brownfield-create-epic.md` | @pm | Criacao de epics (delegada) |
| `.lmas-core/development/tasks/brownfield-create-story.md` | @pm | Criacao de stories (delegada) |
| `.lmas-core/development/tasks/analyst-facilitate-brainstorming.md` | @analyst | Brainstorming (delegado) |
| `.lmas-core/development/tasks/generate-ai-frontend-prompt.md` | @architect | Geracao de prompts AI (delegada) |
| `.lmas-core/development/tasks/create-suite.md` | @qa | Criacao de suites de teste (delegada) |
...
flowchart TB
    ...
    subgraph OUTPUTS["📁 OUTPUTS"]
        AGENTS_DIR[".lmas-core/agents/"]
        TASKS_DIR[".lmas-core/tasks/"]
        WORKFLOWS_DIR[".lmas-core/workflows/"]
        DOCS_DIR["docs/"]
    end
...
```mermaid
flowchart LR
    subgraph MASTER["👑 @lmas-master (Morpheus)"]
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/core-config.yaml` | Configuracao central do framework |
| `.lmas-core/install-manifest.yaml` | Manifesto de instalacao |
| `.lmas-core/config/agent-config-requirements.yaml` | Requisitos de configuracao de agentes |
| `.lmas/project-registry.yaml` | Registry central de projetos |
...
**Solucao:**
1. Liste templates disponiveis: verifique `.lmas-core/development/templates/`
...
**Solucao:**
1. Verifique existencia de `.lmas-core/development/data/lmas-kb.md`
...
- [Agente lmas-master](.lmas-core/development/agents/lmas-master.md)
- [Knowledge Base](.lmas-core/development/data/lmas-kb.md)
- [Guia do Usuario](.lmas-core/user-guide.md)

### Standards e Documentacao

- [LMAS Framework Master](.lmas-core/docs/standards/LMAS-FRAMEWORK-MASTER.md)
- [LMAS Livro de Ouro](.lmas-core/docs/standards/LMAS-LIVRO-DE-OURO.md)
- [Agent Personalization Standard](.lmas-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md)

### Diretorio de Tasks

- [Tasks Directory](.lmas-core/development/tasks/)
- [Templates Directory](.lmas-core/development/templates/)
- [Workflows Directory](.lmas-core/development/workflows/)
...
| Aspecto | Detalhes |
|---------|----------|
| **Nome do Agente** | Morpheus (lmas-master) |
...
|------|-------|-----------|
| 2026-02-04 | @lmas-master | Documento inicial criado com mapeamento completo |

---

*-- Morpheus, orquestrando o sistema*

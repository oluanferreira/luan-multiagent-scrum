...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/analyst.md` | Definicao core do agente Analyst |
| `.claude/commands/LMAS/agents/analyst.md` | Comando Claude Code para ativar @analyst |

### Tasks do Analyst

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | Task principal - facilita sessoes de brainstorming estruturadas |
| `.lmas-core/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | Variante interativa da task de brainstorming |
| `.lmas-core/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | Gera prompts de pesquisa profunda para investigacao |
| `.lmas-core/development/tasks/advanced-elicitation.md` | `*elicit` | Sessao avancada de elicitacao de requisitos |
| `.lmas-core/development/tasks/create-doc.md` | `*doc-out` | Criacao de documentos a partir de templates YAML |
| `.lmas-core/development/tasks/document-project.md` | `*create-project-brief` | Documentacao de projetos existentes |
| `.lmas-core/development/tasks/calculate-roi.md` | (relacionada) | Calculo de ROI e economia de custos |

### Tasks Relacionadas de Analise

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/tasks/analyze-brownfield.md` | Analise de projetos brownfield |
| `.lmas-core/development/tasks/analyze-framework.md` | Analise de frameworks existentes |
| `.lmas-core/development/tasks/analyze-performance.md` | Analise de performance |
| `.lmas-core/development/tasks/analyze-project-structure.md` | Analise de estrutura de projeto |
| `.lmas-core/development/tasks/analyze-cross-artifact.md` | Analise cross-artifact |

### Templates do Analyst

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/product/templates/project-brief-tmpl.yaml` | Template para Project Brief |
| `.lmas-core/product/templates/market-research-tmpl.yaml` | Template para Pesquisa de Mercado |
| `.lmas-core/product/templates/competitor-analysis-tmpl.yaml` | Template para Analise Competitiva |
| `.lmas-core/product/templates/brainstorming-output-tmpl.yaml` | Template para output de sessoes de brainstorming |

### Arquivos de Dados

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/data/lmas-kb.md` | Knowledge base do LMAS |
| `.lmas-core/development/data/brainstorming-techniques.md` | Tecnicas de brainstorming disponiveis |

### Workflows que Usam o Analyst

| Arquivo | Fase | Proposito |
|---------|------|-----------|
| `.lmas-core/development/workflows/greenfield-fullstack.yaml` | Fase 1 | Discovery & Planning - cria project-brief.md |
| `.lmas-core/development/workflows/brownfield-discovery.yaml` | Fase 9 | Relatorio Executivo de Awareness |
...
flowchart TB
    ...
    subgraph PLANNING["Fase de Planning"]
        direction TB
        PM_WORK["@pm (Trinity)<br/>Estrategia de Produto"]
        PRD["prd.md"]
    ...
    subgraph VALIDATION["Fase de Validacao"]
        direction TB
        PO_WORK["@po (Keymaker)<br/>Validacao de Artefatos"]
...
|--------|---------------------|
| **@pm (Trinity)** | Analyst fornece pesquisa e analise para criacao de PRD |
| **@po (Keymaker)** | Analyst fornece insights de mercado e analise competitiva |
...
- [Task: facilitate-brainstorming-session.md](.lmas-core/development/tasks/facilitate-brainstorming-session.md)
- [Task: create-deep-research-prompt.md](.lmas-core/development/tasks/create-deep-research-prompt.md)
- [Task: advanced-elicitation.md](.lmas-core/development/tasks/advanced-elicitation.md)
- [Task: create-doc.md](.lmas-core/development/tasks/create-doc.md)
- [Task: document-project.md](.lmas-core/development/tasks/document-project.md)

### Templates

- [Template: project-brief-tmpl.yaml](.lmas-core/product/templates/project-brief-tmpl.yaml)
- [Template: market-research-tmpl.yaml](.lmas-core/product/templates/market-research-tmpl.yaml)
- [Template: competitor-analysis-tmpl.yaml](.lmas-core/product/templates/competitor-analysis-tmpl.yaml)
- [Template: brainstorming-output-tmpl.yaml](.lmas-core/product/templates/brainstorming-output-tmpl.yaml)

### Workflows

- [Workflow: greenfield-fullstack.yaml](.lmas-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-discovery.yaml](.lmas-core/development/workflows/brownfield-discovery.yaml)

### Agente

- [Agent: analyst.md](.lmas-core/development/agents/analyst.md)

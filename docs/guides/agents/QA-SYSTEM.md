...
O agente **@qa (Oracle)** e o Test Architect & Quality Advisor do LMAS. Seu papel e fornecer analise abrangente de qualidade, decisoes de quality gates e recomendacoes acionaveis para equipes de desenvolvimento.
...
|---------|---------|-----------|
| `.lmas-core/development/tasks/qa-gate.md` | `*gate {story}` | Criar arquivo de decisao de quality gate |
| `.lmas-core/development/tasks/qa-review-story.md` | `*review {story}` | Revisao completa de story com decisao de gate |
| `.lmas-core/development/tasks/qa-test-design.md` | `*test-design {story}` | Criar cenarios de teste abrangentes |
| `.lmas-core/development/tasks/qa-risk-profile.md` | `*risk-profile {story}` | Gerar matriz de avaliacao de risco |
| `.lmas-core/development/tasks/qa-nfr-assess.md` | `*nfr-assess {story}` | Validar requisitos nao-funcionais |
| `.lmas-core/development/tasks/qa-trace-requirements.md` | `*trace {story}` | Mapear requisitos para testes (Given-When-Then) |
| `.lmas-core/development/tasks/qa-generate-tests.md` | `*generate-tests` | Gerar suites de teste automaticamente |
| `.lmas-core/development/tasks/qa-run-tests.md` | `*run-tests` | Executar suite de testes com gate de qualidade |
| `.lmas-core/development/tasks/qa-backlog-add-followup.md` | `*backlog-add` | Adicionar follow-ups ao backlog |
| `.lmas-core/development/tasks/qa-create-fix-request.md` | `*create-fix-request {story}` | Gerar documento de fix request para @dev |

### Arquivos de Tasks Secundarias do @qa

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/tasks/qa-browser-console-check.md` | Verificar erros no console do browser |
| `.lmas-core/development/tasks/qa-evidence-requirements.md` | Requisitos de evidencia para QA |
| `.lmas-core/development/tasks/qa-false-positive-detection.md` | Deteccao de falsos positivos |
| `.lmas-core/development/tasks/qa-fix-issues.md` | Task para @dev aplicar fixes de QA |
| `.lmas-core/development/tasks/qa-library-validation.md` | Validacao de bibliotecas |
| `.lmas-core/development/tasks/qa-migration-validation.md` | Validacao de migracoes |
| `.lmas-core/development/tasks/qa-review-build.md` | Revisao de builds |
| `.lmas-core/development/tasks/qa-security-checklist.md` | Checklist de seguranca |
| `.lmas-core/development/tasks/qa-review-proposal.md` | Revisao de propostas |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/qa.md` | Definicao completa do agente QA |
| `.claude/commands/LMAS/agents/qa.md` | Comando Claude Code para ativar @qa |

### Arquivos de Workflow

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/workflows/qa-loop.yaml` | Orquestrador do loop QA (Review -> Fix -> Re-review) |

### Arquivos de Time

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agent-teams/team-qa-focused.yaml` | Configuracao do time focado em QA (@dev, @qa, @github-devops) |
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/core-config.yaml` | Configuracao central (qa.qaLocation, etc.) |
| `.lmas-core/development/data/technical-preferences.md` | Preferencias tecnicas para QA |
...
wsl bash -c 'cd /mnt/c/.../lmas-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'

# Story review (committed changes vs main)
wsl bash -c 'cd /mnt/c/.../lmas-core && ~/.local/bin/coderabbit --prompt-only -t committed --base main'
```
...
flowchart TB
    subgraph AGENTS["Integracoes do @qa"]
        ...
        subgraph QA_BOX["@qa (Oracle) - Test Architect"]
...
- [qa-gate.md](/.lmas-core/development/tasks/qa-gate.md)
- [qa-review-story.md](/.lmas-core/development/tasks/qa-review-story.md)
- [qa-test-design.md](/.lmas-core/development/tasks/qa-test-design.md)
- [qa-risk-profile.md](/.lmas-core/development/tasks/qa-risk-profile.md)
- [qa-nfr-assess.md](/.lmas-core/development/tasks/qa-nfr-assess.md)
- [qa-trace-requirements.md](/.lmas-core/development/tasks/qa-trace-requirements.md)

### Workflows

- [qa-loop.yaml](/.lmas-core/development/workflows/qa-loop.yaml)

### Teams

- [team-qa-focused.yaml](/.lmas-core/development/agent-teams/team-qa-focused.yaml)

### Agente

- [qa.md](/.lmas-core/development/agents/qa.md)

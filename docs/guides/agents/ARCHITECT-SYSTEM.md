...
| `.lmas-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validacao |
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/architect.md` | Definicao core do agente Architect |

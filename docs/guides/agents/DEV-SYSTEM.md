...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/dev.md` | Definicao core do agente @dev (persona, comandos, workflows) |
...
| `.lmas-core/development/scripts/greeting-builder.js` | Constroi greeting adaptativo |

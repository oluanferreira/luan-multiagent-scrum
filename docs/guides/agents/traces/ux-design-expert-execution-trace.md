...
> Agent definition: `.lmas-core/development/agents/ux-design-expert.md`
...
|-------|------|--------|---------|
| 1 | `.lmas-core/development/agents/ux-design-expert.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.lmas-core/core-config.yaml` | generate-greeting.js (fs.readFile + yaml.load) | Core configuration |
| 3 | `.lmas-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, uxLocation |
| 4 | `.lmas-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.lmas/session-state.json` | SessionContextLoader.loadContext() | Session type detection (sessionType, previousAgent, lastCommands) |
| 6 | `.lmas/project-status.yaml` | loadProjectStatus() | Cached project status (60s TTL) |
...
**Task file:** `.lmas-core/development/tasks/ux-user-research.md`
...
**Task file:** `.lmas-core/development/tasks/ux-create-wireframe.md`
...
**Task file:** `.lmas-core/development/tasks/generate-ai-frontend-prompt.md`
...
**Template:** `.lmas-core/product/templates/front-end-spec-tmpl.yaml`
...
**Task file:** `.lmas-core/development/tasks/audit-codebase.md`
...
**Task file:** `.lmas-core/development/tasks/consolidate-patterns.md`
...
**Task file:** `.lmas-core/development/tasks/generate-shock-report.md`
**Template:** `.lmas-core/product/templates/shock-report-tmpl.html`
...
**Task file:** `.lmas-core/development/tasks/extract-tokens.md`
**Template:** `.lmas-core/product/templates/tokens-schema-tmpl.yaml`
...
**Task file:** `.lmas-core/development/tasks/setup-design-system.md`
...
**Task file:** `.lmas-core/development/tasks/generate-migration-strategy.md`
**Template:** `.lmas-core/product/templates/migration-strategy-tmpl.md`
...
**Task file:** `.lmas-core/development/tasks/tailwind-upgrade.md`
...
**Task file:** `.lmas-core/development/tasks/audit-tailwind-config.md`
...
**Task file:** `.lmas-core/development/tasks/export-design-tokens-dtcg.md`
**Templates:** `.lmas-core/product/templates/token-exports-css-tmpl.css`, `.lmas-core/product/templates/token-exports-tailwind-tmpl.js`
...
**Task file:** `.lmas-core/development/tasks/bootstrap-shadcn-library.md`
...
**Task file:** `.lmas-core/development/tasks/build-component.md`
**Template:** `.lmas-core/product/templates/component-react-tmpl.tsx`
...
**Task file:** `.lmas-core/development/tasks/compose-molecule.md`
...
**Task file:** `.lmas-core/development/tasks/extend-pattern.md`
...
**Task file:** `.lmas-core/development/tasks/generate-documentation.md`
...
**Checklist file:** `.lmas-core/product/checklists/accessibility-wcag-checklist.md`
...
**Task file:** `.lmas-core/development/tasks/calculate-roi.md`
...
**Task file:** `.lmas-core/development/tasks/ux-ds-scan-artifact.md`
**Template:** `.lmas-core/product/templates/ds-artifact-analysis.md`
...
**Task file:** `.lmas-core/development/tasks/integrate-Squad.md` (MISSING)
...
**Receives from @architect (Architect):**
...
**Collaborates with @analyst (Link):**
...
The agent definition references dependencies using short names (e.g., `lmas-core/tasks/...`). The actual resolution paths are:

| Dependency Type | Agent Definition Path | Actual Disk Location |
|-----------------|----------------------|---------------------|
| Tasks | `lmas-core/tasks/{name}` | `.lmas-core/development/tasks/{name}` |
| Templates | `lmas-core/templates/{name}` | `.lmas-core/product/templates/{name}` |
| Checklists | `lmas-core/checklists/{name}` | `.lmas-core/product/checklists/{name}` |
| Data | `lmas-core/data/{name}` | `.lmas-core/data/{name}` or `.lmas-core/product/data/{name}` |

All 9 templates, all 4 checklists, and all 7 data files resolve correctly to files in `product/` directories. The `development/data/` directory does not exist; data files live under `.lmas-core/data/` and `.lmas-core/product/data/`.
...
**Template for state persistence:** `.lmas-core/product/templates/state-persistence-tmpl.yaml` (EXISTS)

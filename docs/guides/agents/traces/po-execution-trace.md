# @po (Keymaker) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.lmas-core/development/agents/po.md`
...
|-------|------|--------|---------|
| 1 | `.lmas-core/development/agents/po.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.lmas-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.lmas-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, prd, storyBacklog, templatesLocation |
| 4 | `.lmas-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.lmas-core/product/data/elicitation-methods.md` | AgentConfigLoader.loadFile() | Elicitation methods (always loaded, 5KB) |
...
sequenceDiagram
    ...
    ACL-->>CC: { agent: { name: 'Keymaker', icon: '🎯' }, commands: [...18], ... }
...
po:
  config_sections:
    ...
    - templatesLocation
  files_loaded:
    - path: .lmas-core/product/data/elicitation-methods.md
      lazy: false
      size: 5KB
  lazy_loading:
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `🎯 Keymaker the Balancer ready to balance!` |
| Signature | `persona_profile.communication.signature_closing` | `— Keymaker, equilibrando prioridades 🎯` |
...
**Task file:** `.lmas-core/development/tasks/po-backlog-add.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `po-backlog-add.md` | Task | EXISTS |
| `.lmas-core/product/data/elicitation-methods.md` | Data | EXISTS (pre-loaded) |
...
**Task file:** `.lmas-core/development/tasks/po-manage-story-backlog.md`
...
**Task file:** `.lmas-core/development/tasks/po-stories-index.md`
...
**Task file:** `.lmas-core/development/tasks/validate-next-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-next-story.md` | Task | EXISTS |
| `.lmas-core/product/templates/story-tmpl.yaml` | Template | EXISTS |
| `.lmas-core/product/checklists/po-master-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.lmas-core/development/tasks/po-sync-story.md`
...
flowchart TD
    ...
    E -->|None configured| J[Prompt: run lmas init]
...
**Task file:** `.lmas-core/development/tasks/po-pull-story.md`
...
| @po -> @lmas-master | Escalate | Course corrections via `*correct-course` |

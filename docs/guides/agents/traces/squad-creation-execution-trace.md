...
> Agent definition: `.lmas-core/development/agents/squad-creator.md`
...
|-------|------|--------|---------|
| 1 | `.lmas-core/development/agents/squad-creator.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.lmas-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.lmas-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation (no squad-creator entry found) |
...
**Task file:** `.lmas-core/development/tasks/squad-creator-design.md`
...
**Task file:** `.lmas-core/development/tasks/squad-creator-create.md`
...
| `.lmas-core/development/templates/squad-template/` | Template scaffold | EXISTS |
...
**Task file:** `.lmas-core/development/tasks/squad-creator-validate.md`
...
**Task file:** `.lmas-core/development/tasks/squad-creator-list.md`
...
**Task file:** `.lmas-core/development/tasks/squad-creator-migrate.md`
...
flowchart TD
    ...
    C --> D["Detect: config.yaml, flat structure,<br/>missing lmas.type, missing lmas.minVersion"]
    D --> E{Needs migration?}
...
**Migration detections:** config.yaml (rename to squad.yaml), flat structure (create dirs), missing fields (lmas.type, lmas.minVersion, name, version)

---

### `*analyze-squad`

**Task file:** `.lmas-core/development/tasks/squad-creator-analyze.md`
...
**Task file:** `.lmas-core/development/tasks/squad-creator-extend.md`
...
| `squad-validator.js` | Script | EXISTS |
| `.lmas-core/development/templates/squad/agent-template.md` | Template | EXISTS |
| `.lmas-core/development/templates/squad/task-template.md` | Template | EXISTS |
| `.lmas-core/development/templates/squad/workflow-template.yaml` | Template | EXISTS |
| `.lmas-core/development/templates/squad/checklist-template.md` | Template | EXISTS |
| `.lmas-core/development/templates/squad/template-template.md` | Template | EXISTS |
| `.lmas-core/development/templates/squad/tool-template.js` | Template | EXISTS |
| `.lmas-core/development/templates/squad/script-template.js` | Template | EXISTS |
| `.lmas-core/development/templates/squad/data-template.yaml` | Template | EXISTS |
...
**Task file:** `.lmas-core/development/tasks/squad-creator-download.md`
...
flowchart TD
    ...
    B --> C{--list flag?}
    C -->|yes| D[Fetch registry.json from lmas-squads]
...
**Task file:** `.lmas-core/development/tasks/squad-creator-publish.md`
**Status:** Active (Sprint 8)
...
| @lmas-master -> @squad-creator | Invokes | Component creation (agents, tasks, workflows) |
...
- `.lmas-core/development/tasks/squad-creator-design.md`
- `.lmas-core/development/tasks/squad-creator-create.md`
- `.lmas-core/development/tasks/squad-creator-validate.md`
- `.lmas-core/development/tasks/squad-creator-list.md`
- `.lmas-core/development/tasks/squad-creator-migrate.md`
- `.lmas-core/development/tasks/squad-creator-analyze.md`
...
- `.lmas-core/development/scripts/squad/README.md`

**Schemas (2 files, all EXISTS):**
- `.lmas-core/schemas/squad-schema.json`
- `.lmas-core/schemas/squad-design-schema.json`

**Component Templates (8 files, all EXISTS):**
- `.lmas-core/development/templates/squad/agent-template.md`
- `.lmas-core/development/templates/squad/task-template.md`
- `.lmas-core/development/templates/squad/workflow-template.yaml`
- `.lmas-core/development/templates/squad/checklist-template.md`
- `.lmas-core/development/templates/squad/template-template.md`
- `.lmas-core/development/templates/squad/tool-template.js`
- `.lmas-core/development/templates/squad/script-template.js`
- `.lmas-core/development/templates/squad/data-template.yaml`

**Squad Template Scaffold (10 files, all EXISTS):**
- `.lmas-core/development/templates/squad-template/squad.yaml`
- `.lmas-core/development/templates/squad-template/README.md`
- `.lmas-core/development/templates/squad-template/package.json`
- `.lmas-core/development/templates/squad-template/.gitignore`
- `.lmas-core/development/templates/squad-template/LICENSE`
- `.lmas-core/development/templates/squad-template/agents/example-agent.yaml`
- `.lmas-core/development/templates/squad-template/tasks/example-task.yaml`
- `.lmas-core/development/templates/squad-template/workflows/example-workflow.yaml`
- `.lmas-core/development/templates/squad-template/templates/example-template.md`
- `.lmas-core/development/templates/squad-template/tests/example-agent.test.js`

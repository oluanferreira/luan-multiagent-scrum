# @sm (Niobe) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.lmas-core/development/agents/sm.md`
...
|-------|------|--------|---------|
| 1 | `.lmas-core/development/agents/sm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.lmas-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.lmas-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog, dataLocation |
| 4 | `.lmas-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.lmas-core/product/data/mode-selection-best-practices.md` | AgentConfigLoader.loadFile() | Mode selection best practices (always loaded, 10KB) |
...
sm:
  config_sections:
    ...
    - dataLocation
  files_loaded:
    - path: .lmas-core/product/data/mode-selection-best-practices.md
      lazy: false
      size: 10KB
    - path: .lmas-core/data/workflow-patterns.yaml
      lazy: false
      size: 8KB
...
**Task file:** `.lmas-core/development/tasks/sm-create-next-story.md`
**Template:** `.lmas-core/development/templates/story-tmpl.yaml` (MISSING in development/, EXISTS in `.lmas-core/product/templates/story-tmpl.yaml`)
...
| `.lmas-core/product/data/mode-selection-best-practices.md` | Data | Referenced by sm config |
...
**Checklist:** `.lmas-core/development/checklists/story-draft-checklist.md` (MISSING in development/, EXISTS in `.lmas-core/product/checklists/story-draft-checklist.md`)
...
- Course corrections needed (`@lmas-master *correct-course`)
...
|------|------|---------------|--------|
| `story-tmpl.yaml` | Template | `*draft` (sm-create-next-story.md) | MISSING in `.lmas-core/development/templates/`, EXISTS in `.lmas-core/product/templates/story-tmpl.yaml` |
| `story-draft-checklist.md` | Checklist | `*story-checklist` (execute-checklist.md) | MISSING in `.lmas-core/development/checklists/`, EXISTS in `.lmas-core/product/checklists/story-draft-checklist.md` |

# @dev (Neo) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.lmas-core/development/agents/dev.md`
...
|-------|------|--------|---------|
| 1 | `.lmas-core/development/agents/dev.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.lmas-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration + devLoadAlwaysFiles list |
| 3 | `.lmas-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devLoadAlwaysFiles, devStoryLocation, dataLocation |
...
| 8 | `.lmas-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 9 | `.lmas/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 10 | `.lmas/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
sequenceDiagram
    ...
    ACL-->>CC: { agent: { name: 'Neo', icon: '💻' }, commands: [...36], ... }
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `💻 Neo the Builder ready to innovate!` |
| Signature | `persona_profile.communication.signature_closing` | `— Neo, sempre construindo 🔨` |
...
**Task file:** `.lmas-core/development/tasks/dev-develop-story.md`
...
**Task file:** `.lmas-core/development/tasks/plan-execute-subtask.md`
...
**Task file:** `.lmas-core/development/tasks/build-autonomous.md`
...
**Task files:** `.lmas-core/development/tasks/gotcha.md`, `.lmas-core/development/tasks/gotchas.md`
...
**Task files:** `.lmas-core/development/tasks/create-worktree.md`, `list-worktrees.md`, `remove-worktree.md`
...
**Task file:** `.lmas-core/development/tasks/qa-fix-issues.md`
...
**Task file:** `.lmas-core/development/tasks/waves.md`
...
**Task file:** `.lmas-core/development/tasks/create-service.md`

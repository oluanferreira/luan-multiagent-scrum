# @data-engineer (Dozer) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.lmas-core/development/agents/data-engineer.md`
...
|-------|------|--------|---------|
| 1 | `.lmas-core/development/agents/data-engineer.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.lmas-core/core-config.yaml` | generate-greeting.js (CLI wrapper) | Core configuration |
| 3 | `.lmas-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, etlLocation |
...
| 6 | `.lmas/session-state.json` | SessionContextLoader.loadContext() | Session type detection (CLI wrapper pre-loads) |
...
> to GreetingBuilder. See `.lmas-core/development/scripts/generate-greeting.js`.
...
sequenceDiagram
    ...
    par Parallel Loading (Promise.all)
        ...
        ACL-->>GG: { agent: { name: 'Dozer', icon: '📊' }, commands: [...31], ... }
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `📊 Dozer the Sage ready to architect!` |
| Signature | `persona_profile.communication.signature_closing` | `— Dozer, arquitetando dados 🗄️` |
...
**Template:** `.lmas-core/development/templates/schema-design-tmpl.yaml` (MISSING)
...
| `.lmas-core/data/technical-preferences.md` | Data | Loaded at activation |
...
**Task file:** `.lmas-core/development/tasks/create-doc.md`
**Template:** `.lmas-core/development/templates/rls-policies-tmpl.yaml` (MISSING)
...
**Task file:** `.lmas-core/development/tasks/create-doc.md`
**Template:** `.lmas-core/development/templates/migration-plan-tmpl.yaml` (MISSING)
...
**Task file:** `.lmas-core/development/tasks/create-doc.md`
**Template:** `.lmas-core/development/templates/index-strategy-tmpl.yaml` (MISSING)
...
**Task file:** `.lmas-core/development/tasks/db-domain-modeling.md`
...
**Task file:** `.lmas-core/development/tasks/db-env-check.md`
...
**Task file:** `.lmas-core/development/tasks/db-bootstrap.md`
...
**Task file:** `.lmas-core/development/tasks/db-apply-migration.md`
...
**Task file:** `.lmas-core/development/tasks/db-dry-run.md`
...
**Task file:** `.lmas-core/development/tasks/db-seed.md`
...
**Task file:** `.lmas-core/development/tasks/db-snapshot.md`
...
**Task file:** `.lmas-core/development/tasks/db-rollback.md`
...
**Task file:** `.lmas-core/development/tasks/db-smoke-test.md`
...
**Task file:** `.lmas-core/development/tasks/security-audit.md`
...
**Task file:** `.lmas-core/development/tasks/analyze-performance.md`
...
**Task file:** `.lmas-core/development/tasks/db-policy-apply.md`
...
**Task file:** `.lmas-core/development/tasks/test-as-user.md`
...
**Task file:** `.lmas-core/development/tasks/db-verify-order.md`
...
**Task file:** `.lmas-core/development/tasks/db-load-csv.md`
...
**Task file:** `.lmas-core/development/tasks/db-run-sql.md`
...
**Task file:** `.lmas-core/development/tasks/setup-database.md`
...
flowchart TD
    ...
    B --> C[Resolve checklist from .lmas-core/development/checklists/]
...
**Task file:** `.lmas-core/development/tasks/create-deep-research-prompt.md`

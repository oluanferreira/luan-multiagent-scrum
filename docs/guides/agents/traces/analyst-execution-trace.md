...
> Agent definition: `.lmas-core/development/agents/analyst.md`
...
|-------|------|--------|---------|
| 1 | `.lmas-core/development/agents/analyst.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.lmas-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.lmas-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, analyticsLocation |
| 4 | `.lmas-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.lmas-core/product/data/brainstorming-techniques.md` | AgentConfigLoader.loadFile() | Brainstorming techniques (always loaded, 2KB) |
...
analyst:
  config_sections:
    ...
    - analyticsLocation
  files_loaded:
    - path: .lmas-core/product/data/brainstorming-techniques.md
      lazy: false
      size: 2KB
...
**Template:** `.lmas-core/product/templates/project-brief-tmpl.yaml` (EXISTS)
...
| `.lmas-core/product/data/elicitation-methods.md` | Data | Referenced by create-doc |
...
**Task file:** `.lmas-core/development/tasks/create-doc.md`
**Template:** `.lmas-core/product/templates/market-research-tmpl.yaml` (EXISTS)
...
**Task file:** `.lmas-core/development/tasks/create-doc.md`
**Template:** `.lmas-core/product/templates/competitor-analysis-tmpl.yaml` (EXISTS)
...
**Task file:** `.lmas-core/development/tasks/facilitate-brainstorming-session.md`
**Template:** `.lmas-core/product/templates/brainstorming-output-tmpl.yaml` (EXISTS)
**Data file:** `.lmas-core/product/data/brainstorming-techniques.md` (EXISTS)
...
**Task file:** `.lmas-core/development/tasks/spec-research-dependencies.md`
...
**Script:** `.lmas-core/infrastructure/scripts/pattern-extractor.js` (EXISTS)

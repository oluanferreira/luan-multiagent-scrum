...
Este documento descreve o sistema completo do agente Product Manager (PM) do LMAS, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis e integracoes entre agentes.
...
| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/development/agents/pm.md` | Definicao core do agente PM |
| `.claude/commands/LMAS/agents/pm.md` | Comando Claude Code para ativar @pm |

### Tasks do @pm

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.lmas-core/development/tasks/create-doc.md` | `*create-prd` | Cria documentos a partir de templates YAML |
| `.lmas-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de projeto |
| `.lmas-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.lmas-core/development/tasks/brownfield-create-epic.md` | `*create-epic` | Cria epics para projetos brownfield |
| `.lmas-core/development/tasks/brownfield-create-story.md` | `*create-story` | Cria stories para brownfield |
| `.lmas-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validacao de checklists |
| `.lmas-core/development/tasks/shard-doc.md` | `*shard-prd` | Fragmenta documentos grandes |

### Templates do @pm

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/product/templates/prd-tmpl.yaml` | Template PRD para projetos greenfield |
| `.lmas-core/product/templates/brownfield-prd-tmpl.yaml` | Template PRD para projetos brownfield |

### Checklists do @pm

| Arquivo | Proposito |
|---------|-----------|
| `.lmas-core/product/checklists/pm-checklist.md` | Checklist de validacao de PRD |
| `.lmas-core/product/checklists/change-checklist.md` | Checklist para navegacao de mudancas |

### Workflows que Utilizam o @pm

| Arquivo | Fase | Proposito |
|---------|------|-----------|
| `.lmas-core/development/workflows/brownfield-discovery.yaml` | Fase 10 | Criacao de epics e stories pos-discovery |
...
flowchart TB
    ...
    subgraph PM_CORE["📋 @pm (Trinity) - CORE"]
...
```mermaid
flowchart TB
    subgraph PM_BOX["📋 @pm (Trinity) - Product Manager"]
    ...
    subgraph ARCHITECT_BOX["🏗️ @architect (Architect) - Architect"]
...
**Solucao:**
- Verifique `.lmas-core/product/templates/`
...
- [Agent Definition: pm.md](.lmas-core/development/agents/pm.md)
- [Task: create-doc.md](.lmas-core/development/tasks/create-doc.md)
- [Task: brownfield-create-epic.md](.lmas-core/development/tasks/brownfield-create-epic.md)
- [Task: correct-course.md](.lmas-core/development/tasks/correct-course.md)
- [Template: prd-tmpl.yaml](.lmas-core/product/templates/prd-tmpl.yaml)
- [Template: brownfield-prd-tmpl.yaml](.lmas-core/product/templates/brownfield-prd-tmpl.yaml)
- [Checklist: pm-checklist.md](.lmas-core/product/checklists/pm-checklist.md)

...
### Configuration
- `.lmas-core/core-config.yaml` - Configuração global (git + agentIdentity sections)

### Agents (Updated)
- `.lmas-core/agents/dev.md` - ✅ Command visibility metadata
- `.lmas-core/agents/po.md` - ✅ Command visibility metadata
- `.lmas-core/agents/*.md` - ⏳ Remaining 9 agents (pending update)
...
A: Use o script de teste: `node .lmas-core/development/scripts/test-greeting-system.js`

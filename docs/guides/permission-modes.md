...
> Control how much autonomy LMAS agents have over your system.

---

## Overview

Permission Modes let you control the level of autonomy LMAS agents have. Whether you're exploring a new codebase or running fully autonomous builds, there's a mode for your workflow.
...
Mode is persisted in `.lmas/config.yaml`:
...
Check `.lmas/config.yaml` exists and is writable:

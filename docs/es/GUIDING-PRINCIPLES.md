...
# Principios Rectores del Método LMAS

> 🌐 [EN](../GUIDING-PRINCIPLES.md) | [PT](../pt/GUIDING-PRINCIPLES.md) | **ES**

---

El Método LMAS es un framework de lenguaje natural para el desarrollo de software asistido por IA. Estos principios aseguran que las contribuciones mantengan la efectividad del método.
...
Las plantillas siguen la especificación de [Plantilla de Documento LMAS](../../common/utils/lmas-doc-template.md) usando formato YAML:

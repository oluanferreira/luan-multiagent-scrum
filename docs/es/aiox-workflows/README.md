# LMAS Workflows - Documentacion Detallada de los Workflows

> [PT](../../lmas-workflows/README.md) | [EN](../../en/lmas-workflows/README.md) | **ES** | [ZH](../../zh/lmas-workflows/README.md)
...
Esta carpeta contiene la documentacion detallada de todos los workflows de LMAS, incluyendo:
...
| Agent Flows | [docs/lmas-agent-flows/](../../lmas-agent-flows/) | Detalles de agentes |
...
*LMAS Workflows Documentation v1.0 - Documentacion detallada de los workflows de desarrollo*

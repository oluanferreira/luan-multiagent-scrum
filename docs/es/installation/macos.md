...
# Guía de Instalación de Synkra LMAS para macOS
...
1. Los comandos se instalan en `.claude/commands/LMAS/`
...
2. Synkra LMAS maneja automáticamente tanto sistemas de archivos sensibles como insensibles a mayúsculas

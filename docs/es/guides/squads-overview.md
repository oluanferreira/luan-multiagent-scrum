...
Introduccion a LMAS Squads - equipos modulares de agentes IA que extienden la funcionalidad del framework.
...
Los Squads son equipos modulares de agentes IA que extienden la funcionalidad de LMAS para dominios o casos de uso especificos. Cada squad es un paquete autocontenido que puede ser instalado, compartido y compuesto con otros squads.

> **LMAS Squads:** Equipos de agentes IA trabajando contigo
...
| Agentes Tradicionales      | LMAS Squads                    |
| -------------------------- | ------------------------------ |
...
Las tasks deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.lmas-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).

### 2. Usar Herencia de Config Sabiamente

| Modo       | Comportamiento                              |
| ---------- | ------------------------------------------- |
| `extend`   | Agregar reglas del squad a reglas core LMAS |
...
- [Especificacion de Formato de Tasks](../../../.lmas-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_LMAS Squads: Equipos de agentes IA trabajando contigo_

...
Guia completa para desarrolladores que quieren contribuir al proyecto LMAS.
...
| -------------------- | ------------------------------------------- |
| **Claude Code**      | Desarrollo potenciado por IA con agentes LMAS |
| **VS Code / Cursor** | IDE con integracion LMAS                    |
...
1. Navega a [github.com/oluanferreira/luan-multiagent-scrum](https://github.com/oluanferreira/luan-multiagent-scrum)
...
```bash
# Clonar tu fork
git clone https://github.com/YOUR_USERNAME/lmas-core.git
cd lmas-core
...
Sincroniza los agentes LMAS con tu IDE:
...
Entendiendo la estructura de directorios de `lmas-core`:

```
lmas-core/
├── .lmas-core/                    # Fuente del framework (committed)
...
│   ├── commands/LMAS/agents/      # Comandos skill de agentes
...
| ----------------------------------- | -------------------------------- | ------------------------- |
| `.lmas-core/development/agents/`    | Personas y comportamientos de agentes | Agregar/modificar agentes |
| `.lmas-core/development/tasks/`     | Workflows de tasks ejecutables   | Agregar/modificar tasks   |
| `.lmas-core/development/workflows/` | Orquestaciones multi-paso        | Crear workflows           |
...
Crea un nuevo archivo en `.lmas-core/development/agents/`:

```bash
# Archivo: .lmas-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Crear en .lmas-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Crear en .lmas-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crea un nuevo archivo en `.lmas-core/development/tasks/`:
...
# Ejemplos:
# .lmas-core/development/tasks/dev-build-component.md  (agente dev)
# .lmas-core/development/tasks/create-doc.md          (compartida)
```
...
## Definicion de Task (LMAS Task Format V1.0)
...
Crea un nuevo archivo en `.lmas-core/development/workflows/`:

```bash
# Archivo: .lmas-core/development/workflows/my-workflow.yaml
```
...
npx js-yaml .lmas-core/development/agents/my-agent.md

# Verificar que existan dependencias
ls .lmas-core/development/tasks/my-task.md
```
...
LMAS_DEBUG=true npm run trace -- workflow-name

# Verificar estado de workflow
cat .lmas/state/workflow-state.json
```
...
- Etiquetar `@LMAS/core-team` para issues urgentes
...
_LMAS Guia de Configuracion para Desarrollo v1.0.0_

...
# Guía de Instalación y Solución de Problemas de LMAS-Core
...
Este comando descarga y ejecuta la última versión del instalador de LMAS-Core.
...
| Comando | Descripción |
|---------|-------------|
| `npx lmas-core@latest` | Instalar/ejecutar asistente |
| `npx lmas-core@latest --version` | Mostrar versión |
| `npx lmas-core@latest --help` | Mostrar ayuda |
| `npx lmas-core@latest install` | Instalar en directorio actual |
| `npx lmas-core@latest init <name>` | Crear nuevo proyecto |
| `npx lmas-core@latest doctor` | Ejecutar diagnósticos |
| `npx lmas-core@latest info` | Mostrar información del sistema |

---

*Última actualización: Diciembre 2025 | LMAS-Core v2.2.0*

...
**Opcion 1: Si tienes lmas-core clonado**
```bash
# Desde el directorio lmas-core
node .lmas-core/infrastructure/scripts/llm-routing/install-llm-routing.js
```
...
**Windows:** `.lmas-core/infrastructure/scripts/llm-routing/templates/claude-free.cmd`
**Unix:** `.lmas-core/infrastructure/scripts/llm-routing/templates/claude-free.sh`
...
- **Definicion de Herramienta:** `.lmas-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalacion:** `.lmas-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definicion de Tarea:** `.lmas-core/development/tasks/setup-llm-routing.md`
...
*Generado por LMAS Framework - Story 6.7*

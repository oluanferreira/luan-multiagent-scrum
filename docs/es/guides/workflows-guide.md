...
Los Workflows de LMAS son secuencias orquestadas de actividades de agents que automatizan procesos de desarrollo complejos. Proporcionan patrones estructurados y repetibles para escenarios de desarrollo comunes.
...
El state se persiste en `.lmas/{instance-id}-state.yaml`:
...
LMAS detecta patrones comunes de workflow basados en el historial de comandos:
...
| **Ubicacion** | `.lmas-core/development/workflows/` | `.lmas-core/development/tasks/` |
...
*Guia de Workflows de LMAS v1.0 - Orquestando la Colaboracion IA-Humano*

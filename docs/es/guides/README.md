...
Índice completo de documentación para las guías del sistema LMAS.
...
> **Nota:** La documentación de 1MCP ha sido descontinuada. LMAS ahora usa Docker MCP Toolkit exclusivamente (Story 5.11). Los documentos archivados están disponibles en `.github/deprecated-docs/guides/`.

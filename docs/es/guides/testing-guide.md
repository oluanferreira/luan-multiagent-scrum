# Guia de Testing de Synkra LMAS

> [EN](../../guides/testing-guide.md) | [PT](../../pt/guides/testing-guide.md) | **ES**

---

> Guia completa de la estrategia de testing, herramientas y mejores practicas para Synkra LMAS.
...
LMAS sigue una estrategia de testing integral que asegura la calidad del codigo en todas las capas del framework. Nuestra filosofia de testing esta construida sobre:
...
const {
  QualityGateManager,
} = require('../../../.lmas-core/core/quality-gates/quality-gate-manager');
 ...
 * Tests de Compatibilidad Retroactiva de Agentes
 *
 * Asegura que agentes de versiones anteriores de LMAS continuen funcionando.
 */

const { loadAgent } = require('../../.lmas-core/core/registry/agent-loader');
...
LMAS soporta Windows, macOS y Linux. El testing cross-platform asegura comportamiento consistente.
...
function getTempDir() {
  return path.join(os.tmpdir(), 'lmas-tests');
}
...
module.exports = {
  collectCoverageFrom: [
    ...
    '!.lmas-core/core/health-check/checks/**',
    '!.lmas-core/core/config/**',
    '!.lmas-core/core/manifest/**',
    '!.lmas-core/core/registry/**',
    '!.lmas-core/core/utils/**',
  ],
...
│   └── .lmas-core/       # Cobertura por modulo
...
El Sistema de Quality Gate de LMAS (ver [Guia de Quality Gates](./quality-gates.md)) integra testing en multiples capas:
...
jest.mock('../../.lmas-core/integrations/clickup-client');
const clickupClient = require('../../.lmas-core/integrations/clickup-client');
...
_Guia de Testing de Synkra LMAS v4_

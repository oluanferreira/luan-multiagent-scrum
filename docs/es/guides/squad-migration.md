...
Como migrar squads legacy al formato LMAS 2.1.

## Descripcion General

LMAS 2.1 introdujo un nuevo formato de squad con:
...
| Campo de tipo LMAS    | Faltante      | `lmas.type: squad`         |
| Version minima        | Faltante      | `lmas.minVersion: "2.1.0"` |
...
- Agrega campos `lmas` faltantes al manifiesto
...
- [ ] `lmas.type` es `"squad"`
- [ ] `lmas.minVersion` es `"2.1.0"` o superior

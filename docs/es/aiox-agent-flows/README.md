# LMAS Agent Flows - Documentacion Detallada de los Agentes

> [PT](../../lmas-agent-flows/README.md) | [EN](../../en/lmas-agent-flows/README.md) | **ES** | [ZH](../../zh/lmas-agent-flows/README.md)
...
Esta carpeta contiene la documentacion detallada de todos los agentes de LMAS, incluyendo:
...
|--------|---------|-----------|-----------|
| **@lmas-master** | Morpheus | Orchestrator | [lmas-master-system.md](./lmas-master-system.md) |
...
| **@data-engineer** | Dozer | Data Sage | [data-engineer-system.md](./data-engineer-system.md) |
| **@dev** | Neo | Builder | [dev-system.md](./dev-system.md) |
| **@devops** | Operator | Guardian | [devops-system.md](./devops-system.md) |
| **@pm** | Morgan | Strategist | [pm-system.md](./pm-system.md) |
| **@qa** | Oracle | Guardian | [qa-system.md](./qa-system.md) |
...
| LMAS Workflows | [docs/lmas-workflows/](../../lmas-workflows/) | Detalle de workflows |
...
*LMAS Agent Flows Documentation v1.0 - Documentacion detallada del sistema de agentes*

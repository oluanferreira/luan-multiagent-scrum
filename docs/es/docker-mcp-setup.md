...
Guía para configurar servidores MCP (Model Context Protocol) basados en Docker con LMAS.
...
- `~/.lmas/mcp/servers/` - Configuraciones de servidores individuales
...
LMAS usa Docker MCP Toolkit como infraestructura MCP principal:

...
# Fundamentos de los Arquetipos de Agentes LMAS

**Version:** 1.0
**Creado:** 2025-01-14
**Autor:** @ux-design-expert (Uma) + @architect (Architect)
**Proposito:** Documentar las decisiones de diseno, consideraciones de sensibilidad cultural y opciones alternativas para el sistema de personas de agentes LMAS

---

## Resumen Ejecutivo

Este documento proporciona la fundamentacion completa para el sistema de personas de agentes LMAS, incluyendo:
...
**Decision Clave:** Usar arquetipos zodiacales (12 signos) como marco de personalidad para 12 agentes LMAS, con equilibrio elemental perfecto y adecuacion cultural global.
...
1. **Rasgos Son Aspiracionales** - Arquetipos representan comportamientos ideales, no limitaciones
   - Ejemplo: Virgo (qa/Oracle) = "perfeccionista" es una fortaleza, no un defecto
...
|--------|------------------|---------------------|-----------|
| Neo | /deks/ | /deks/ | Ninguno |
| Oracle | /kwin/ | /kwin/ | Ninguno |
| Keymaker | /paeks/ | /paks/ | Ninguno |
| Morgan | /morgan/ | /morgan/ | Ninguno |
| River | /river/ | /river/ | Ninguno |
| Aria | /aria/ | /aria/ | Ninguno |
| Atlas | /atlas/ | /atlas/ | Ninguno |
| Uma | /uma/ | /uma/ | Ninguno |
| Dozer | /dara/ | /dara/ | Ninguno |
| Operator | /geidj/ | /geidj/ | Ninguno |
| Ajax | /eidjaeks/ | /ajaks/ | Ninguno |
| Morpheus | /oraion/ | /orion/ | Ninguno |
...
|--------|------------|-------|
| Neo | Ninguno | "Neo files" (Android) - contexto diferente |
| Oracle | Ninguno | Sin asociaciones tecnologicas importantes |
| Keymaker | Ninguno | Herramienta menor, no conflictiva |
...
| Dozer | Ninguno | Sin conflictos |
| Operator | Ninguno | Sin conflictos |
| Ajax | Consciente | Patron de programacion AJAX - ACEPTABLE (sugiere expertise tecnico) |
| Morpheus | Ninguno | Nombre de constelacion, sin conflictos |
...
**Ejemplos:**
- Neo, Oracle, Keymaker (claramente neutrales)
...
**Ejemplos:**
- Keymaker = "paz" (Latin) -> equilibra conflictos como PO
- Neo = "destreza" -> constructor habil
...
```yaml
agent:
  name: Neo          # De persona-definitions.yaml
...
**Los arquetipos zodiacales proporcionan el marco ideal para personas de agentes LMAS porque:**

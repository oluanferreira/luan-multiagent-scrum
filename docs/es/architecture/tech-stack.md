...
LMAS esta construido sobre JavaScript/TypeScript moderno con runtime Node.js, optimizado para desarrollo CLI multiplataforma con UX interactivo y capacidades de orquestacion de agentes.
...
LMAS_CONFIG_PATH=/ruta/custom      # Ubicacion de config personalizada
LMAS_YOLO_MODE=true               # Forzar modo yolo
...
_Este es un estandar oficial del framework LMAS. Todas las elecciones de tecnologia deben alinearse con este stack._

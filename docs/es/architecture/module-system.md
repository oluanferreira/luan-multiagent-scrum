...
# Arquitectura del Sistema de Módulos LMAS

> 🌐 [EN](../../architecture/module-system.md) | [PT](../../pt/architecture/module-system.md) | **ES**

---

> Guía completa de la arquitectura modular v4.2 para Synkra LMAS.
...
Synkra LMAS organiza el directorio `.lmas-core/` en cuatro módulos principales:
...
| `data/`          | `lmas-kb.md`, `workflow-patterns.yaml`           | Base de conocimiento del framework     |
...
```javascript
// Configuración
const { loadAgentConfig, globalConfigCache } = require('./.lmas-core/core');

// Sesión
const { ContextDetector, SessionContextLoader } = require('./.lmas-core/core');

// Elicitation
const { ElicitationEngine, ElicitationSessionManager } = require('./.lmas-core/core');
...
| --------------- | ------------------ | -------------------------- |
| LMAS Master     | `lmas-master`      | Orquestación del framework |
...
_Arquitectura del Sistema de Módulos Synkra LMAS v4_

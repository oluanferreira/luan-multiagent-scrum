# Cambios en los Agentes ADE - Alteraciones en los Agentes LMAS
...
Este documento registra todas las alteraciones realizadas en los archivos de definición de los agentes LMAS para soportar el LMAS Autonomous Development Engine (ADE).

**Archivos modificados:**

- `.lmas-core/development/agents/*.md` (fuente)
- `.claude/commands/LMAS/agents/*.md` (sincronizado)
...
**Archivo:** `.lmas-core/development/agents/devops.md`
...
**Archivo:** `.lmas-core/development/agents/pm.md`
...
**Archivo:** `.lmas-core/development/agents/architect.md`
...
**Archivo:** `.lmas-core/development/agents/analyst.md`
...
**Archivo:** `.lmas-core/development/agents/qa.md`
...
**Archivo:** `.lmas-core/development/agents/dev.md`
...
- name: list-gotchas
  visibility: [full, quick]
  description: 'Listar gotchas conocidos de .lmas/gotchas.md'
```
...
```
.lmas-core/development/agents/   →   .claude/commands/LMAS/agents/
         (fuente)                           (sincronizado)
```
...
- `.lmas-core/infrastructure/schemas/agent-v3-schema.json`

**Comando para validar:**

```bash
node .lmas-core/infrastructure/scripts/migrate-agent.js --validate
```

---

_Documento creado por Oracle (@qa) - Guardián de la Calidad_
_Fecha: 2026-01-29_

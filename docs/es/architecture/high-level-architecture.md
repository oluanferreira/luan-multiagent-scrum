...
# Arquitectura de Alto Nivel LMAS v4
...
**LMAS (AI Operating System)** es un framework sofisticado para orquestar agentes de IA, workers y humanos en flujos de trabajo complejos de desarrollo de software. La versión 2.1 introduce una arquitectura modular con 4 módulos, estrategia multi-repositorio y quality gates de 3 capas.
...
│   ┌─────────────────────────────────────────────────────────────────┐   │
│   │                        CLI / HERRAMIENTAS                        │   │
│   │  (lmas agents, lmas tasks, lmas squads, lmas workflow)          │   │
│   └─────────────────────────────────────────────────────────────────┘   │
│                                │                                        │
│          ┌────────────────────┼────────────────────┐                   │
│          │                    │                    │                   │
...
| --------------------- | ----------- | -------------- |
| `@lmas/core`          | npm público | MIT            |
| `@lmas/squad-etl`     | npm público | MIT            |
| `@lmas/squad-creator` | npm público | MIT            |
| `@lmas/squad-mmos`    | npm público | MIT            |
| `@lmas/mcp-presets`   | npm público | Apache 2.0     |
...
| ------------------ | ---------------------------- | ------------------------ | ----------------------------------- |
| **Core**           | `.lmas-core/core/`           | Fundación del framework  | Config, Registry, QG, MCP, Session  |
| **Development**    | `.lmas-core/development/`    | Artefactos de desarrollo | Agentes, Tareas, Workflows, Scripts |
| **Product**        | `.lmas-core/product/`        | Artefactos PM            | Plantillas, Checklists, Data        |
| **Infrastructure** | `.lmas-core/infrastructure/` | Config del sistema       | Scripts, Tools, Integraciones       |

### Sistema de Agentes

| Agente | ID              | Arquetipo    | Responsabilidad            |
| ------ | --------------- | ------------ | -------------------------- |
| Neo    | `dev`           | Constructor  | Implementación de código   |
| Oracle  | `qa`            | Guardián     | Aseguramiento de calidad   |
...
| Dozer   | `data-engineer` | Arquitecto   | Ingeniería de datos        |
| Felix  | `devops`        | Optimizador  | CI/CD y operaciones        |
| Uma    | `ux-expert`     | Creador      | Experiencia de usuario     |
| Keymaker    | `lmas-master`   | Orquestador  | Orquestación del framework |
...
- [LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.lmas-core/docs/standards/LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guía completa del framework

---

**Última Actualización:** 2025-12-09
**Versión:** 2.1.0
**Responsable:** @architect (Architect)

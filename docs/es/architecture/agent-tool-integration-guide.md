...
Esta guía explica cómo se integran las herramientas con los agentes LMAS. Las herramientas amplían las capacidades de los agentes proporcionando acceso a servicios externos, APIs y recursos del sistema.
...
| `tasks`      | Archivos de flujo de trabajo          | `.lmas-core/development/tasks/`  |
| `checklists` | Listas de validación                  | `.lmas-core/product/checklists/` |

### Ejemplo de Declaración

```yaml
# De .lmas-core/development/agents/dev.md
dependencies:
  checklists:
...
LMAS implementa gobernanza estricta de operaciones de git:
...
- [Definiciones de Agentes](../../../.lmas-core/development/agents/)

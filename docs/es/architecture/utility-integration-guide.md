...
**Propósito:** Definir patrones estándar para integrar scripts de utilidades en el framework LMAS

---

## ¿Qué es la Integración de Utilidades?

**Definición:** La integración de utilidades es el proceso de hacer que un script de utilidad huérfano sea **descubrible, documentado y utilizable** dentro del framework LMAS.
...
- `.lmas-core/agents/{agent}.yaml` (agregar a dependencies.utils)
- `.lmas-core/core-config.yaml` (registrar si es necesario)
- `.lmas-core/utils/README.md` (documentar utilidad)
...
```yaml
# .lmas-core/tasks/generate-commit-message.md
...
**Archivos Modificados:**
- `.lmas-core/tasks/{task}.md` (agregar execution.utils)
- `.lmas-core/agents/{agent}.yaml` (agregar tarea a lista executes)
- `.lmas-core/core-config.yaml` (registrar si es necesario)
- `.lmas-core/utils/README.md` (documentar utilidad)
...
**Archivos Modificados:**
- `.lmas-core/core-config.yaml` (registrar bajo framework)
- `.lmas-core/utils/README.md` (documentar como utilidad de framework)
...
```yaml
# .lmas-core/agents/architect.yaml
dependencies:
  utils:
...
**Archivos Modificados:**
- `.lmas-core/agents/{agent}.yaml`
- `.lmas-core/tasks/{task}.md` (si se crea tarea)
- `.lmas-core/core-config.yaml`
- `.lmas-core/utils/README.md`
...
**Ejemplos:** lmas-validator, code-quality-improver, coverage-analyzer
...
const utility = require('.lmas-core/utils/{utility-name}');
...
**Ubicación:** `.lmas-core/utils/{name}.js`

...
| ------------------------ | ------------------------------------------------------------ | --------- | ------ |
| worktree-manager.js      | `.lmas-core/infrastructure/scripts/worktree-manager.js`      | JS Script | ✅     |
| story-worktree-hooks.js  | `.lmas-core/infrastructure/scripts/story-worktree-hooks.js`  | JS Script | ✅     |
| project-status-loader.js | `.lmas-core/infrastructure/scripts/project-status-loader.js` | JS Script | ✅     |
| auto-worktree.yaml       | `.lmas-core/development/workflows/auto-worktree.yaml`        | Workflow  | ✅     |
| worktree-create.md       | `.lmas-core/development/tasks/worktree-create.md`            | Task      | ✅     |
| worktree-list.md         | `.lmas-core/development/tasks/worktree-list.md`              | Task      | ✅     |
| worktree-merge.md        | `.lmas-core/development/tasks/worktree-merge.md`             | Task      | ✅     |
...
```javascript
const { WorktreeManager } = require('.lmas-core/infrastructure/scripts/worktree-manager.js');
...
- **status.json**: Estado del worktree rastreado en `.lmas/status.json`
- **Dashboard**: API de WorktreeManager consumida por LMAS Dashboard
...
_Handoff preparado por Oracle (@qa) - Guardián de la Calidad_

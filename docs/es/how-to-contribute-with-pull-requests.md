...
- **Para correcciones de bugs**: Crea un issue usando la [plantilla de reporte de bugs](https://github.com/oluanferreirainc/lmas-core/issues/new?template=bug_report.md)
- **Para nuevas features**:
  1. Discute en Discord en el [canal #general-dev](https://discord.gg/gk8jAdXWmj)
  2. Crea un issue usando la [plantilla de solicitud de feature](https://github.com/oluanferreirainc/lmas-core/issues/new?template=feature_request.md)
...
1. Ve al [repositorio LMAS](https://github.com/oluanferreirainc/lmas-core)
...
git clone https://github.com/TU-USUARIO/lmas-core.git
cd lmas-core
```
...
- Reporta bugs usando la [plantilla de reporte de bugs](https://github.com/oluanferreirainc/lmas-core/issues/new?template=bug_report.md)
- Sugiere features usando la [plantilla de solicitud de feature](https://github.com/oluanferreirainc/lmas-core/issues/new?template=feature_request.md)

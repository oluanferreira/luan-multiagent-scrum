...
# Guía de LMAS para GitHub Copilot
...
### ¿Por qué usar LMAS con GitHub Copilot?
...
### Activando Modos de Agentes LMAS
...
4. Para agentes LMAS, usa modos de chat personalizados en `.github/chatmodes/`

### Modos Personalizados LMAS

| Modo | Propósito |
|---|---|
| `lmas-dev` | Desarrollo full-stack |
| `lmas-qa` | Aseguramiento de calidad |
| `lmas-architect` | Diseño de sistemas |
| `lmas-pm` | Gestión de proyectos |
...
```mermaid
flowchart LR
    Source["LMAS Core<br/>.lmas-core/development/agents"] --> Parser["Agent Parser"]
...
```
Problema: Los modos de agentes LMAS no aparecen en el selector
```
**Solución:**
...
1. Los agentes almacenados en `.lmas-core/` son portables

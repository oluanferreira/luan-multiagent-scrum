...
LMAS soporta 9 plataformas de desarrollo con IA. Elija la que mejor se adapte a su flujo de trabajo.
...
flowchart TD
    ...
    Q1 -->|Sí| CC["<b>Claude Code</b> ⭐<br/>Mejor integración LMAS"]
...
graph TD
    subgraph "LMAS Core"
        Agents["Definiciones de Agentes<br/>.lmas-core/development/agents"]
        Templates["Templates de IDE<br/>.lmas-core/product/templates"]
...
_Synkra LMAS - Documentación de Plataformas v1.0_

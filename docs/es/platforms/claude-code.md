...
# Guía LMAS para Claude Code

> 🌐 [EN](../../platforms/claude-code.md) | [PT](../../pt/platforms/claude-code.md) | **ES**

---

> **CLI Oficial de Anthropic** - Plataforma Recomendada para LMAS
...
### ¿Por qué usar LMAS con Claude Code?

Claude Code ofrece la **mejor integración** con LMAS debido a:
...
# Verifica que los archivos LMAS fueron creados
ls -la .claude/
```
...
export LMAS_DEBUG="true"                        # Habilitar registro de depuración
```
...
```mermaid
flowchart LR
    Source["LMAS Core<br/>.lmas-core/development/agents"] --> Parser["Analizador de Agentes"]
...
1. Los cambios locales se respaldan en `.claude/commands/LMAS/agents/.backup/`
...
R: En `.claude/commands/LMAS/agents/` después de la sincronización.

**P: ¿Con qué frecuencia debo sincronizar agentes?**
R: Después de actualizar LMAS o cuando los agentes se modifiquen en el núcleo.
...
2. Inicializa LMAS con Claude Code:
   ```bash
...
1. Tus agentes LMAS se almacenan en `.lmas-core/development/agents/`
2. Inicializa LMAS para el IDE objetivo

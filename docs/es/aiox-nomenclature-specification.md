<!--
  Traducción: ES
  Original: /docs/en/lmas-nomenclature-specification.md
  Última sincronización: 2026-01-26
-->

# Especificación de Nomenclatura de LMAS

> 🌐 [EN](../lmas-nomenclature-specification.md) | [PT](../pt/lmas-nomenclature-specification.md) | **ES**
...
Este documento establece nomenclatura clara para LMAS para diferenciar entre:
...
**Características:**
- **Alcance:** Interno a un único archivo de tarea (`.lmas-core/tasks/*.md`)
...
- **Ubicación:** Definido en `.lmas-core/workflows/*.yaml` o secciones de workflow de stories
...
**Concepto:** Inspirado por el protocolo Organizer-Worker de AsyncThink, los workflows de LMAS pueden usar un **Agente Organizador** que coordina **Agentes Trabajadores** ejecutando tareas en paralelo.
...
**Archivos de Tarea:**
- Ubicación: `.lmas-core/tasks/{task-name}.md`
- Contiene: Task workflow (Step-by-Step Execution)
- Ejemplo: `.lmas-core/tasks/security-scan.md`

**Archivos de Workflow:**
- Ubicación: `.lmas-core/workflows/{workflow-name}.yaml`
- Contiene: Definición de orquestación multi-tarea
- Ejemplo: `.lmas-core/workflows/story-development-workflow.yaml`
...
```yaml
# .lmas-core/workflows/story-development-workflow.yaml
workflow:
  id: story-development-workflow
  name: Story Development Flow
...
3. **Gestión de Workflows LMAS:** Patrones de workflow existentes en LMAS

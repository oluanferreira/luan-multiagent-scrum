...
# Estructura del Árbol de Código Fuente LMAS
...
**Repositorio:** SynkraAI/lmas-core
...
- [Core del Framework (.lmas-core/)](#core-del-framework-lmas-core)
...
LMAS utiliza una **arquitectura modular** con clara separación de responsabilidades:

1. **Core del Framework** (`.lmas-core/`) - Componentes portables del framework organizados por dominio
...
```
lmas-core/                             # Proyecto raíz
├── .lmas-core/                        # Core del framework (modular)
...
│
├── bin/                               # Ejecutables CLI
│   └── lmas.js                        # Punto de entrada principal CLI
│
...
```yaml
Agents:
  Location: .lmas-core/development/agents/
  Format: Markdown with YAML frontmatter
  Naming: {agent-name}.md (kebab-case)
  Example: dev.md, qa.md, architect.md

Tasks:
  Location: .lmas-core/development/tasks/
...
Workflows:
  Location: .lmas-core/development/workflows/
  Format: YAML
...
│   ├── lmas migration/                # Stories de migración LMAS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a LMAS. A diferencia de los Squads deprecados, los Squads siguen una estructura de template estandarizada.
...
npx create-lmas-squad my-squad-name
...
```
lmas-core/
├── .lmas-core/                        # Assets del framework (modular v2.0)
│   ├── cli/                           # Comandos CLI y utilidades
│   ├── core/                          # Esenciales del framework
│   │   ├── config/                    # Sistema de configuración
...
```
squads/
├── verified/                          # Squads curados por LMAS
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
Ubicación: .lmas-core/development/agents/{agent-name}.md
Ejemplo: .lmas-core/development/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicación: .lmas-core/development/tasks/{task-name}.md
Ejemplo: .lmas-core/development/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicación: .lmas-core/development/workflows/{workflow-name}.yaml
Ejemplo: .lmas-core/development/workflows/continuous-deployment.yaml

# Estoy creando un nuevo template:
Ubicación: .lmas-core/product/templates/{template-name}-tmpl.{yaml|md}
Ejemplo: .lmas-core/product/templates/deployment-plan-tmpl.yaml

# Estoy creando un nuevo checklist:
Ubicación: .lmas-core/product/checklists/{checklist-name}-checklist.md
Ejemplo: .lmas-core/product/checklists/security-review-checklist.md

# Estoy creando un comando CLI:
Ubicación: .lmas-core/cli/commands/{category}/{command-name}.js
Ejemplo: .lmas-core/cli/commands/generate/workflow.js

# Estoy creando una utilidad core:
Ubicación: .lmas-core/core/utils/{utility-name}.js
Ejemplo: .lmas-core/core/utils/performance-monitor.js

# Estoy creando un script de infraestructura:
Ubicación: .lmas-core/infrastructure/scripts/{category}/{script-name}.js
Ejemplo: .lmas-core/infrastructure/scripts/llm-routing/router.js

# Estoy agregando un adaptador de herramienta PM:
Ubicación: .lmas-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Ejemplo: .lmas-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
| 1.1     | 2025-12-14 | Actualizada org a SynkraAI, reemplazado Squads con sistema de Squads [Story 6.10]                                          | Neo (dev)        |
| 2.0     | 2025-12-15 | Actualización mayor para reflejar arquitectura modular (cli/, core/, development/, infrastructure/, product/) [Story 6.13] | Keymaker (PO)         |

---

_Este es un estándar oficial del framework LMAS. Toda colocación de archivos debe seguir esta estructura._

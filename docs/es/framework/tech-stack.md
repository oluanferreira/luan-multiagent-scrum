...
**Aviso de Migración:** Este documento migrará al repositorio `LMAS/lmas-core` en Q2 2026 (ver Decision 005)
...
| 1.1     | 2025-12-14 | Actualizado aviso de migración a LMAS/lmas-core, semantic-release a v25.0.2 [Story 6.10] | Neo (dev)        |

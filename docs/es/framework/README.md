...
# Documentación del Framework LMAS
...
Este directorio contiene la **documentación oficial del framework LMAS** que define estándares, patrones y estructuras aplicables a todos los proyectos LMAS (greenfield y brownfield).
...
1. **Lea la documentación del framework durante la incorporación** - Comprenda los estándares de LMAS
...
### Para Mantenedores del Framework LMAS
...
**Mantenedor**: Equipo del Framework LMAS

...
# Guía de Flujo de Trabajo Git de LMAS
...
LMAS implementa una estrategia de validación de **Defensa en Profundidad** con tres capas progresivas que detectan problemas tempranamente y aseguran la calidad del código antes del merge.
...
```bash
# Validación manual
node .lmas-core/utils/lmas-validator.js pre-push
node .lmas-core/utils/lmas-validator.js stories

# Validar una sola story
node .lmas-core/utils/lmas-validator.js story docs/stories/1.1-story.yaml
...
**Ubicación:** `.lmas-core/utils/lmas-validator.js`
...
- name: Validate story checkboxes
  run: node .lmas-core/utils/lmas-validator.js stories
```
...
# Verificar corrección
node .lmas-core/utils/lmas-validator.js story docs/stories/X.X-story.yaml
...
```javascript
// .lmas-core/utils/custom-validator.js
...
```bash
# .husky/pre-commit
node .lmas-core/utils/lmas-validator.js pre-commit
node .lmas-core/utils/custom-validator.js
```
...
- name: Custom validation
  run: node .lmas-core/utils/custom-validator.js
```
...
- **LMAS Validator:** [.lmas-core/utils/lmas-validator.js](../../.lmas-core/utils/lmas-validator.js)
...
- [Abrir un Issue](https://github.com/oluanferreira/luan-multiagent-scrum/issues)

...
Todos los cambios notables en LMAS seran documentados en este archivo.
...
- **Estructura de Directorios**: Renombrado `.legacy-core/` a `.lmas-core/`
...
- **Configuracion de IDE**: Agentes de Claude Code movidos a `.claude/commands/LMAS/agents/`
- **Ubicaciones de Archivos**:
  ...
  - `.lmas-core/utils/` → `.lmas-core/scripts/`
...
- Proceso de instalacion manual (usar `npx lmas-core install` en su lugar)
...
- Lanzamiento publico inicial de LMAS
...
**Cambios clave:**
1. Directorio renombrado: `.legacy-core/` → `.lmas-core/`
...
- [Repositorio GitHub](https://github.com/oluanferreira/luan-multiagent-scrum)

...
```bash
LMAS_AI_PROVIDER=openai          # AI provider
LMAS_AI_MODEL=gpt-4             # AI model
LMAS_LOG_LEVEL=debug            # Log level
LMAS_TELEMETRY=disabled         # Telemetry setting
LMAS_TIMEOUT=30000             # Command timeout (ms)
LMAS_MEMORY_CACHE=true         # Memory caching
```

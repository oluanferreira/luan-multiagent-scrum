...
3. Pesquise [Issues existentes no GitHub](https://github.com/SynkraAI/lmas-core/issues)
...
- **Issues no GitHub**: [lmas-core/issues](https://github.com/SynkraAI/lmas-core/issues)

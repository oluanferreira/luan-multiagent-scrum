...
# Guia de Instalação Windows para Synkra LMAS
...
2. Comandos são instalados em `.claude\commands\LMAS\`
...
# - Fazer backup de customizações em .lmas-backup\

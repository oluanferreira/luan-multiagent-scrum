...
O LMAS usa uma **arquitetura modular** com clara separação de responsabilidades:

1. **Framework Core** (`.lmas-core/`) - Componentes portáveis do framework organizados por domínio
...
│   ├── lmas migration/                # Stories de migração LMAS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads são extensões modulares que adicionam capacidades especializadas ao LMAS. Diferente dos Squads deprecados, Squads seguem uma estrutura de template padronizada.
...
```
squads/
├── verified/                          # Squads curados pelo LMAS
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
_Este é um padrão oficial do framework LMAS. Todo posicionamento de arquivos deve seguir esta estrutura._

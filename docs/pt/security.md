...
Levamos a segurança a sério na LMAS. Se você descobrir uma vulnerabilidade de segurança no LMAS, por favor reporte de forma responsável.
...
1. **GitHub Security Advisories** (Preferido)
   - Vá para [Security Advisories](https://github.com/oluanferreira/luan-multiagent-scrum/security/advisories)
   - Clique em "Report a vulnerability"
   - Preencha o formulário com detalhes

2. **GitHub Issues (Privado)**
   - Abra um [security advisory privado](https://github.com/oluanferreira/luan-multiagent-scrum/security/advisories)
...
Ao usar o LMAS Framework, recomendamos:
...
O LMAS Framework executa código e comandos gerados por IA. Usuários devem:
...
- LMAS pode processar dados sensíveis através de provedores de IA

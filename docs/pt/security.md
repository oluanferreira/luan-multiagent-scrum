...
Levamos a segurança a sério na SynkraAI. Se você descobrir uma vulnerabilidade de segurança no LMAS, por favor reporte de forma responsável.
...
1. **GitHub Security Advisories** (Preferido)
   - Vá para [Security Advisories](https://github.com/SynkraAI/lmas-core/security/advisories)
   - Clique em "Report a vulnerability"
   - Preencha o formulário com detalhes

2. **GitHub Issues (Privado)**
   - Abra um [security advisory privado](https://github.com/SynkraAI/lmas-core/security/advisories)

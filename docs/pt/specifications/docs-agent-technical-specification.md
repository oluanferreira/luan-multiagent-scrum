...
**@docs (Ajax)** e um agente de IA especializado em criar **documentacao educacional** para o LMAS. Diferente da documentacao tecnica (JSDoc/Typedoc), Ajax foca em **tutoriais, guias de onboarding, explicadores visuais e materiais de treinamento para parceiros**.
...
- Aprovacao unanime da mesa redonda (Brad Frost, Marty Cagan, Paul Graham, Luan Ferreira)
...
whenToUse: |
  ...
  - Tutoriais explicando como usar recursos do LMAS
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Usa estilo consistente (paleta de cores LMAS)"
      blocker: false
...
whenToUse: |
  ...
  - Novo parceiro entra no ecossistema LMAS
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Links para documentacao LMAS relevante"
      blocker: false
...
**Agente:** @[nome-agente]
**Nome:** [Nome Completo (ex: Ajax, Neo)]
...
[Nome do Agente] e o agente de [funcao] do LMAS, especializado em [expertise principal].
...
**Notas do Template:**
- Use paleta de cores LMAS (Azul primario, Roxo secundario, Rosa terciario)
...
```bash
#!/bin/bash
# Hook de Auto-Atualizacao @docs do LMAS
...
- [ ] Criar `squads/lmas/agents/docs/agent.yaml`
...
- [ ] **Reconhecimento da Industria:** Docs do LMAS citados como "melhor no espaco de agentes de IA"
...
Com a adicao do @docs (Ajax), LMAS agora tem **13 agentes nomeados**:

| # | Agente | Nome | Funcao | Arquetipo | Cor |
|---|--------|------|--------|-----------|-----|
| 1 | @dev | Neo | Builder | Aquarius | Cyan |
| 2 | @qa | Oracle | Guardian | Virgo | Green |
| 3 | @po | Keymaker | Balancer | Libra | Yellow |
...
| 9 | @data-engineer | Dozer | Sage | Gemini | Yellow |
| 10 | @devops | Operator | Automator | Taurus | Green |
| 11 | **@docs** | **Ajax** | **Estrategista de Conteudo** | **Aries** | **Blue** |
| 12 | ~~@security~~ | ~~Apex~~ | ~~Conductor~~ | ~~Leo~~ | ~~Red~~ (CANCELADO) |
| 13 | @lmas-master | Morpheus | Commander | Aries | Cyan |
...
**Especificacao Aprovada Por:** Architect (Architect)

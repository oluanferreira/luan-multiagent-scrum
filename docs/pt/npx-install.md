...
Sempre execute `npx lmas-core install` **a partir do diretório do seu projeto**:
...
o LMAS de detectar sua IDE corretamente.

Solução:
  cd /path/to/your/project
  npx lmas-core install

Veja: https://lmas-core.dev/docs/npx-install
```
...
2. **Camada SECUNDÁRIA** (`tools/installer/bin/lmas.js`):

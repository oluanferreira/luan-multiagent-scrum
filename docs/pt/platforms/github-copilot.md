...
Este projeto usa LMAS para desenvolvimento orquestrado por IA.
...
Você é um Desenvolvedor Full Stack Sênior trabalhando com LMAS.
...
*LMAS - Guia da Plataforma GitHub Copilot v1.0*

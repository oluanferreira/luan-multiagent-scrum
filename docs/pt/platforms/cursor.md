...
### Por que usar LMAS com Cursor?

O Cursor é uma das **IDEs com IA mais populares** com excelente integração LMAS:
...
Verifique se os arquivos LMAS foram criados:
...
R: Execute `npm run sync:ide` após atualizações do LMAS.
...
2. Inicialize LMAS para Claude Code:
...
- [Guia de Integração LMAS](../README.md)

...
```
my-first-project/
├── .lmas/                    # Configuração do framework
...
O arquivo principal de configuração (`.lmas/config.json`) contém:
...
- **[Tutoriais em Vídeo](https://lmas-core.dev/tutorials)**: Aprendizado visual
...
- **Twitter**: Siga [@lmasfullstack](https://twitter.com/lmasfullstack)

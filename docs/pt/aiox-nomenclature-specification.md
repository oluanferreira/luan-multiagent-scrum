...
# Especificação de Nomenclatura do LMAS

> 🌐 [EN](../lmas-nomenclature-specification.md) | **PT** | [ES](../es/lmas-nomenclature-specification.md)
...
Este documento estabelece nomenclatura clara para o LMAS diferenciando entre:
...
**Características:**
- **Escopo:** Interno a um único arquivo de task (`.lmas-core/tasks/*.md`)
...
- **Localização:** Definido em `.lmas-core/workflows/*.yaml` ou seções de workflow de stories
...
**Conceito:** Inspirado pelo protocolo Organizer-Worker do AsyncThink, workflows do LMAS podem usar um **Organizer Agent** que coordena **Worker Agents** executando tasks em paralelo.
...
- Exemplo: `.lmas-core/tasks/security-scan.md`

**Arquivos de Workflow:**
- Localização: `.lmas-core/workflows/{workflow-name}.yaml`
- Contém: Definição de orquestração multi-task
- Exemplo: `.lmas-core/workflows/story-development-workflow.yaml`
...
3. **Gerenciamento de Workflow LMAS:** Padrões de workflow existentes no LMAS

...
Todas as alteracoes notaveis do LMAS serao documentadas neste arquivo.
...
- **Estrutura de Diretorios**: Renomeado `.legacy-core/` para `.lmas-core/`
...
- **Configuracao de IDE**: Agentes do Claude Code movidos para `.claude/commands/LMAS/agents/`
...
- Processo de instalacao manual (use `npx lmas-core install` em vez disso)
...
- Lancamento publico inicial do LMAS
...
1. Diretorio renomeado: `.legacy-core/` -> `.lmas-core/`

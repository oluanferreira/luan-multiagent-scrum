...
**Opção 1: Se você tem o lmas-core clonado**
```bash
# Do diretório lmas-core
...
- **Definição da Ferramenta:** `.lmas-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalação:** `.lmas-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definição de Tarefa:** `.lmas-core/development/tasks/setup-llm-routing.md`
...
*Gerado pelo LMAS Framework - Story 6.7*

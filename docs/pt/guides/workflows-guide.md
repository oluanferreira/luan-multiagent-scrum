...
Os Workflows do LMAS sao sequencias orquestradas de atividades de agents que automatizam processos de desenvolvimento complexos. Eles fornecem padroes estruturados e repetitivos para cenarios de desenvolvimento comuns.
...
O state e persistido em `.lmas/{instance-id}-state.yaml`:
...
O LMAS detecta padroes comuns de workflow baseados no historico de comandos:
...
| **Localizacao** | `.lmas-core/development/workflows/` | `.lmas-core/development/tasks/` |
...
*Guia de Workflows do LMAS v1.0 - Orquestrando Colaboracao IA-Humano*

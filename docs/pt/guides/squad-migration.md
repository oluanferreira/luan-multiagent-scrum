...
Como migrar squads legados para o formato LMAS 2.1.

## Visão Geral

LMAS 2.1 introduziu um novo formato de squad com:
...
| Campo LMAS type      | Ausente       | `lmas.type: squad`         |
| Versão mínima        | Ausente       | `lmas.minVersion: "2.1.0"` |
...
- Adiciona campos `lmas` ausentes ao manifesto
...
- [ ] `lmas.type` é `"squad"`
- [ ] `lmas.minVersion` é `"2.1.0"` ou superior

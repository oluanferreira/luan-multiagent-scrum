...
# Guia de Instalação e Solução de Problemas do LMAS-Core
...
Este comando baixa e executa a versão mais recente do instalador do LMAS-Core.
...
npx --ignore-existing lmas-core@latest
...
2. **Execute diagnósticos**: `npx lmas-core@latest doctor`
3. **Verifique informações do sistema**: `npx lmas-core@latest info`
...
| Comando | Descrição |
|---------|-----------|
| `npx lmas-core@latest` | Instalar/executar assistente |
| `npx lmas-core@latest --version` | Mostrar versão |
| `npx lmas-core@latest --help` | Mostrar ajuda |
| `npx lmas-core@latest install` | Instalar no diretório atual |
| `npx lmas-core@latest init <name>` | Criar novo projeto |
| `npx lmas-core@latest doctor` | Executar diagnósticos |
| `npx lmas-core@latest info` | Mostrar informações do sistema |

---

*Última atualização: Dezembro 2025 | LMAS-Core v2.2.0*

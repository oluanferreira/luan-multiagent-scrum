...
# Guia de Service Discovery LMAS

> 🌐 [EN](../../guides/service-discovery.md) | **PT** | [ES](../../es/guides/service-discovery.md)

---

> Como descobrir, consultar e usar workers no framework LMAS.
...
O sistema de Service Discovery permite encontrar e usar workers (tasks, templates, scripts, workflows) em todo o framework LMAS. O **Service Registry** é o catálogo central contendo metadados sobre todos os workers disponíveis.
...
Encontrados 5 workers correspondendo a "create story":
  ...
  [task] dev-create-brownfield-story
         Path: .lmas-core/development/tasks/dev-create-brownfield-story.md
...
**Localização:** `.lmas-core/development/tasks/`
...
**Localização:** `.lmas-core/product/templates/`
...
**Localização:** `.lmas-core/infrastructure/scripts/`
...
**Localização:** `.lmas-core/development/workflows/`
...
**Localização:** `.lmas-core/product/checklists/`

...
Introdução aos LMAS Squads - equipes modulares de agentes de IA que estendem a funcionalidade do framework.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do LMAS para domínios ou casos de uso específicos. Cada squad é um pacote autocontido que pode ser instalado, compartilhado e composto com outros squads.

> **LMAS Squads:** Equipes de agentes de IA trabalhando com você
...
| Agentes Tradicionais   | LMAS Squads                  |
| ---------------------- | ---------------------------- |
...
| Modo       | Comportamento                           |
| ---------- | --------------------------------------- |
| `extend`   | Adiciona regras do squad às regras LMAS |
| `override` | Substitui regras LMAS pelas do squad    |
...
- [Especificação de Formato de Task](../../../.lmas-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_LMAS Squads: Equipes de agentes de IA trabalhando com você_

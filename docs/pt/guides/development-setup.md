...
| -------------------- | --------------------------------------------- |
| **Claude Code**      | Desenvolvimento com IA usando agentes LMAS    |
| **VS Code / Cursor** | IDE com integração LMAS                       |
...
Sincronizar agentes LMAS com sua IDE:
...
Entendendo a estrutura de diretórios do `lmas-core`:

```
lmas-core/
├── .lmas-core/                    # Fonte do framework (commitado)
...
| ----------------------------------- | ----------------------------- | ------------------------- |
| `.lmas-core/development/agents/`    | Personas e comportamentos de agentes | Adicionar/modificar agentes |
| `.lmas-core/development/tasks/`     | Workflows de tasks executáveis | Adicionar/modificar tasks |
| `.lmas-core/development/workflows/` | Orquestrações multi-etapas    | Criar workflows           |
...
Crie um novo arquivo em `.lmas-core/development/agents/`:

```bash
# Arquivo: .lmas-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Criar em .lmas-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Criar em .lmas-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crie um novo arquivo em `.lmas-core/development/tasks/`:
...
# .lmas-core/development/tasks/create-doc.md          (compartilhada)
```
...
## Definição da Task (LMAS Task Format V1.0)
...
Crie um novo arquivo em `.lmas-core/development/workflows/`:

```bash
# Arquivo: .lmas-core/development/workflows/my-workflow.yaml
```

...
| **Achados do Oracle**           | Problemas encontrados pelo agente @qa                  |
...
```bash
# Sincronizar de .lmas/data para o dashboard
npm run sync-metrics
...
Isso copia `.lmas/data/quality-metrics.json` para `tools/quality-dashboard/public/.lmas/data/`.

# LMAS Architecture Documentation Index
...
This index provides navigation to all architecture documentation for LMAS v4.
...
|----------|-------------|--------|
| [High-Level Architecture](./high-level-architecture.md) | Overview of LMAS v4 architecture | ✅ Current |

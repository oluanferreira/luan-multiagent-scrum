...
.lmas-core/schemas/squad-schema.json            # (sem alterações necessárias)
```
...
| Suporte | @qa (Oracle) | Testar implementação |
| Revisão | @architect (Architect) | Revisão de arquitetura |

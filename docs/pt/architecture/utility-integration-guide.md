...
**Propósito:** Definir padrões para integração de scripts utilitários no framework LMAS

---

## O que é Integração de Utilitários?

**Definição:** Integração de utilitários é o processo de tornar um script utilitário órfão **descobrível, documentado e utilizável** dentro do framework LMAS.
...
- `.lmas-core/agents/{agent}.yaml` (adicionar a dependencies.utils)
- `.lmas-core/core-config.yaml` (registrar se necessário)
- `.lmas-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.lmas-core/tasks/{task}.md` (adicionar execution.utils)
- `.lmas-core/agents/{agent}.yaml` (adicionar task à lista executes)
- `.lmas-core/core-config.yaml` (registrar se necessário)
- `.lmas-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.lmas-core/core-config.yaml` (registrar em framework)
- `.lmas-core/utils/README.md` (documentar como utilitário de framework)
...
- `.lmas-core/tasks/{task}.md` (se criar task)
- `.lmas-core/core-config.yaml`
...
**Exemplos:** lmas-validator, code-quality-improver, coverage-analyzer
...
**Localização:** `.lmas-core/utils/{name}.js`

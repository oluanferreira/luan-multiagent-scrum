...
# Arquitetura do Sistema de Módulos do LMAS
...
| `data/`          | `lmas-kb.md`, `workflow-patterns.yaml`           | Base de conhecimento do framework           |
...
| --------------- | ------------------ | ------------------------- |
| LMAS Master     | `lmas-master`      | Orquestração do framework |
...
**Caminho:** `.lmas-core/infrastructure/`

...
# Arquitetura de Alto Nível do LMAS v4
...
**LMAS (AI Operating System)** é um framework sofisticado para orquestração de agentes de IA, workers e humanos em fluxos de trabalho complexos de desenvolvimento de software. A versão 2.1 introduz uma arquitetura modular com 4 módulos, estratégia multi-repositório e quality gates de 3 camadas.
...
| ------------------ | ---------------------------- | --------------------- | ------------------------------------ |
| **Core**           | `.lmas-core/core/`           | Fundação do framework | Config, Registry, QG, MCP, Session   |
| **Development**    | `.lmas-core/development/`    | Artefatos de dev      | Agentes, Tarefas, Workflows, Scripts |
| **Product**        | `.lmas-core/product/`        | Artefatos PM          | Templates, Checklists, Dados         |
| **Infrastructure** | `.lmas-core/infrastructure/` | Config do sistema     | Scripts, Ferramentas, Integrações    |

### Sistema de Agentes

| Agente | ID              | Arquétipo    | Responsabilidade          |
| ------ | --------------- | ------------ | ------------------------- |
| Neo    | `dev`           | Builder      | Implementação de código   |
| Oracle  | `qa`            | Guardian     | Garantia de qualidade     |
...
| Dozer   | `data-engineer` | Architect    | Engenharia de dados       |
| Felix  | `devops`        | Optimizer    | CI/CD e operações         |
| Uma    | `ux-expert`     | Creator      | Experiência do usuário    |
| Keymaker    | `lmas-master`   | Orchestrator | Orquestração do framework |
...
- [LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.lmas-core/docs/standards/LMAS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guia completo do framework

---

**Última Atualização:** 2025-12-09
**Versão:** 2.1.0
**Mantenedor:** @architect (Architect)

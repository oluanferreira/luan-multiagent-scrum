...
Este documento consolida as descobertas de pesquisa sobre melhores práticas para workflows de contribuidores externos em projetos open source, especificamente para habilitar contribuições seguras da comunidade para agentes e tarefas do LMAS.
...
### 2.3 Recomendações Específicas para LMAS
...
### 3.3 Estrutura Específica do LMAS
...
1. **Criar `.coderabbit.yaml`** com instruções de path específicas do LMAS

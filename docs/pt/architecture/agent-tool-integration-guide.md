...
Este guia explica como ferramentas são integradas com agentes LMAS. Ferramentas estendem as capacidades dos agentes fornecendo acesso a serviços externos, APIs e recursos do sistema.
...
| `tasks`        | Arquivos de workflow de tarefas     | `.lmas-core/development/tasks/`    |
| `checklists`   | Checklists de validação             | `.lmas-core/product/checklists/`   |

### Exemplo de Declaração

```yaml
# Do arquivo .lmas-core/development/agents/dev.md
dependencies:
  checklists:
...
LMAS implementa governança rigorosa de operações git:
...
- [Definições de Agentes](../../../.lmas-core/development/agents/)

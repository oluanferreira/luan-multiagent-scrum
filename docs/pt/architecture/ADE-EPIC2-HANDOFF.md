...
| -------------------- | -------------------------------------------------------- | ----------- | ------ |
| asset-inventory.js   | `.lmas-core/infrastructure/scripts/asset-inventory.js`   | JS Script   | ✅     |
| path-analyzer.js     | `.lmas-core/infrastructure/scripts/path-analyzer.js`     | JS Script   | ✅     |
| migrate-agent.js     | `.lmas-core/infrastructure/scripts/migrate-agent.js`     | JS Script   | ✅     |
| agent-v3-schema.json | `.lmas-core/infrastructure/schemas/agent-v3-schema.json` | JSON Schema | ✅     |
| task-v3-schema.json  | `.lmas-core/infrastructure/schemas/task-v3-schema.json`  | JSON Schema | ✅     |
...
- **Todos os agents** sincronizados em `.claude/commands/LMAS/agents/`

...
| Necessidade                    | Onde Ir                                                                                                       |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| **Perguntas sobre MCP?**       | Use a [categoria "MCP Ecosystem"](https://github.com/SynkraAI/lmas-core/discussions/categories/mcp-ecosystem) |
...
3. Discuta na [categoria MCP Ecosystem](https://github.com/SynkraAI/lmas-core/discussions/categories/mcp-ecosystem)

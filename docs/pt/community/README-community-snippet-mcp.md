...
> **Propósito:** Copie este snippet para o README.md do repositório `LMAS/mcp-ecosystem`.
...
| Necessidade                    | Onde Ir                                                                                                       |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| **Perguntas sobre MCP?**       | Use a [categoria "MCP Ecosystem"](https://github.com/oluanferreira/luan-multiagent-scrum/discussions/categories/mcp-ecosystem) |
...
1. Verifique as [propostas de MCP existentes](https://github.com/oluanferreira/luan-multiagent-scrum/labels/mcp-server)
2. Abra uma issue com o label `mcp-server`
3. Discuta na [categoria MCP Ecosystem](https://github.com/oluanferreira/luan-multiagent-scrum/discussions/categories/mcp-ecosystem)

...
# Princípios Orientadores do Método LMAS

> 🌐 [EN](../GUIDING-PRINCIPLES.md) | **PT** | [ES](../es/GUIDING-PRINCIPLES.md)

---

O Método LMAS é um framework em linguagem natural para desenvolvimento de software assistido por IA. Estes princípios garantem que as contribuições mantenham a efetividade do método.
...
Templates seguem a especificação do [LMAS Document Template](../../common/utils/lmas-doc-template.md) usando formato YAML:

...
Guia para configurar servidores MCP (Model Context Protocol) baseados em Docker com LMAS.
...
- `~/.lmas/mcp/servers/` - Configurações de servidores individuais
...
LMAS usa Docker MCP Toolkit como a infraestrutura MCP principal:
...
- [Agente DevOps](../.lmas-core/development/agents/devops.md)

---

_Guia de Configuração Docker MCP do Synkra LMAS v4.0_

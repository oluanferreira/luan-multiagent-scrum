...
Bem-vindo ao LMAS! Obrigado pelo seu interesse em contribuir. Este guia vai ajuda-lo a entender nosso fluxo de trabalho, processo de contribuicao e como submeter suas alteracoes.
...
git clone https://github.com/SEU_USUARIO/lmas-core.git
cd lmas-core
...
```
.lmas-core/development/agents/seu-agent.md
```
...
```
.lmas-core/development/tasks/sua-task.md
```
...
- Padroes especificos do LMAS (agents, tasks, workflows)
...
LMAS implementa uma estrategia de **Defesa em Profundidade** com 3 camadas de validacao:

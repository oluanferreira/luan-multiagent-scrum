...
You can also revoke consent at any time through the consent management interface or by deleting the `.lmas/telemetry/` directory.
...
- **Delete** all local data by removing the `.lmas/` and `.ai/` directories

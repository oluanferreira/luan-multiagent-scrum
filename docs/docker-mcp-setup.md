...
Guide for setting up Docker-based MCP (Model Context Protocol) servers with LMAS.
...
- [DevOps Agent](../.lmas-core/development/agents/devops.md)

---

_Synkra LMAS Docker MCP Setup Guide v4.2.11_

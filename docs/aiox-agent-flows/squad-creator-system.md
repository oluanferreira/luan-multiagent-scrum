# Sistema de Criacao e Gerenciamento de Squads LMAS
...
O **Squad Creator** (Craft) e o agente especializado do LMAS para criação, validação, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.

Este sistema implementa a **arquitetura task-first** do LMAS, onde tasks sao o ponto de entrada principal para execucao, e agentes orquestram essas tasks.
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/squad-creator.md` | Definição core do agente Squad Creator |
| `.claude/commands/LMAS/agents/squad-creator.md` | Comando Claude Code para ativar @squad-creator |

### Arquivos de Tasks do @squad-creator

| Arquivo | Comando | Propósito | Status |
|---------|---------|-----------|--------|
| `.lmas-core/development/tasks/squad-creator-create.md` | `*create-squad` | Cria novo squad com estrutura completa | Ativo |
| `.lmas-core/development/tasks/squad-creator-design.md` | `*design-squad` | Analisa documentacao e gera blueprint | Ativo |
| `.lmas-core/development/tasks/squad-creator-validate.md` | `*validate-squad` | Valida squad contra schema e padroes | Ativo |
| `.lmas-core/development/tasks/squad-creator-list.md` | `*list-squads` | Lista squads locais | Ativo |
| `.lmas-core/development/tasks/squad-creator-analyze.md` | `*analyze-squad` | Analisa estrutura e sugere melhorias | Ativo |
| `.lmas-core/development/tasks/squad-creator-extend.md` | `*extend-squad` | Estende squad com novos componentes | Ativo |
| `.lmas-core/development/tasks/squad-creator-migrate.md` | `*migrate-to-v2` | Migra squad para formato v2 | Ativo |
| `.lmas-core/development/tasks/squad-generate-skills.md` | `*generate-skills` | Gera skills de conhecimento do squad | Ativo |
...
|---------|---------|-----------|
| `.lmas-core/development/tasks/create-agent.md` | `*create-agent` | Cria definicao de agente individual |
| `.lmas-core/development/tasks/create-task.md` | `*create-task` | Cria arquivo de task individual |
| `.lmas-core/development/tasks/create-workflow.md` | `*create-workflow` | Cria workflow de orquestracao |

### Scripts de Suporte

| Arquivo | Classe/Funcao | Propósito |
|---------|---------------|-----------|
| `.lmas-core/development/scripts/squad/squad-generator.js` | `SquadGenerator` | Gera estrutura de squad completa |
| `.lmas-core/development/scripts/squad/squad-validator.js` | `SquadValidator` | Valida squad contra schema e padroes |
| `.lmas-core/development/scripts/squad/squad-loader.js` | `SquadLoader` | Carrega e resolve squads |
| `.lmas-core/development/scripts/squad/squad-designer.js` | `SquadDesigner` | Analisa docs e gera blueprints |
| `.lmas-core/development/scripts/squad/squad-analyzer.js` | `SquadAnalyzer` | Analisa estrutura de squads |
| `.lmas-core/development/scripts/squad/squad-extender.js` | `SquadExtender` | Estende squads existentes |
| `.lmas-core/development/scripts/squad/squad-migrator.js` | `SquadMigrator` | Migra squads para v2 |
| `.lmas-core/development/scripts/squad/squad-downloader.js` | `SquadDownloader` | Baixa squads do repositorio |
| `.lmas-core/development/scripts/squad/squad-publisher.js` | `SquadPublisher` | Publica squads |

### Schemas JSON

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/schemas/squad-schema.json` | Schema de validação do squad.yaml |
| `.lmas-core/schemas/squad-design-schema.json` | Schema de validação de blueprints |
...
flowchart LR
    ...
    subgraph DEVOPS["⚙️ @devops (Operator)"]
...
lmas:
  minVersion: string  # versao minima do LMAS
  type: squad
...
- [Task: squad-creator-create.md](.lmas-core/development/tasks/squad-creator-create.md)
- [Task: squad-creator-validate.md](.lmas-core/development/tasks/squad-creator-validate.md)
- [Task: squad-creator-design.md](.lmas-core/development/tasks/squad-creator-design.md)
- [Script: squad-generator.js](.lmas-core/development/scripts/squad/squad-generator.js)
- [Script: squad-validator.js](.lmas-core/development/scripts/squad/squad-validator.js)
- [Schema: squad-schema.json](.lmas-core/schemas/squad-schema.json)
- [Agent: squad-creator.md](.lmas-core/development/agents/squad-creator.md)
- [Command: squad-creator.md](.claude/commands/LMAS/agents/squad-creator.md)

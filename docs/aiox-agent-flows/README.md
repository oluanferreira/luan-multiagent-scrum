# LMAS Agent Flows - Documentação Detalhada dos Agentes

> 🌐 **PT** | [EN](../en/lmas-agent-flows/README.md) | [ES](../es/lmas-agent-flows/README.md) | [ZH](../zh/lmas-agent-flows/README.md)
...
Esta pasta contém a documentação detalhada de todos os agentes do LMAS, incluindo:
...
| LMAS Workflows | [docs/lmas-workflows/](../lmas-workflows/) | Detalhamento de workflows |
...
*LMAS Agent Flows Documentation v1.0 - Documentação detalhada do sistema de agentes*

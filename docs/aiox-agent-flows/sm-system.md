...
O agente **@sm (Niobe)** e o Scrum Master tecnico do LMAS, especializado em preparacao de stories e facilitacao de processos ageis. Seu papel principal e criar stories detalhadas e acionaveis que agentes desenvolvedores possam implementar com minima necessidade de pesquisa adicional.
...
|---------|---------|-----------|
| `.lmas-core/development/tasks/sm-create-next-story.md` | `*draft` | Task principal para criar proxima story do backlog |
| `.lmas-core/development/tasks/create-next-story.md` | `*draft` | Versao completa da task de criação de story |
| `.lmas-core/development/tasks/execute-checklist.md` | `*story-checklist` | Executa checklist de validação de story draft |
| `.lmas-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo |
| `.lmas-core/development/tasks/collaborative-edit.md` | - | Edicao colaborativa de documentos |
| `.lmas-core/development/tasks/init-project-status.md` | - | Inicializacao de status do projeto |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/sm.md` | Definição core do agente SM |
| `.claude/commands/LMAS/agents/sm.md` | Comando Claude Code para ativar @sm |
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/product/checklists/story-draft-checklist.md` | Valida qualidade e completude de story drafts |
| `.lmas-core/product/checklists/story-dod-checklist.md` | Definition of Done para stories |
| `.lmas-core/product/checklists/change-checklist.md` | Navegacao de mudancas e correcao de curso |
| `.lmas-core/product/checklists/po-master-checklist.md` | Checklist mestre usado em validação |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.lmas-core/development/agents/po.md` | @po | Coordena com @sm em backlog e sprint planning |
| `.lmas-core/development/agents/dev.md` | @dev | Recebe stories do @sm para implementacao |
| `.lmas-core/development/agents/pm.md` | @pm | Cria epics que @sm quebra em stories |
| `.lmas-core/development/agents/devops.md` | @github-devops | Recebe stories completas para push/PR |
| `.lmas-core/development/agents/qa.md` | @qa | Coordena em risk profiling |

### Arquivos de Workflows que Utilizam @sm

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/workflows/story-development-cycle.yaml` | Ciclo completo de desenvolvimento de stories |
| `.lmas-core/development/workflows/greenfield-fullstack.yaml` | Workflow greenfield full-stack |
| `.lmas-core/development/workflows/greenfield-service.yaml` | Workflow greenfield service |
| `.lmas-core/development/workflows/greenfield-ui.yaml` | Workflow greenfield UI |
| `.lmas-core/development/workflows/brownfield-fullstack.yaml` | Workflow brownfield full-stack |
| `.lmas-core/development/workflows/brownfield-service.yaml` | Workflow brownfield service |
| `.lmas-core/development/workflows/brownfield-ui.yaml` | Workflow brownfield UI |

### Arquivos de Configuracao

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/core-config.yaml` | Configuracao central (devStoryLocation, etc.) |
| `.lmas-core/development/scripts/unified-activation-pipeline.js` | Pipeline de saudacao inteligente |
| `.lmas-core/development/scripts/agent-assignment-resolver.js` | Resolucao de assignment de agentes |
...
flowchart TB
    ...
    subgraph SM_AGENT["🌊 @sm (Niobe) - Scrum Master"]
        direction TB
    ...
    subgraph COLLABORATION["👥 COLABORACAO"]
        DEV_AGENT["@dev (Neo)<br/>Recebe stories"]
        PO_AGENT["@po (Keymaker)<br/>Valida stories"]
        DEVOPS_AGENT["@github-devops (Operator)<br/>Push/PR apos conclusao"]
    end
...
flowchart TB
    subgraph UPSTREAM["⬆️ UPSTREAM - Fornece para @sm"]
        PM_UP["@pm (Trinity)<br/>Cria estrutura de epics"]
        PO_UP["@po (Keymaker)<br/>Prioriza backlog"]
        ANALYST_UP["@analyst (Sage)<br/>Pesquisa e insights"]
    end

    SM_CENTRAL["🌊 @sm (Niobe)<br/>Scrum Master"]

    subgraph DOWNSTREAM["⬇️ DOWNSTREAM - Recebe de @sm"]
        DEV_DOWN["@dev (Neo)<br/>Implementa stories"]
        PO_DOWN["@po (Keymaker)<br/>Valida stories"]
        QA_DOWN["@qa (Oracle)<br/>Risk profiling"]
    end

    subgraph LATERAL["↔️ LATERAL - Coordena com @sm"]
        DEVOPS_LAT["@github-devops (Operator)<br/>Push/PR workflow"]
    end
...
|--------|----------------|------|
| **@pm (Trinity)** | Recebe de | Epic structure, PRD shardado |
| **@po (Keymaker)** | Coordena com | Backlog prioritization, sprint planning |
| **@dev (Neo)** | Entrega para | Stories prontas para implementacao |
| **@qa (Oracle)** | Solicita | Risk profiling para stories |
| **@github-devops (Operator)** | Delega para | Push branches, criar PRs |
...
**Solucao:**
1. Copiar de `GITHUB lmas-core/core-config.yaml`
2. Ou executar LMAS installer: `npm run lmas:install`
...
### Arquivos do Agente
- [Agent: sm.md](.lmas-core/development/agents/sm.md)
- [Task: create-next-story.md](.lmas-core/development/tasks/create-next-story.md)
- [Task: execute-checklist.md](.lmas-core/development/tasks/execute-checklist.md)
- [Task: correct-course.md](.lmas-core/development/tasks/correct-course.md)

### Checklists
- [Checklist: story-draft-checklist.md](.lmas-core/product/checklists/story-draft-checklist.md)
- [Checklist: story-dod-checklist.md](.lmas-core/product/checklists/story-dod-checklist.md)
- [Checklist: change-checklist.md](.lmas-core/product/checklists/change-checklist.md)

### Workflows
- [Workflow: story-development-cycle.yaml](.lmas-core/development/workflows/story-development-cycle.yaml)
- [Workflow: greenfield-fullstack.yaml](.lmas-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-fullstack.yaml](.lmas-core/development/workflows/brownfield-fullstack.yaml)

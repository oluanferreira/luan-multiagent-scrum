...
O agente **@architect** (Architect) e o **Holistic System Architect & Full-Stack Technical Leader** do LMAS. Este agente e responsavel por:
...
|---------|---------|-----------|
| `.lmas-core/development/tasks/architect-analyze-impact.md` | `*analyze-impact` | Analisa impacto de modificacoes em componentes do framework |
| `.lmas-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao brownfield de projeto existente |
| `.lmas-core/development/tasks/create-doc.md` | `*create-doc` | Cria documentos a partir de templates YAML |
| `.lmas-core/development/tasks/collaborative-edit.md` | `*collaborative-edit` | Gerencia sessoes de edicao colaborativa |
| `.lmas-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.lmas-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validação |
| `.lmas-core/development/tasks/spec-assess-complexity.md` | `*assess-complexity` | Avalia complexidade de stories (Spec Pipeline) |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/architect.md` | Definição core do agente Architect |
| `.claude/commands/LMAS/agents/architect.md` | Comando Claude Code para ativar @architect |

### Arquivos de Templates do @architect

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/product/templates/architecture-tmpl.yaml` | Template para arquitetura backend |
| `.lmas-core/product/templates/front-end-architecture-tmpl.yaml` | Template para arquitetura frontend |
| `.lmas-core/product/templates/fullstack-architecture-tmpl.yaml` | Template para arquitetura fullstack |
| `.lmas-core/product/templates/brownfield-architecture-tmpl.yaml` | Template para projetos brownfield |

### Arquivos de Dados de Suporte

| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/data/technical-preferences.md` | Preferencias tecnicas padrao do LMAS |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.lmas-core/development/tasks/spec-gather-requirements.md` | @pm | Coleta requisitos que alimentam arquitetura |
| `.lmas-core/development/tasks/spec-research-dependencies.md` | @analyst | Pesquisa dependencias para arquitetura |
| `.lmas-core/development/tasks/spec-critique.md` | @qa | Valida specs que impactam arquitetura |
| `.lmas-core/development/tasks/plan-create-implementation.md` | @architect | Cria plano de implementacao pos-spec |
| `.lmas-core/development/agents/db-sage.md` | @db-sage | Colabora em arquitetura de dados |
| `.lmas-core/development/agents/ux-design-expert.md` | @ux-design-expert | Colabora em arquitetura frontend |
| `.lmas-core/development/agents/devops.md` | @devops | Colabora em infraestrutura |
...
flowchart TB
    ...
    subgraph ARCHITECT_CORE["@architect (Architect) - Core Operations"]
        direction TB
...
**Arquivo:** `.lmas-core/development/workflows/greenfield-fullstack.yaml`
...
**Arquivo:** `.lmas-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo:** `.lmas-core/development/workflows/spec-pipeline.yaml`
...
**Arquivo:** `.lmas-core/development/workflows/qa-loop.yaml`
...
```bash
# Analise basica
*analyze-impact modify .lmas-core/agents/weather-agent.md

# Analise profunda com testes
*analyze-impact modify .lmas-core/agents/weather-agent.md --depth deep --include-tests

# Deprecacao com output visual
*analyze-impact deprecate .lmas-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation.html

# Refatoracao com threshold de risco
*analyze-impact refactor .lmas-core/tasks/process-data.md --depth shallow --risk-threshold medium
```
...
| `.lmas/project-registry.yaml` | Registro de projetos |
...
**Solucao:**
1. Verificar `.lmas-core/product/templates/`
...
- [architect-analyze-impact.md](.lmas-core/development/tasks/architect-analyze-impact.md)
- [document-project.md](.lmas-core/development/tasks/document-project.md)
- [create-doc.md](.lmas-core/development/tasks/create-doc.md)
- [execute-checklist.md](.lmas-core/development/tasks/execute-checklist.md)
- [spec-assess-complexity.md](.lmas-core/development/tasks/spec-assess-complexity.md)

### Templates de Arquitetura

- [fullstack-architecture-tmpl.yaml](.lmas-core/product/templates/fullstack-architecture-tmpl.yaml)
- [architecture-tmpl.yaml](.lmas-core/product/templates/architecture-tmpl.yaml)
- [front-end-architecture-tmpl.yaml](.lmas-core/product/templates/front-end-architecture-tmpl.yaml)
- [brownfield-architecture-tmpl.yaml](.lmas-core/product/templates/brownfield-architecture-tmpl.yaml)

### Workflows Relacionados

- [greenfield-fullstack.yaml](.lmas-core/development/workflows/greenfield-fullstack.yaml)
- [brownfield-fullstack.yaml](.lmas-core/development/workflows/brownfield-fullstack.yaml)
- [spec-pipeline.yaml](.lmas-core/development/workflows/spec-pipeline.yaml)

### Agentes Colaboradores

- [@db-sage](.lmas-core/development/agents/db-sage.md) - Arquitetura de dados
- [@ux-design-expert](.lmas-core/development/agents/ux-design-expert.md) - Arquitetura frontend
- [@pm](.lmas-core/development/agents/pm.md) - Requisitos e PRD
- [@devops](.lmas-core/development/agents/devops.md) - Git push e infraestrutura

...
O agente `@devops` (Operator) e o especialista em infraestrutura e operacoes do framework LMAS. Ele e responsavel por:
...
|---------|---------|-----------|
| Definição do Agente | `.lmas-core/development/agents/devops.md` | Persona, comandos e comportamentos |

### Arquivos de Tasks

| Task | Caminho | Comando |
|------|---------|---------|
| Pre-Push Quality Gate | `.lmas-core/development/tasks/github-devops-pre-push-quality-gate.md` | `*push` |
| Version Management | `.lmas-core/development/tasks/github-devops-version-management.md` | `*version-check` |
| Repository Cleanup | `.lmas-core/development/tasks/github-devops-repository-cleanup.md` | `*cleanup` |
| CI/CD Configuration | `.lmas-core/development/tasks/ci-cd-configuration.md` | `*ci-cd` |
| Release Management | `.lmas-core/development/tasks/release-management.md` | `*release` |
| Environment Bootstrap | `.lmas-core/development/tasks/environment-bootstrap.md` | `*environment-bootstrap` |
| Search MCP | `.lmas-core/development/tasks/search-mcp.md` | `*search-mcp` |
| Add MCP | `.lmas-core/development/tasks/add-mcp.md` | `*add-mcp` |
| Setup MCP Docker | `.lmas-core/development/tasks/setup-mcp-docker.md` | `*setup-mcp-docker` |
| Setup GitHub | `.lmas-core/development/tasks/setup-github.md` | `*setup-github` |
| Security Audit | `.lmas-core/development/tasks/security-audit.md` | `*security-audit` |
| Security Scan | `.lmas-core/development/tasks/security-scan.md` | `*security-scan` |
...
```mermaid
flowchart TB
    subgraph "Agente DevOps (Operator)"
        A[/"@devops"/]
    end
...
| Task | Descrição |
|------|-----------|
| [Pre-Push Quality Gate](.lmas-core/development/tasks/github-devops-pre-push-quality-gate.md) | Validacao antes do push |
| [Version Management](.lmas-core/development/tasks/github-devops-version-management.md) | Gerenciamento de versoes |
| [CI/CD Configuration](.lmas-core/development/tasks/ci-cd-configuration.md) | Configuracao de pipelines |
| [Release Management](.lmas-core/development/tasks/release-management.md) | Gerenciamento de releases |
| [Environment Bootstrap](.lmas-core/development/tasks/environment-bootstrap.md) | Bootstrap de ambientes |
...
*Documento gerado pelo Sistema LMAS - 2026-02-04*
*Mantido por: @devops*

...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/analyst.md` | Definição core do agente Analyst |
...
| `.lmas-core/development/tasks/document-project.md` | `*create-project-brief` | Documentação de projetos existentes |
...
|--------|---------------------|
| **@pm (Trinity)** | Analyst fornece pesquisa e analise para criação de PRD |

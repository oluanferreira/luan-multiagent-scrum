...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/development/agents/pm.md` | Definição core do agente PM |
...
| `.lmas-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validação de checklists |
...
| Arquivo | Propósito |
|---------|-----------|
| `.lmas-core/product/checklists/pm-checklist.md` | Checklist de validação de PRD |
